namespace EventHorizon.Blazor.TypeScript.Interop.Generator.Tests.GenerateClassStatementStringTests
{
    ...
    public class ClassStringGenerationTests : GenerateStringTestBase
    {
        ...
        [InlineData(
            "ClassGenerics.ts",
            "Classes",
            "ClassGenerics.Expected.txt",
            ASTParserType.Sdcb
        )]
        [InlineData(
            "ExtendsAndImplementsClass.ts",
            "Classes",
            "ExtendsAndImplementsClass.Expected.txt",
            ASTParserType.Sdcb
        )]
        [InlineData(
            "ExtendsInterface.ts",
            "Classes",
            "ExtendsInterface.Expected.txt",
            ASTParserType.Sdcb
        )]
        [InlineData(
            "InterfaceGenerics.ts",
            "Classes",
            "InterfaceGenerics.Expected.txt",
            ASTParserType.Sdcb
        )]
        [InlineData(
            "NamespaceExtendsClass.ts",
            "Classes",
            "NamespaceExtendsClass.Expected.txt",
            ASTParserType.Sdcb
        )]
        [InlineData(
            "NamespaceImplementsInterface.ts",
            "Classes",
            "NamespaceImplementsInterface.Expected.txt",
            ASTParserType.Sdcb
        )]
