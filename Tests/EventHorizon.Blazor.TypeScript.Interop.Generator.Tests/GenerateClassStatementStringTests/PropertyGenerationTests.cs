...
public class PropertyGenerationTests : GenerateStringTestBase
{
    [Theory(DisplayName = "Property.Static")]
    [Trait("Category", "Property.Static")]
    [Trait("AST", "Sdcb")]
    [InlineData(
        "PropertyStaticClass.ts",
        "Properties",
        "PropertyStaticClass.Expected.txt",
        ASTParserType.Sdcb
    )]
    [InlineData(
        "PropertyStaticClassArray.ts",
        "Properties",
        "PropertyStaticClassArray.Expected.txt",
        ASTParserType.Sdcb
    )]
    [InlineData(
        "PropertyStaticPrimitive.ts",
        "Properties",
        "PropertyStaticPrimitive.Expected.txt",
        ASTParserType.Sdcb
    )]
    [InlineData(
        "PropertyStaticPrimitiveArray.ts",
        "Properties",
        "PropertyStaticPrimitiveArray.Expected.txt",
        ASTParserType.Sdcb
    )]
    ...
    [InlineData(
        "PropertyClassArray.ts",
        "Properties",
        "PropertyClassArray.Expected.txt",
        ASTParserType.Sdcb
    )]
    [InlineData(
        "PropertyPrimitive.ts",
        "Properties",
        "PropertyPrimitive.Expected.txt",
        ASTParserType.Sdcb
    )]
    [InlineData(
        "PropertyPrimitiveArray.ts",
        "Properties",
        "PropertyPrimitiveArray.Expected.txt",
        ASTParserType.Sdcb
    )]
    ...
    [Trait("AST", "Sdcb")]
    [InlineData(
        "AnyLiteralPropertyType.ts",
        "Properties",
        "Scenarios",
        "AnyLiteralPropertyType.Expected.txt",
        ASTParserType.Sdcb
    )]
    [InlineData(
        "ArrayInterfaceResponse.ts",
        "Properties",
        "Scenarios",
        "ArrayInterfaceResponse.Expected.txt",
        ASTParserType.Sdcb
    )]
    [InlineData(
        "DotNetNormalized.ts",
    ...
    [InlineData(
        "PropertyGenericTypes.ts",
        "Properties",
        "Scenarios",
        "PropertyGenericTypes.Expected.txt",
        ASTParserType.Sdcb
    )]
    [InlineData(
        "PropertyJavaScriptTypes.ts",
        "Properties",
        "Scenarios",
        "PropertyJavaScriptTypes.Expected.txt",
        ASTParserType.Sdcb
    )]
    [InlineData(
        "PropertyParenthesized.ts",
        "Properties",
        "Scenarios",
        "PropertyParenthesized.Expected.txt",
        ASTParserType.Sdcb
    )]
    [InlineData(
        "PropertyStaticRootNamespace.ts",
        "Properties",
        "Scenarios",
        "PropertyStaticRootNamespace.Expected.txt",
        ASTParserType.Sdcb
    )]
    [InlineData(
    ...
    [InlineData(
        ...
        "Properties",
        "Scenarios",
        "TypeofResponse.Expected.txt",
        ASTParserType.Sdcb
    )]
    [InlineData(
        "TypeofToPrimitiveResponse.ts",
        "Properties",
        "Scenarios",
        "TypeofToPrimitiveResponse.Expected.txt",
        ASTParserType.Sdcb
    )]
    [InlineData(
        "UnionLiteralPropertyType.ts",
        "Properties",
        "Scenarios",
