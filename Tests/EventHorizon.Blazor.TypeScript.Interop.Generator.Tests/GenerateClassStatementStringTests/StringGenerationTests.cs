namespace EventHorizon.Blazor.TypeScript.Interop.Generator.Tests.GenerateClassStatementStringTests
{
    ...
    public class StringGenerationTests : GenerateStringTestBase
    {
        ...
        [Trait("AST", "Sdcb")]
        [InlineData(
            "DotNetNormalizedArguments.ts",
            "Constructors",
            "DotNetNormalizedArguments.Expected.txt",
            ASTParserType.Sdcb
        )]
        [InlineData(
            "MixedArguments.ts",
            "Constructors",
            "MixedArguments.Expected.txt",
            ASTParserType.Sdcb
        )]
        [InlineData(
            "NoConstructor.ts",
            "Constructors",
            "NoConstructor.Expected.txt",
            ASTParserType.Sdcb
        )]
        [InlineData(
            "NoNamespaceWithArguments.d.ts",
            "Constructors",
            "NoNamespaceWithArguments.d.Expected.txt",
            ASTParserType.Sdcb
        )]
        [InlineData(
            "WithActionArgument.ts",
            "Constructors",
            "WithActionArgument.Expected.txt",
            ASTParserType.Sdcb
        )]
        [InlineData(
            "WithActionGenericArgument.ts",
            "Constructors",
            "WithActionGenericArgument.Expected.txt",
            ASTParserType.Sdcb
        )]
        [InlineData(
            "WithNullArguments.ts",
            "Constructors",
            "WithNullArguments.Expected.txt",
            ASTParserType.Sdcb
        )]
        ...
        [InlineData(
            "MethodArrayTypes.ts",
            "Methods",
            "MethodArrayTypes.Expected.txt",
            ASTParserType.Sdcb
        )]
        [InlineData(
            "PropertyArrayTypes.ts",
            "Properties",
            "PropertyArrayTypes.Expected.txt",
            ASTParserType.Sdcb
        )]
        ...
        [InlineData(
            "AccessorOverride.ts",
            "TypeOverrides",
            "AccessorOverride.Expected.txt",
            ASTParserType.Sdcb
        )]
        [InlineData(
            "ConstructorOverride.ts",
            "TypeOverrides",
            "ConstructorOverride.Expected.txt",
            ASTParserType.Sdcb
        )]
        [InlineData(
            "MethodOverride.ts",
            "TypeOverrides",
            "MethodOverride.Expected.txt",
            ASTParserType.Sdcb
        )]
        [InlineData(
            "PropertyOverride.ts",
            "TypeOverrides",
            "PropertyOverride.Expected.txt",
            ASTParserType.Sdcb
        )]
        public void ShouldGenerateTypeOverrideScenarioStringsUsingSdcb(
            ...
            ValidateGenerateWithTypeOverrideStrings(
                ...
                new Dictionary<string, string>
                {
                    ...
                    {
                        "Examples.ExampleClass | static | vectorStaticMethodCheck | arg1",
                        "OverrideVector4"
                    },
        ...
        [InlineData(
            "NullableEnumAccessor.ts",
            "Enums",
            "NullableEnumAccessor.Expected.txt",
            ASTParserType.Sdcb
        )]
        public void ShouldGenerateEnumScenarioStringsUsingSdcb(
            ...
            string expectedFile,
            ASTParserType parserType
        ) => ValidateGenerateStrings(rootPath, sourceFile, expectedFile, parserType: parserType);
