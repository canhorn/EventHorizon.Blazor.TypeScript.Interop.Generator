namespace EventHorizon.Blazor.TypeScript.Interop.Generator.Model
{
    public static class TypeStatementTemplates
    {
        ...
        public static string ActionResultTemplate { get; set; } =
            "ActionResultCallback<[[ACTION_RESULT]]>";
        public static string ActionResultArgsTemplate { get; set; } =
            "ActionResultCallback<[[GENERIC_TYPES]], [[ACTION_RESULT]]>";
        ...
        public static string StandardPostfixTemplate { get; set; } =
            "[[NAME]][[INTERFACE_POSTFIX]]";
        public static string GenericTemplate { get; set; } = "[[NAME]]<[[GENERIC_TYPES]]>";
        public static string GenericPostfixTemplate { get; set; } =
            "[[NAME]][[INTERFACE_POSTFIX]]<[[GENERIC_TYPES]]>";
