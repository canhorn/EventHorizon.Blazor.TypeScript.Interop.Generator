...
public static class ReadTemplates
{
    ...
    public static ClassGenerationTemplates Read()
    {
        ...
        var returnTypeClassTemplate = ReadAllText($"{templatesPath}.ReturnTypeClassTemplate.txt");
        ...
        var interopFuncArrayTemplate = ReadAllText($"{templatesPath}.InteropFuncArrayTemplate.txt");
        var interopFuncClassTemplate = ReadAllText($"{templatesPath}.InteropFuncClassTemplate.txt");
        ...
        var interopGetArrayTemplate = ReadAllText($"{templatesPath}.InteropGetArrayTemplate.txt");
        var interopGetClassTemplate = ReadAllText($"{templatesPath}.InteropGetClassTemplate.txt");

        var interopTaskTemplate = ReadAllText($"{templatesPath}.InteropTaskTemplate.txt");
        var interopTaskArrayTemplate = ReadAllText($"{templatesPath}.InteropTaskArrayTemplate.txt");
        var interopTaskClassTemplate = ReadAllText($"{templatesPath}.InteropTaskClassTemplate.txt");
