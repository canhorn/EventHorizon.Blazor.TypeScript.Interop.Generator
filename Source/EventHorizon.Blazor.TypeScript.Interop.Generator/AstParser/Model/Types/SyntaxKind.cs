namespace EventHorizon.Blazor.TypeScript.Interop.Generator.AstParser.Model.Types;
...
public static class SyntaxKind
{
    ...
    public const string GetAccessor = nameof(GetAccessor);
    public const string SetAccessor = nameof(SetAccessor);
    public const string PrivateKeyword = nameof(PrivateKeyword);
    public const string ProtectedKeyword = nameof(ProtectedKeyword);
    ...
    public const string LiteralType = nameof(LiteralType);
    public const string QuestionToken = nameof(QuestionToken);
    public const string TypeLiteral = nameof(TypeLiteral);
    public const string NullKeyword = nameof(NullKeyword);
    public const string UndefinedKeyword = nameof(UndefinedKeyword);
