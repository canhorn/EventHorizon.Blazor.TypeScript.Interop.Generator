    ...
    public class NodeJS_Node : Node
    {
        ...
        )
        {
            ...
            if (node.TypeName is not null)
            {
                ...
                {
                    children.Add(
                        new NodeJS_Node(SyntaxKind.Identifier, node.TypeName.Left.Name, this)
                    );
                }
            ...
            if (node.SuperClass is not null)
            {
                ...
                heritageClauses.Add(
                    new NodeJS_Node(types: new List<Node> { superClassNode }, this)
                );
            }
            ...
            if (node.Implements is not null)
            {
                foreach (var implementation in node.Implements)
                {
                    ...
                    heritageClauses.Add(
                        new NodeJS_Node(types: new List<Node> { interfaceNode }, this)
                    );
                }
            }
            ...
            {
                var types = node.TypeParameters.Params.Select(a => new NodeJS_Node(
                    a,
                    parent: this
                ));
