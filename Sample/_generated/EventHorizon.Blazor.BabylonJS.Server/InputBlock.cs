...
public class InputBlock : NodeMaterialBlock
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<CachedEntity>(this.___guid, "value");
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "valueCallback", value);
    }

    public async ValueTask<string> get_associatedVariableName()
    {
        return await EventHorizonBlazorInterop.Get<string>(this.___guid, "associatedVariableName");
    }

    public ValueTask set_associatedVariableName(string value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "associatedVariableName", value);
    }

    public async ValueTask<int> get_animationType()
    {
        return await EventHorizonBlazorInterop.Get<int>(this.___guid, "animationType");
    }

    public ValueTask set_animationType(int value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "animationType", value);
    }

    public async ValueTask<bool> get_isUndefined()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isUndefined");
    }

    public async ValueTask<bool> get_isUniform()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isUniform");
    }

    public ValueTask set_isUniform(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "isUniform", value);
    }

    public async ValueTask<bool> get_isAttribute()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isAttribute");
    }

    public ValueTask set_isAttribute(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "isAttribute", value);
    }

    public async ValueTask<bool> get_isVarying()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isVarying");
    }

    public ValueTask set_isVarying(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "isVarying", value);
    }

    public async ValueTask<bool> get_isSystemValue()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isSystemValue");
    }

    public async ValueTask<int> get_systemValue()
    {
        return await EventHorizonBlazorInterop.Get<int>(this.___guid, "systemValue");
    }

    public ValueTask set_systemValue(int value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "systemValue", value);
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isBoolean");
    }

    public ValueTask set_isBoolean(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "isBoolean", value);
    }

    public async ValueTask<decimal> get_matrixMode()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "matrixMode");
    }

    public ValueTask set_matrixMode(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "matrixMode", value);
    }

    public async ValueTask<bool> get_isConstant()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isConstant");
    }

    public ValueTask set_isConstant(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "isConstant", value);
    }

    public async ValueTask<string> get_groupInInspector()
    {
        return await EventHorizonBlazorInterop.Get<string>(this.___guid, "groupInInspector");
    }

    public ValueTask set_groupInInspector(string value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "groupInInspector", value);
    }
    ...
    public async ValueTask<Observable<InputBlock>> get_onValueChangedObservable()
    {
        ...
        {
            __onValueChangedObservable = await EventHorizonBlazorInterop.GetClass<
                Observable<InputBlock>
            >(
                this.___guid,
    ...
    public ValueTask set_onValueChangedObservable(Observable<InputBlock> value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "onValueChangedObservable", value);
    }
    ...
    public async ValueTask<InputBlock> setAsAttribute(string attributeName = null)
    {
        return await EventHorizonBlazorInterop.FuncClass<InputBlock>(
            ...
            new object[] { new string[] { this.___guid, "setAsAttribute" }, attributeName }
        );
    }
    ...
    public async ValueTask<InputBlock> setAsSystemValue(int value)
    {
        return await EventHorizonBlazorInterop.FuncClass<InputBlock>(
            entity => new InputBlock() { ___guid = entity.___guid },
            new object[] { new string[] { this.___guid, "setAsSystemValue" }, value }
        );
    }
    ...
    public async ValueTask animate(Scene scene)
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { this.___guid, "animate" }, scene }
        );
    }
    ...
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { this.___guid, "setDefaultValue" } }
        );
    }
