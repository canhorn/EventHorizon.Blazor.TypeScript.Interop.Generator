...
public class NodeMaterialDefines : MaterialDefines, IImageProcessingConfigurationDefines
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "NUM_BONE_INFLUENCERS");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "NUM_MORPH_INFLUENCERS");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "VIGNETTEBLENDMODEMULTIPLY");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "VIGNETTEBLENDMODEOPAQUE");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "TONEMAPPING");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "TONEMAPPING_ACES");
    }

    public ValueTask set_TONEMAPPING_ACES(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "TONEMAPPING_ACES", value);
    }
