...
public class IEdgesRendererOptionsCachedEntity : CachedEntityObject, IEdgesRendererOptions
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useAlternateEdgeFinder");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "epsilonVertexAligned");
    }
