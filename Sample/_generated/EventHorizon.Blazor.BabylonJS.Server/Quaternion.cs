...
public class Quaternion : CachedEntityObject
{
    ...
    public static async ValueTask<Quaternion> FromRotationMatrix(Matrix matrix)
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            ...
            new object[] { new string[] { "Quaternion", "FromRotationMatrix" }, matrix }
        );
    }
    ...
    public static async ValueTask FromRotationMatrixToRef(Matrix matrix, Quaternion result)
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Quaternion", "FromRotationMatrixToRef" },
                matrix,
                result
            }
        );
    ...
    public static async ValueTask<decimal> Dot(Quaternion left, Quaternion right)
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "Quaternion", "Dot" }, left, right }
        );
    }
    ...
    public static async ValueTask<bool> AreClose(Quaternion quat0, Quaternion quat1)
    {
        return await EventHorizonBlazorInterop.Func<bool>(
            new object[] { new string[] { "Quaternion", "AreClose" }, quat0, quat1 }
        );
    }
    ...
    public static async ValueTask<Quaternion> Zero()
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            entity => new Quaternion() { ___guid = entity.___guid },
            new object[] { new string[] { "Quaternion", "Zero" } }
        );
    }
    ...
    public static async ValueTask<Quaternion> Inverse(Quaternion q)
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            entity => new Quaternion() { ___guid = entity.___guid },
            new object[] { new string[] { "Quaternion", "Inverse" }, q }
        );
    }
    ...
    public static async ValueTask<Quaternion> InverseToRef(Quaternion q, Quaternion result)
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            entity => new Quaternion() { ___guid = entity.___guid },
            new object[] { new string[] { "Quaternion", "InverseToRef" }, q, result }
        );
    }
    ...
    public static async ValueTask<Quaternion> Identity()
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            entity => new Quaternion() { ___guid = entity.___guid },
            new object[] { new string[] { "Quaternion", "Identity" } }
        );
    }
    ...
    {
        return await EventHorizonBlazorInterop.Func<bool>(
            new object[] { new string[] { "Quaternion", "IsIdentity" }, quaternion }
        );
    }
    ...
    public static async ValueTask<Quaternion> RotationAxis(Vector3 axis, decimal angle)
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            entity => new Quaternion() { ___guid = entity.___guid },
            new object[] { new string[] { "Quaternion", "RotationAxis" }, axis, angle }
        );
    }

    public static async ValueTask<Quaternion> RotationAxisToRef(
        Vector3 axis,
        decimal angle,
        Quaternion result
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            entity => new Quaternion() { ___guid = entity.___guid },
            new object[] { new string[] { "Quaternion", "RotationAxisToRef" }, axis, angle, result }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            entity => new Quaternion() { ___guid = entity.___guid },
            new object[] { new string[] { "Quaternion", "FromArray" }, array, offset }
        );
    }
    ...
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Quaternion", "FromArrayToRef" }, array, offset, result }
        );
    }
    ...
    public static async ValueTask<Quaternion> FromEulerAngles(decimal x, decimal y, decimal z)
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            entity => new Quaternion() { ___guid = entity.___guid },
            new object[] { new string[] { "Quaternion", "FromEulerAngles" }, x, y, z }
        );
    }

    public static async ValueTask<Quaternion> FromEulerAnglesToRef(
        decimal x,
        decimal y,
        decimal z,
        Quaternion result
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            entity => new Quaternion() { ___guid = entity.___guid },
            new object[] { new string[] { "Quaternion", "FromEulerAnglesToRef" }, x, y, z, result }
        );
    }
    ...
    public static async ValueTask<Quaternion> FromEulerVector(Vector3 vec)
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            entity => new Quaternion() { ___guid = entity.___guid },
            new object[] { new string[] { "Quaternion", "FromEulerVector" }, vec }
        );
    }
    ...
    public static async ValueTask<Quaternion> FromEulerVectorToRef(Vector3 vec, Quaternion result)
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            entity => new Quaternion() { ___guid = entity.___guid },
            new object[] { new string[] { "Quaternion", "FromEulerVectorToRef" }, vec, result }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            entity => new Quaternion() { ___guid = entity.___guid },
            new object[] { new string[] { "Quaternion", "RotationYawPitchRoll" }, yaw, pitch, roll }
        );
    }
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Quaternion", "RotationYawPitchRollToRef" },
                yaw,
                pitch,
                roll,
                result
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            ...
            new object[]
            {
                new string[] { "Quaternion", "RotationAlphaBetaGamma" },
                alpha,
                beta,
                gamma
            }
    ...
    public static async ValueTask RotationAlphaBetaGammaToRef(
        decimal alpha,
        decimal beta,
        decimal gamma,
        Quaternion result
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Quaternion", "RotationAlphaBetaGammaToRef" },
                alpha,
                beta,
                gamma,
                result
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            ...
            new object[]
            {
                new string[] { "Quaternion", "RotationQuaternionFromAxis" },
                axis1,
                axis2,
                axis3
            }
    ...
    public static async ValueTask RotationQuaternionFromAxisToRef(
        Vector3 axis1,
        Vector3 axis2,
        Vector3 axis3,
        Quaternion @ref
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Quaternion", "RotationQuaternionFromAxisToRef" },
                axis1,
                axis2,
                axis3,
                @ref
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Quaternion>(
            entity => new Quaternion() { ___guid = entity.___guid },
            new object[] { new string[] { "Quaternion", "Slerp" }, left, right, amount }
        );
    }

    public static async ValueTask SlerpToRef(
        Quaternion left,
        Quaternion right,
        decimal amount,
        Quaternion result
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Quaternion", "SlerpToRef" },
                left,
                right,
                amount,
                result
    ...
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Quaternion" }, x, y, z, w);
