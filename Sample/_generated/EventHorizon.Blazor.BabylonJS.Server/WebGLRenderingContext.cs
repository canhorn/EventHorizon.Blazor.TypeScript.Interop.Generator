...
public class WebGLRenderingContextCachedEntity : CachedEntityObject, WebGLRenderingContext
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "MAX_SAMPLES");
    }

    public ValueTask set_MAX_SAMPLES(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "MAX_SAMPLES", value);
    }

    public async ValueTask<decimal> get_RGBA8()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "RGBA8");
    }

    public ValueTask set_RGBA8(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "RGBA8", value);
    }

    public async ValueTask<decimal> get_READ_FRAMEBUFFER()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "READ_FRAMEBUFFER");
    }

    public ValueTask set_READ_FRAMEBUFFER(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "READ_FRAMEBUFFER", value);
    }

    public async ValueTask<decimal> get_DRAW_FRAMEBUFFER()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "DRAW_FRAMEBUFFER");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "UNIFORM_BUFFER");
    }

    public ValueTask set_UNIFORM_BUFFER(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "UNIFORM_BUFFER", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "RGBA16F");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "RGBA32F");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "R32F");
    }

    public ValueTask set_R32F(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "R32F", value);
    }

    public async ValueTask<decimal> get_RG32F()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "RG32F");
    }

    public ValueTask set_RG32F(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "RG32F", value);
    }

    public async ValueTask<decimal> get_RGB32F()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "RGB32F");
    }

    public ValueTask set_RGB32F(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "RGB32F", value);
    }

    public async ValueTask<decimal> get_R16F()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "R16F");
    }

    public ValueTask set_R16F(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "R16F", value);
    }

    public async ValueTask<decimal> get_RG16F()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "RG16F");
    }

    public ValueTask set_RG16F(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "RG16F", value);
    }

    public async ValueTask<decimal> get_RGB16F()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "RGB16F");
    }

    public ValueTask set_RGB16F(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "RGB16F", value);
    }

    public async ValueTask<decimal> get_RED()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "RED");
    }

    public ValueTask set_RED(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "RED", value);
    }

    public async ValueTask<decimal> get_RG()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "RG");
    }

    public ValueTask set_RG(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "RG", value);
    }

    public async ValueTask<decimal> get_R8()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "R8");
    }

    public ValueTask set_R8(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "R8", value);
    }

    public async ValueTask<decimal> get_RG8()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "RG8");
    }

    public ValueTask set_RG8(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "RG8", value);
    }

    public async ValueTask<decimal> get_UNSIGNED_INT_24_8()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "UNSIGNED_INT_24_8");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "DEPTH24_STENCIL8");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "COLOR_ATTACHMENT0");
    }

    public async ValueTask<decimal> get_COLOR_ATTACHMENT1()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "COLOR_ATTACHMENT1");
    }

    public async ValueTask<decimal> get_COLOR_ATTACHMENT2()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "COLOR_ATTACHMENT2");
    }

    public async ValueTask<decimal> get_COLOR_ATTACHMENT3()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "COLOR_ATTACHMENT3");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "ANY_SAMPLES_PASSED");
    }

    public ValueTask set_ANY_SAMPLES_PASSED(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "ANY_SAMPLES_PASSED", value);
    }

    public async ValueTask<decimal> get_QUERY_RESULT_AVAILABLE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "QUERY_RESULT_AVAILABLE");
    }

    public ValueTask set_QUERY_RESULT_AVAILABLE(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "QUERY_RESULT_AVAILABLE", value);
    }

    public async ValueTask<decimal> get_QUERY_RESULT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "QUERY_RESULT");
    }

    public ValueTask set_QUERY_RESULT(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "QUERY_RESULT", value);
    }
    #endregion
    ...
    #region Methods
    public async ValueTask drawArraysInstanced(
        decimal mode,
        decimal first,
        decimal count,
        decimal primcount
    ...
    public async ValueTask drawElementsInstanced(
        decimal mode,
        decimal count,
        decimal type,
        decimal offset,
    ...
    public async ValueTask blitFramebuffer(
        decimal srcX0,
        decimal srcY0,
        decimal srcX1,
        decimal srcY1,
    ...
    public async ValueTask renderbufferStorageMultisample(
        decimal target,
        decimal samples,
    ...
    public async ValueTask<decimal> getUniformBlockIndex(
    ...
    public async ValueTask uniformBlockBinding(
        WebGLProgram program,
