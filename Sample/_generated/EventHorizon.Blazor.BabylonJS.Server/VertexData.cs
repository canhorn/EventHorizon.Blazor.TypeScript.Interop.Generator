...
public class VertexData : CachedEntityObject
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("VertexData", "FRONTSIDE");
    }

    public static async ValueTask<decimal> get_BACKSIDE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("VertexData", "BACKSIDE");
    }

    public static async ValueTask<decimal> get_DOUBLESIDE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("VertexData", "DOUBLESIDE");
    }

    public static async ValueTask<decimal> get_DEFAULTSIDE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("VertexData", "DEFAULTSIDE");
    }
    #endregion
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            ...
            new object[]
            {
                new string[] { "VertexData", "ExtractFromMesh" },
                mesh,
                copyWhenShared,
                forceCopy
            }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            ...
            new object[]
            {
                new string[] { "VertexData", "ExtractFromGeometry" },
                geometry,
                copyWhenShared,
                forceCopy
            }
    ...
    public static async ValueTask<VertexData> CreateRibbon(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateRibbon" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreateBox(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateBox" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreateTiledBox(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateTiledBox" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreateTiledPlane(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateTiledPlane" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreateSphere(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateSphere" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreateCylinder(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateCylinder" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreateTorus(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateTorus" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreateLineSystem(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateLineSystem" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreateDashedLines(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateDashedLines" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreateGround(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateGround" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreateTiledGround(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateTiledGround" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreateGroundFromHeightMap(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateGroundFromHeightMap" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreatePlane(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreatePlane" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreateDisc(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateDisc" }, options }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            ...
            new object[]
            {
                new string[] { "VertexData", "CreatePolygon" },
                polygon,
                sideOrientation,
                fUV,
                fColors,
    ...
    public static async ValueTask<VertexData> CreateIcoSphere(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateIcoSphere" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreatePolyhedron(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreatePolyhedron" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreateCapsule(ICreateCapsuleOptions options = null)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateCapsule" }, options }
        );
    }
    ...
    public static async ValueTask<VertexData> CreateTorusKnot(object options)
    {
        return await EventHorizonBlazorInterop.FuncClass<VertexData>(
            entity => new VertexData() { ___guid = entity.___guid },
            new object[] { new string[] { "VertexData", "CreateTorusKnot" }, options }
        );
    }
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "VertexData", "ComputeNormals" },
                positions,
                indices,
                normals,
                options
    ...
    public static async ValueTask ImportVertexData(object parsedVertexData, Geometry geometry)
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "VertexData", "ImportVertexData" },
                parsedVertexData,
                geometry
            }
        );
    ...
    {
        return await EventHorizonBlazorInterop.GetArray<decimal>(this.___guid, "matricesIndices");
    }
    ...
    {
        return await EventHorizonBlazorInterop.GetArray<decimal>(this.___guid, "matricesWeights");
    }
