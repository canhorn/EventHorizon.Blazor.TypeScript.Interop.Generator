...
public class Light : Node
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Light", "FALLOFF_DEFAULT");
    }

    public static async ValueTask<decimal> get_FALLOFF_PHYSICAL()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Light", "FALLOFF_PHYSICAL");
    }

    public static async ValueTask<decimal> get_FALLOFF_GLTF()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Light", "FALLOFF_GLTF");
    }

    public static async ValueTask<decimal> get_FALLOFF_STANDARD()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Light", "FALLOFF_STANDARD");
    }

    public static async ValueTask<decimal> get_LIGHTMAP_DEFAULT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Light", "LIGHTMAP_DEFAULT");
    }

    public static async ValueTask<decimal> get_LIGHTMAP_SPECULAR()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Light", "LIGHTMAP_SPECULAR");
    }

    public static async ValueTask<decimal> get_LIGHTMAP_SHADOWSONLY()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Light", "LIGHTMAP_SHADOWSONLY");
    }

    public static async ValueTask<decimal> get_INTENSITYMODE_AUTOMATIC()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Light", "INTENSITYMODE_AUTOMATIC");
    }

    public static async ValueTask<decimal> get_INTENSITYMODE_LUMINOUSPOWER()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Light", "INTENSITYMODE_LUMINOUSPOWER");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Light", "INTENSITYMODE_ILLUMINANCE");
    }

    public static async ValueTask<decimal> get_INTENSITYMODE_LUMINANCE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Light", "INTENSITYMODE_LUMINANCE");
    }

    public static async ValueTask<decimal> get_LIGHTTYPEID_POINTLIGHT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Light", "LIGHTTYPEID_POINTLIGHT");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Light", "LIGHTTYPEID_SPOTLIGHT");
    }
    ...
    public static async ValueTask<decimal> CompareLightsPriority(Light a, Light b)
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "Light", "CompareLightsPriority" }, a, b }
        );
    }

    public static async ValueTask<Light> GetConstructorFromName()
    {
        return await EventHorizonBlazorInterop.FuncClass<Light>(
            entity => new Light() { ___guid = entity.___guid },
            new object[] { new string[] { "Light", "GetConstructorFromName" } }
        );
    }
    ...
    public static async ValueTask<Light> Parse(object parsedLight, Scene scene)
    {
        return await EventHorizonBlazorInterop.FuncClass<Light>(
            entity => new Light() { ___guid = entity.___guid },
            new object[] { new string[] { "Light", "Parse" }, parsedLight, scene }
        );
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "range");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "intensityMode");
    }

    public ValueTask set_intensityMode(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "intensityMode", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "includedOnlyMeshes", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "excludedMeshes", value);
    }

    public async ValueTask<decimal> get_excludeWithLayerMask()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "excludeWithLayerMask");
    }

    public ValueTask set_excludeWithLayerMask(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "excludeWithLayerMask", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "includeOnlyWithLayerMask", value);
    }

    public async ValueTask<decimal> get_lightmapMode()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "lightmapMode");
    }

    public ValueTask set_lightmapMode(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "lightmapMode", value);
    }
    #endregion
    ...
    {
        __diffuse = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "diffuse", value);
    }
    ...
    {
        __specular = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "specular", value);
    }

    public async ValueTask<decimal> get_falloffType()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "falloffType");
    }

    public ValueTask set_falloffType(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "falloffType", value);
    }
    ...
    public static async ValueTask<Light> NewLight(string name, Scene scene)
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Light" }, name, scene);
    ...
    public async ValueTask<Light> transferToNodeMaterialEffect(
        Effect effect,
