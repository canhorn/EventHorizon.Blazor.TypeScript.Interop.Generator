...
public class SpriteManager : CachedEntityObject, ISpriteManager
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<string>("SpriteManager", "SnippetUrl");
    }

    public static ValueTask set_SnippetUrl(string value)
    {
        return EventHorizonBlazorInterop.Set("SpriteManager", "SnippetUrl", value);
    }
    #endregion
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<SpriteManager>(
            ...
            new object[]
            {
                new string[] { "SpriteManager", "Parse" },
                parsedManager,
                scene,
                rootUrl
            }
    ...
    )
    {
        return await EventHorizonBlazorInterop.TaskClass<SpriteManager>(
            ...
            new object[]
            {
                new string[] { "SpriteManager", "ParseFromFileAsync" },
                name,
                url,
                scene,
                rootUrl
    ...
    public static async ValueTask<SpriteManager> CreateFromSnippetAsync(
        string snippetId,
        Scene scene,
        string rootUrl = null
    )
    {
        return await EventHorizonBlazorInterop.TaskClass<SpriteManager>(
            ...
            new object[]
            {
                new string[] { "SpriteManager", "CreateFromSnippetAsync" },
                snippetId,
                scene,
                rootUrl
            }
