...
public class StencilState : CachedEntityObject
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("StencilState", "ALWAYS");
    }

    public static async ValueTask<decimal> get_KEEP()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("StencilState", "KEEP");
    }

    public static async ValueTask<decimal> get_REPLACE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("StencilState", "REPLACE");
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "stencilOpStencilFail");
    }
