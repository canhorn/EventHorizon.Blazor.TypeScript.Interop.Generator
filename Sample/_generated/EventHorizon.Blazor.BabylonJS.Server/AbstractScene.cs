...
public class AbstractScene : CachedEntityObject
{
    ...
    public static async ValueTask AddParser(
        string name,
        ActionCallback<CachedEntity, Scene, AssetContainer, string> parser
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "AbstractScene", "AddParser" }, name, parser }
        );
    }
    ...
    {
        return await EventHorizonBlazorInterop.Func<
            ActionCallback<CachedEntity, Scene, AssetContainer, string>
        >(new object[] { new string[] { "AbstractScene", "GetParser" }, name });
    }

    public static async ValueTask AddIndividualParser(
        string name,
        ActionResultCallback<CachedEntity, Scene, string, CachedEntity> parser
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "AbstractScene", "AddIndividualParser" }, name, parser }
        );
    }
    ...
    > GetIndividualParser(string name)
    {
        return await EventHorizonBlazorInterop.Func<
            ActionResultCallback<CachedEntity, Scene, string, CachedEntity>
        >(new object[] { new string[] { "AbstractScene", "GetIndividualParser" }, name });
    }

    public static async ValueTask Parse(
        object jsonData,
        Scene scene,
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "AbstractScene", "Parse" },
                jsonData,
                scene,
                container,
                rootUrl
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "cameras", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "lights", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "particleSystems", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "multiMaterials", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "materials", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "morphTargetManagers", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "geometries", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "transformNodes", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "actionManagers", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "textures", value);
    }
