...
public class NodeMaterialConnectionPoint : CachedEntityObject
{
    ...
    public static async ValueTask<bool> AreEquivalentTypes(decimal type1, decimal type2)
    {
        return await EventHorizonBlazorInterop.Func<bool>(
            new object[]
            {
                new string[] { "NodeMaterialConnectionPoint", "AreEquivalentTypes" },
                type1,
                type2
            }
        );
    ...
    {
        return await EventHorizonBlazorInterop.Get<int>(this.___guid, "direction");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<int>(this.___guid, "innerType");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isConnected");
    }

    public async ValueTask<bool> get_isConnectedToInputBlock()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isConnectedToInputBlock");
    }
    ...
    public async ValueTask<NodeMaterialConnectionPoint> get_connectedPoint()
    {
        ...
        {
            __connectedPoint =
                await EventHorizonBlazorInterop.GetClass<NodeMaterialConnectionPoint>(
                    this.___guid,
                    "connectedPoint",
                    (entity) =>
                    {
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "hasEndpoints");
    }

    public async ValueTask<bool> get_isConnectedInVertexShader()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isConnectedInVertexShader");
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "needDualDirectionValidation", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "acceptedConnectionPointTypes", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "excludedConnectionPointTypes", value);
    }
    ...
    public async ValueTask<Observable<NodeMaterialConnectionPoint>> get_onConnectionObservable()
    {
        ...
        {
            __onConnectionObservable = await EventHorizonBlazorInterop.GetClass<
    ...
    public ValueTask set_onConnectionObservable(Observable<NodeMaterialConnectionPoint> value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "onConnectionObservable", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<string>(this.___guid, "displayName");
    }

    public ValueTask set_displayName(string value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "displayName", value);
    }

    public async ValueTask<bool> get_isOptional()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isOptional");
    }

    public ValueTask set_isOptional(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "isOptional", value);
    }

    public async ValueTask<bool> get_isExposedOnFrame()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isExposedOnFrame");
    }

    public ValueTask set_isExposedOnFrame(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "isExposedOnFrame", value);
    }

    public async ValueTask<decimal> get_exposedPortPosition()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "exposedPortPosition");
    }

    public ValueTask set_exposedPortPosition(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "exposedPortPosition", value);
    }

    public async ValueTask<string> get_define()
    {
        return await EventHorizonBlazorInterop.Get<string>(this.___guid, "define");
    }

    public ValueTask set_define(string value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "define", value);
    }
    #endregion
    ...
    public static async ValueTask<NodeMaterialConnectionPoint> NewNodeMaterialConnectionPoint(
        string name,
        NodeMaterialBlock ownerBlock,
        int direction
    )
    {
        var entity = await EventHorizonBlazorInterop.New(
            new string[] { "NodeMaterialConnectionPoint" },
            name,
            ownerBlock,
            direction
        );
    ...
    public async ValueTask<NodeMaterialConnectionPoint> connectTo(
    ...
    public async ValueTask<NodeMaterialConnectionPoint> disconnectFrom(
        NodeMaterialConnectionPoint endpoint
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<NodeMaterialConnectionPoint>(
            entity => new NodeMaterialConnectionPoint() { ___guid = entity.___guid },
