...
public class AdvancedDynamicTexture : DynamicTexture
{
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<AdvancedDynamicTexture>(
            ...
            new object[]
            {
                new string[] { "AdvancedDynamicTexture", "CreateForMesh" },
                mesh,
                width,
                height,
                supportPointerMove,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<AdvancedDynamicTexture>(
            ...
            new object[]
            {
                new string[] { "AdvancedDynamicTexture", "CreateForMeshTexture" },
                mesh,
                width,
                height,
                supportPointerMove,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<AdvancedDynamicTexture>(
            ...
            new object[]
            {
                new string[] { "AdvancedDynamicTexture", "CreateFullscreenUI" },
                name,
                foreground,
                scene,
                sampling
    ...
    public async ValueTask<IFocusableControlCachedEntity> get_focusedControl()
    {
        ...
        {
            __focusedControl =
                await EventHorizonBlazorInterop.GetClass<IFocusableControlCachedEntity>(
                    this.___guid,
                    "focusedControl",
                    (entity) =>
                    {
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "useInvalidateRectOptimization", value);
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "applyYInversionOnUpdate");
    }
    ...
    )
    {
        var entity = await EventHorizonBlazorInterop.New(
            new string[] { "AdvancedDynamicTexture" },
            name,
            width,
            height,
            scene,
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { this.___guid, "executeOnAllControls" }, func, container }
        );
    }
