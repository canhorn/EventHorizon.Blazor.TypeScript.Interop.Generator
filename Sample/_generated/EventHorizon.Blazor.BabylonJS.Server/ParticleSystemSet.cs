...
public class ParticleSystemSet : CachedEntityObject, _IDisposable
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<string>("ParticleSystemSet", "BaseAssetsUrl");
    }

    public static ValueTask set_BaseAssetsUrl(string value)
    {
        return EventHorizonBlazorInterop.Set("ParticleSystemSet", "BaseAssetsUrl", value);
    }
    #endregion
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<ParticleSystemSet>(
            ...
            new object[] { new string[] { "ParticleSystemSet", "Parse" }, data, scene, gpu }
        );
    }
    #endregion
