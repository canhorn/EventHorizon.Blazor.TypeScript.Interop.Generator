...
public class Image : Control
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Image", "STRETCH_NONE");
    }

    public static async ValueTask<decimal> get_STRETCH_FILL()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Image", "STRETCH_FILL");
    }

    public static async ValueTask<decimal> get_STRETCH_UNIFORM()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Image", "STRETCH_UNIFORM");
    }

    public static async ValueTask<decimal> get_STRETCH_EXTEND()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Image", "STRETCH_EXTEND");
    }

    public static async ValueTask<decimal> get_STRETCH_NINE_PATCH()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Image", "STRETCH_NINE_PATCH");
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "detectPointerOnOpaqueOnly");
    }
    ...
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Image" }, name, url);
    ...
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Image" }, name);
