...
public class AbstractMesh : TransformNode, _IDisposable, ICullable, IGetSetVerticesData
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("AbstractMesh", "BILLBOARDMODE_NONE");
    }

    public static async ValueTask<decimal> get_BILLBOARDMODE_X()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("AbstractMesh", "BILLBOARDMODE_X");
    }

    public static async ValueTask<decimal> get_BILLBOARDMODE_Y()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("AbstractMesh", "BILLBOARDMODE_Y");
    }

    public static async ValueTask<decimal> get_BILLBOARDMODE_Z()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("AbstractMesh", "BILLBOARDMODE_Z");
    }

    public static async ValueTask<decimal> get_BILLBOARDMODE_ALL()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("AbstractMesh", "BILLBOARDMODE_ALL");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("AbstractMesh", "OCCLUSION_TYPE_NONE");
    }

    public static ValueTask set_OCCLUSION_TYPE_NONE(decimal value)
    {
        return EventHorizonBlazorInterop.Set("AbstractMesh", "OCCLUSION_TYPE_NONE", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("AbstractMesh", "OCCLUSION_TYPE_OPTIMISTIC", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("AbstractMesh", "OCCLUSION_TYPE_STRICT", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "partitioningBBoxRatio");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "computeBonesUsingShaders");
    }
    ...
    public ValueTask set_onMaterialChangedObservable(Observable<AbstractMesh> value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "onMaterialChangedObservable", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "showSubMeshesBoundingBox");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "enablePointerMoveEvents");
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "useOctreeForRenderingSelection", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useOctreeForCollisions");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "alwaysSelectAsActiveMesh");
    }
