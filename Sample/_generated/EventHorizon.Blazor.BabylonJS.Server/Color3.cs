...
public class Color3 : CachedEntityObject
{
    ...
    public static async ValueTask HSVtoRGBToRef(
        decimal hue,
        decimal saturation,
        decimal value,
        Color3 result
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Color3", "HSVtoRGBToRef" },
                hue,
                saturation,
                value,
                result
    ...
    public static async ValueTask<Color3> FromHexString(string hex)
    {
        return await EventHorizonBlazorInterop.FuncClass<Color3>(
            ...
            new object[] { new string[] { "Color3", "FromHexString" }, hex }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Color3>(
            entity => new Color3() { ___guid = entity.___guid },
            new object[] { new string[] { "Color3", "FromArray" }, array, offset }
        );
    }
    ...
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Color3", "FromArrayToRef" }, array, offset, result }
        );
    }
    ...
    public static async ValueTask<Color3> FromInts(decimal r, decimal g, decimal b)
    {
        return await EventHorizonBlazorInterop.FuncClass<Color3>(
            entity => new Color3() { ___guid = entity.___guid },
            new object[] { new string[] { "Color3", "FromInts" }, r, g, b }
        );
    }
    ...
    public static async ValueTask<Color3> Lerp(Color3 start, Color3 end, decimal amount)
    {
        return await EventHorizonBlazorInterop.FuncClass<Color3>(
            entity => new Color3() { ___guid = entity.___guid },
            new object[] { new string[] { "Color3", "Lerp" }, start, end, amount }
        );
    }
    ...
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Color3", "LerpToRef" }, left, right, amount, result }
        );
    }
    ...
    public static async ValueTask<Color3> Red()
    {
        return await EventHorizonBlazorInterop.FuncClass<Color3>(
            entity => new Color3() { ___guid = entity.___guid },
            new object[] { new string[] { "Color3", "Red" } }
        );
    }
    ...
    public static async ValueTask<Color3> Green()
    {
        return await EventHorizonBlazorInterop.FuncClass<Color3>(
            entity => new Color3() { ___guid = entity.___guid },
            new object[] { new string[] { "Color3", "Green" } }
        );
    }
    ...
    public static async ValueTask<Color3> Blue()
    {
        return await EventHorizonBlazorInterop.FuncClass<Color3>(
            entity => new Color3() { ___guid = entity.___guid },
            new object[] { new string[] { "Color3", "Blue" } }
        );
    }
    ...
    public static async ValueTask<Color3> Black()
    {
        return await EventHorizonBlazorInterop.FuncClass<Color3>(
            entity => new Color3() { ___guid = entity.___guid },
            new object[] { new string[] { "Color3", "Black" } }
        );
    }
    ...
    public static async ValueTask<Color3> White()
    {
        return await EventHorizonBlazorInterop.FuncClass<Color3>(
            entity => new Color3() { ___guid = entity.___guid },
            new object[] { new string[] { "Color3", "White" } }
        );
    }
    ...
    public static async ValueTask<Color3> Purple()
    {
        return await EventHorizonBlazorInterop.FuncClass<Color3>(
            entity => new Color3() { ___guid = entity.___guid },
            new object[] { new string[] { "Color3", "Purple" } }
        );
    }
    ...
    public static async ValueTask<Color3> Magenta()
    {
        return await EventHorizonBlazorInterop.FuncClass<Color3>(
            entity => new Color3() { ___guid = entity.___guid },
            new object[] { new string[] { "Color3", "Magenta" } }
        );
    }
    ...
    public static async ValueTask<Color3> Yellow()
    {
        return await EventHorizonBlazorInterop.FuncClass<Color3>(
            entity => new Color3() { ___guid = entity.___guid },
            new object[] { new string[] { "Color3", "Yellow" } }
        );
    }
    ...
    public static async ValueTask<Color3> Gray()
    {
        return await EventHorizonBlazorInterop.FuncClass<Color3>(
            entity => new Color3() { ___guid = entity.___guid },
            new object[] { new string[] { "Color3", "Gray" } }
        );
    }
    ...
    public static async ValueTask<Color3> Teal()
    {
        return await EventHorizonBlazorInterop.FuncClass<Color3>(
            entity => new Color3() { ___guid = entity.___guid },
            new object[] { new string[] { "Color3", "Teal" } }
        );
    }
    ...
    public static async ValueTask<Color3> Random()
    {
        return await EventHorizonBlazorInterop.FuncClass<Color3>(
            entity => new Color3() { ___guid = entity.___guid },
            new object[] { new string[] { "Color3", "Random" } }
        );
    }
    #endregion
    ...
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Color3" }, r, g, b);
    ...
    public async ValueTask<Color3> clampToRef(
        Color3 result,
