...
public class DynamicTexture : Texture
{
    ...
    public static async ValueTask<DynamicTexture> NewDynamicTexture(Scene sceneOrEngine)
    {
        var entity = await EventHorizonBlazorInterop.New(
            new string[] { "DynamicTexture" },
            sceneOrEngine
    ...
    public static async ValueTask<DynamicTexture> NewDynamicTexture(InternalTexture internalTexture)
    {
        var entity = await EventHorizonBlazorInterop.New(
            new string[] { "DynamicTexture" },
            internalTexture
