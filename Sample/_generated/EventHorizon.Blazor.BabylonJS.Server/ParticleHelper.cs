...
public class ParticleHelper : CachedEntityObject
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<string>("ParticleHelper", "BaseAssetsUrl");
    }

    public static ValueTask set_BaseAssetsUrl(string value)
    {
        return EventHorizonBlazorInterop.Set("ParticleHelper", "BaseAssetsUrl", value);
    }

    public static async ValueTask<string> get_SnippetUrl()
    {
        return await EventHorizonBlazorInterop.Get<string>("ParticleHelper", "SnippetUrl");
    }

    public static ValueTask set_SnippetUrl(string value)
    {
        return EventHorizonBlazorInterop.Set("ParticleHelper", "SnippetUrl", value);
    }
    #endregion
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<IParticleSystemCachedEntity>(
            ...
            new object[]
            {
                new string[] { "ParticleHelper", "CreateDefault" },
                emitter,
                capacity,
                scene,
                useGPU
    ...
    )
    {
        return await EventHorizonBlazorInterop.TaskClass<ParticleSystemSet>(
            ...
            new object[] { new string[] { "ParticleHelper", "CreateAsync" }, type, scene, gpu }
        );
    }
    ...
    public static async ValueTask<ParticleSystemSet> ExportSet(IParticleSystem[] systems)
    {
        return await EventHorizonBlazorInterop.FuncClass<ParticleSystemSet>(
            entity => new ParticleSystemSet() { ___guid = entity.___guid },
            new object[] { new string[] { "ParticleHelper", "ExportSet" }, systems }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.TaskClass<IParticleSystemCachedEntity>(
            ...
            new object[]
            {
                new string[] { "ParticleHelper", "ParseFromFileAsync" },
                name,
                url,
                scene,
                gpu,
    ...
    )
    {
        return await EventHorizonBlazorInterop.TaskClass<IParticleSystemCachedEntity>(
            ...
            new object[]
            {
                new string[] { "ParticleHelper", "CreateFromSnippetAsync" },
                snippetId,
                scene,
                gpu,
                rootUrl
