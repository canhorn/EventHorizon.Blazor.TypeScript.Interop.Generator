...
public class Node : CachedEntityObject, IBehaviorAware<Node>
{
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Node", "AddNodeConstructor" }, type, constructorFunc }
        );
    }
    ...
    public static async ValueTask<Node> Construct()
    {
        return await EventHorizonBlazorInterop.FuncClass<Node>(
            ...
            new object[] { new string[] { "Node", "Construct" } }
        );
    }
    ...
    public static async ValueTask ParseAnimationRanges(Node node, object parsedNode, Scene scene)
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Node", "ParseAnimationRanges" },
                node,
                parsedNode,
                scene
            }
    ...
    {
        return await EventHorizonBlazorInterop.Get<ActionCallback<Node>>(this.___guid, "onReady");
    }
    ...
    public static async ValueTask<Node> NewNode(string name, Scene scene = null)
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Node" }, name, scene);
    ...
    public async ValueTask<Node[]> getDescendants(
    ...
    public async ValueTask<Node[]> getChildren(
        ActionResultCallback<Node, bool> predicate = null,
        System.Nullable<bool> directDescendantsOnly = null
    )
    {
