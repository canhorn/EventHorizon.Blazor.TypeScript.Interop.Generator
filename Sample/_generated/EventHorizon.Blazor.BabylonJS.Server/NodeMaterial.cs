...
public class NodeMaterial : PushMaterial
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<string>("NodeMaterial", "EditorURL");
    }

    public static ValueTask set_EditorURL(string value)
    {
        return EventHorizonBlazorInterop.Set("NodeMaterial", "EditorURL", value);
    }

    public static async ValueTask<string> get_SnippetUrl()
    {
        return await EventHorizonBlazorInterop.Get<string>("NodeMaterial", "SnippetUrl");
    }

    public static ValueTask set_SnippetUrl(string value)
    {
        return EventHorizonBlazorInterop.Set("NodeMaterial", "SnippetUrl", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("NodeMaterial", "IgnoreTexturesAtLoadTime", value);
    }
    #endregion
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<NodeMaterial>(
            ...
            new object[] { new string[] { "NodeMaterial", "Parse" }, source, scene, rootUrl }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.TaskClass<NodeMaterial>(
            entity => new NodeMaterial() { ___guid = entity.___guid },
            new object[] { new string[] { "NodeMaterial", "ParseFromFileAsync" }, name, url, scene }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.TaskClass<NodeMaterial>(
            ...
            new object[]
            {
                new string[] { "NodeMaterial", "ParseFromSnippetAsync" },
                snippetId,
                scene,
                rootUrl,
                nodeMaterial
    ...
    public static async ValueTask<NodeMaterial> CreateDefault(string name, Scene scene = null)
    {
        return await EventHorizonBlazorInterop.FuncClass<NodeMaterial>(
            entity => new NodeMaterial() { ___guid = entity.___guid },
            new object[] { new string[] { "NodeMaterial", "CreateDefault" }, name, scene }
        );
    }
    #endregion
    ...
    public static async ValueTask<NodeMaterial> NewNodeMaterial(string name, Scene scene)
    {
        var entity = await EventHorizonBlazorInterop.New(
            new string[] { "NodeMaterial" },
            name,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<InputBlock>(
            ...
            new object[] { new string[] { this.___guid, "getInputBlockByPredicate" }, predicate }
        );
    }
    ...
    public async ValueTask<ProceduralTexture> createProceduralTexture(decimal size, Scene scene)
    {
        return await EventHorizonBlazorInterop.FuncClass<ProceduralTexture>(
            ...
            new object[] { new string[] { this.___guid, "createProceduralTexture" }, size, scene }
        );
    }
