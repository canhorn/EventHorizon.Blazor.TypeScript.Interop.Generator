...
public class ImageProcessingConfiguration : CachedEntityObject
{
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "ImageProcessingConfiguration", "PrepareUniforms" },
                uniforms,
                defines
            }
        );
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "ImageProcessingConfiguration", "PrepareSamplers" },
                samplersList,
                defines
            }
        );
    ...
    public static async ValueTask<ImageProcessingConfiguration> Parse(object source)
    {
        return await EventHorizonBlazorInterop.FuncClass<ImageProcessingConfiguration>(
            ...
            new object[] { new string[] { "ImageProcessingConfiguration", "Parse" }, source }
        );
    }
    #endregion
