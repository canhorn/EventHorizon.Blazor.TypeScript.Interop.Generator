...
public class EasingFunction : CachedEntityObject, IEasingFunction
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("EasingFunction", "EASINGMODE_EASEIN");
    }

    public static async ValueTask<decimal> get_EASINGMODE_EASEOUT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("EasingFunction", "EASINGMODE_EASEOUT");
    }
