...
namespace BABYLON
{
    ...
    public class Camera : Node
    {
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Camera.RIG_MODE_WEBVR");
        }
        ...
        public static async ValueTask<string> GetConstructorFromName(Func<Task> callback)
        {
