...
public class Geometry : CachedEntityObject, IGetSetVerticesData
{
    ...
    public static async ValueTask<Geometry> CreateGeometryForMesh(Mesh mesh)
    {
        return await EventHorizonBlazorInterop.FuncClass<Geometry>(
            ...
            new object[] { new string[] { "Geometry", "CreateGeometryForMesh" }, mesh }
        );
    }
    ...
    public static async ValueTask<Geometry> ExtractFromMesh(Mesh mesh, string id)
    {
        return await EventHorizonBlazorInterop.FuncClass<Geometry>(
            entity => new Geometry() { ___guid = entity.___guid },
            new object[] { new string[] { "Geometry", "ExtractFromMesh" }, mesh, id }
        );
    }
    ...
    public static async ValueTask<string> RandomId()
    {
        return await EventHorizonBlazorInterop.Func<string>(
            new object[] { new string[] { "Geometry", "RandomId" } }
        );
    }

    public static async ValueTask<Geometry> Parse(
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Geometry>(
            entity => new Geometry() { ___guid = entity.___guid },
            new object[] { new string[] { "Geometry", "Parse" }, parsedVertexData, scene, rootUrl }
        );
    }
    #endregion
    ...
    {
        __boundingBias = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "boundingBias", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<CachedEntity>(this.___guid, "extend");
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "useBoundingInfoFromGeometry", value);
    }
    #endregion
    ...
    #region Methods
    public async ValueTask onGeometryUpdated(Geometry geometry, string kind = null)
    {
    ...
    public async ValueTask setAllVerticesData(
    ...
    public async ValueTask setVerticesData(
        string kind,
        decimal[] data,
        System.Nullable<bool> updatable = null,
    ...
    public async ValueTask setVerticesBuffer(
        VertexBuffer buffer,
    ...
    public async ValueTask updateVerticesDataDirectly(
        string kind,
        decimal[] data,
        decimal offset,
    ...
    public async ValueTask updateVerticesData(
        string kind,
        decimal[] data,
    ...
    public async ValueTask updateIndices(
        decimal[] indices,
    ...
    public async ValueTask setIndices(
        decimal[] indices,
        System.Nullable<decimal> totalVertices = null,
        System.Nullable<bool> updatable = null
    )
