...
public class MultiMaterial : Material
{
    ...
    public static async ValueTask<MultiMaterial> ParseMultiMaterial(
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<MultiMaterial>(
            ...
            new object[]
            {
                new string[] { "MultiMaterial", "ParseMultiMaterial" },
                parsedMultiMaterial,
                scene
            }
        );
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "subMaterials", value);
    }
    #endregion
    ...
    public static async ValueTask<MultiMaterial> NewMultiMaterial(string name, Scene scene)
    {
        var entity = await EventHorizonBlazorInterop.New(
            new string[] { "MultiMaterial" },
            name,
            scene
        );
    ...
    public async ValueTask<MultiMaterial> clone(
        string name,
