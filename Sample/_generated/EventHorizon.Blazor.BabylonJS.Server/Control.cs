...
public class Control : CachedEntityObject
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Control", "HORIZONTAL_ALIGNMENT_LEFT");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Control", "VERTICAL_ALIGNMENT_TOP");
    }

    public static async ValueTask<decimal> get_VERTICAL_ALIGNMENT_BOTTOM()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Control", "VERTICAL_ALIGNMENT_BOTTOM");
    }

    public static async ValueTask<decimal> get_VERTICAL_ALIGNMENT_CENTER()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Control", "VERTICAL_ALIGNMENT_CENTER");
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>("Control", "AllowAlphaInheritance");
    }

    public static ValueTask set_AllowAlphaInheritance(bool value)
    {
        return EventHorizonBlazorInterop.Set("Control", "AllowAlphaInheritance", value);
    }
    #endregion
    ...
    )
    {
        return await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Control", "AddHeader" }, control, text, size, options }
        );
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "horizontalAlignment");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "paddingLeftInPixels");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "paddingRightInPixels");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "paddingBottomInPixels");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "linkOffsetXInPixels");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "linkOffsetYInPixels");
    }
    ...
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Control" }, name);
