...
public class Size : CachedEntityObject, ISize
{
    ...
    public static async ValueTask<Size> Zero()
    {
        return await EventHorizonBlazorInterop.FuncClass<Size>(
            ...
            new object[] { new string[] { "Size", "Zero" } }
        );
    }
    ...
    public static async ValueTask<Size> Lerp(Size start, Size end, decimal amount)
    {
        return await EventHorizonBlazorInterop.FuncClass<Size>(
            entity => new Size() { ___guid = entity.___guid },
            new object[] { new string[] { "Size", "Lerp" }, start, end, amount }
        );
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "surface");
    }
    #endregion
    ...
    public static async ValueTask<Size> NewSize(decimal width, decimal height)
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Size" }, width, height);
