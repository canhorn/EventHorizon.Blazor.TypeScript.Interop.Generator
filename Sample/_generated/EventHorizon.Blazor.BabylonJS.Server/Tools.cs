...
namespace BABYLON
{
    ...
    public class Tools : CachedEntityObject
    {
        ...
        public static async ValueTask<string> OnNewCacheEntry(Func<Task> callback)
        {
        ...
        public static async ValueTask<string> StartPerformanceCounter(Func<Task> callback)
        {
        ...
        public static async ValueTask<string> EndPerformanceCounter(Func<Task> callback)
        {
