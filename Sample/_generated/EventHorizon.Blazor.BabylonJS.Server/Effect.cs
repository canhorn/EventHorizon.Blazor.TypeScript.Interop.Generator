...
public class Effect : CachedEntityObject, _IDisposable
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<string>("Effect", "ShadersRepository");
    }

    public static ValueTask set_ShadersRepository(string value)
    {
        return EventHorizonBlazorInterop.Set("Effect", "ShadersRepository", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("Effect", "LogShaderCodeOnCompilationError", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("Effect", "ShadersStore", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("Effect", "IncludesShadersStore", value);
    }
    #endregion
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Effect", "RegisterShader" },
                name,
                pixelShader,
                vertexShader
            }
    ...
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Effect", "ResetCache" } }
        );
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<string>(this.___guid, "rawFragmentSourceCode");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<ActionCallback<Effect>>(this.___guid, "onBind");
    }
