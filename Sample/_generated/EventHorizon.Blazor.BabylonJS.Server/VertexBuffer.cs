...
public class VertexBuffer : CachedEntityObject
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("VertexBuffer", "BYTE");
    }

    public static async ValueTask<decimal> get_UNSIGNED_BYTE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("VertexBuffer", "UNSIGNED_BYTE");
    }

    public static async ValueTask<decimal> get_SHORT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("VertexBuffer", "SHORT");
    }

    public static async ValueTask<decimal> get_UNSIGNED_SHORT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("VertexBuffer", "UNSIGNED_SHORT");
    }

    public static async ValueTask<decimal> get_INT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("VertexBuffer", "INT");
    }

    public static async ValueTask<decimal> get_UNSIGNED_INT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("VertexBuffer", "UNSIGNED_INT");
    }

    public static async ValueTask<decimal> get_FLOAT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("VertexBuffer", "FLOAT");
    }

    public static async ValueTask<string> get_PositionKind()
    {
        return await EventHorizonBlazorInterop.Get<string>("VertexBuffer", "PositionKind");
    }

    public static async ValueTask<string> get_NormalKind()
    {
        return await EventHorizonBlazorInterop.Get<string>("VertexBuffer", "NormalKind");
    }

    public static async ValueTask<string> get_TangentKind()
    {
        return await EventHorizonBlazorInterop.Get<string>("VertexBuffer", "TangentKind");
    }

    public static async ValueTask<string> get_UVKind()
    {
        return await EventHorizonBlazorInterop.Get<string>("VertexBuffer", "UVKind");
    }

    public static async ValueTask<string> get_UV2Kind()
    {
        return await EventHorizonBlazorInterop.Get<string>("VertexBuffer", "UV2Kind");
    }

    public static async ValueTask<string> get_UV3Kind()
    {
        return await EventHorizonBlazorInterop.Get<string>("VertexBuffer", "UV3Kind");
    }

    public static async ValueTask<string> get_UV4Kind()
    {
        return await EventHorizonBlazorInterop.Get<string>("VertexBuffer", "UV4Kind");
    }

    public static async ValueTask<string> get_UV5Kind()
    {
        return await EventHorizonBlazorInterop.Get<string>("VertexBuffer", "UV5Kind");
    }

    public static async ValueTask<string> get_UV6Kind()
    {
        return await EventHorizonBlazorInterop.Get<string>("VertexBuffer", "UV6Kind");
    }

    public static async ValueTask<string> get_ColorKind()
    {
        return await EventHorizonBlazorInterop.Get<string>("VertexBuffer", "ColorKind");
    }

    public static async ValueTask<string> get_MatricesIndicesKind()
    {
        return await EventHorizonBlazorInterop.Get<string>("VertexBuffer", "MatricesIndicesKind");
    }

    public static async ValueTask<string> get_MatricesWeightsKind()
    {
        return await EventHorizonBlazorInterop.Get<string>("VertexBuffer", "MatricesWeightsKind");
    }
    ...
    public static async ValueTask<decimal> DeduceStride(string kind)
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "VertexBuffer", "DeduceStride" }, kind }
        );
    }
    ...
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "VertexBuffer", "GetTypeByteLength" }, type }
        );
    }

    public static async ValueTask ForEach(
        decimal[] data,
        decimal byteOffset,
        decimal byteStride,
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "VertexBuffer", "ForEach" },
                data,
                byteOffset,
                byteStride,
                componentCount,
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "instanceDivisor");
    }

    public ValueTask set_instanceDivisor(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "instanceDivisor", value);
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "byteOffset");
    }
    ...
    public static async ValueTask<VertexBuffer> NewVertexBuffer(
        ...
        System.Nullable<bool> takeBufferOwnership = null
    )
    {
        var entity = await EventHorizonBlazorInterop.New(
            new string[] { "VertexBuffer" },
            engine,
            data,
            kind,
            updatable,
