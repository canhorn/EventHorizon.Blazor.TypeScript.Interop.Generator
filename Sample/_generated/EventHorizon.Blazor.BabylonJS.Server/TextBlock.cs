...
public class TextBlock : Control
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "textVerticalAlignment");
    }
    ...
    public static async ValueTask<TextBlock> NewTextBlock(string name = null, string text = null)
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "TextBlock" }, name, text);
    ...
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "TextBlock" }, name);
