...
public class Color4 : CachedEntityObject
{
    ...
    public static async ValueTask<Color4> FromHexString(string hex)
    {
        return await EventHorizonBlazorInterop.FuncClass<Color4>(
            ...
            new object[] { new string[] { "Color4", "FromHexString" }, hex }
        );
    }
    ...
    public static async ValueTask<Color4> Lerp(Color4 left, Color4 right, decimal amount)
    {
        return await EventHorizonBlazorInterop.FuncClass<Color4>(
            entity => new Color4() { ___guid = entity.___guid },
            new object[] { new string[] { "Color4", "Lerp" }, left, right, amount }
        );
    }
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Color4", "LerpToRef" }, left, right, amount, result }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Color4>(
            entity => new Color4() { ___guid = entity.___guid },
            new object[] { new string[] { "Color4", "FromColor3" }, color3, alpha }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Color4>(
            entity => new Color4() { ___guid = entity.___guid },
            new object[] { new string[] { "Color4", "FromArray" }, array, offset }
        );
    }
    ...
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Color4", "FromArrayToRef" }, array, offset, result }
        );
    }
    ...
    public static async ValueTask<Color4> FromInts(decimal r, decimal g, decimal b, decimal a)
    {
        return await EventHorizonBlazorInterop.FuncClass<Color4>(
            entity => new Color4() { ___guid = entity.___guid },
            new object[] { new string[] { "Color4", "FromInts" }, r, g, b, a }
        );
    }
    ...
    public static async ValueTask<decimal[]> CheckColors4(decimal[] colors, decimal count)
    {
        return await EventHorizonBlazorInterop.FuncArray<decimal>(
            new object[] { new string[] { "Color4", "CheckColors4" }, colors, count }
        );
    }
    #endregion
    ...
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Color4" }, r, g, b, a);
