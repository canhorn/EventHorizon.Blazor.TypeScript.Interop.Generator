...
public class ISoundOptionsCachedEntity : CachedEntityObject, ISoundOptions
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "volume");
    }

    public ValueTask set_volume(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "volume", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "playbackRate");
    }

    public ValueTask set_playbackRate(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "playbackRate", value);
    }

    public async ValueTask<bool> get_streaming()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "streaming");
    }

    public ValueTask set_streaming(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "streaming", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "skipCodecCheck");
    }

    public ValueTask set_skipCodecCheck(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "skipCodecCheck", value);
    }
    #endregion
    ...
    public ISoundOptionsCachedEntity(ICachedEntity entity)
        : base(entity) { }
