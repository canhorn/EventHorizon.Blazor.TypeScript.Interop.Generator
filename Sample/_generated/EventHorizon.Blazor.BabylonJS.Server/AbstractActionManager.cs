...
public class AbstractActionManager : CachedEntityObject, _IDisposable
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>("AbstractActionManager", "HasTriggers");
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("AbstractActionManager", "Triggers", value);
    }
    #endregion
    ...
    public static async ValueTask<bool> HasSpecificTrigger(decimal trigger)
    {
        return await EventHorizonBlazorInterop.Func<bool>(
            new object[] { new string[] { "AbstractActionManager", "HasSpecificTrigger" }, trigger }
        );
    }
    #endregion
