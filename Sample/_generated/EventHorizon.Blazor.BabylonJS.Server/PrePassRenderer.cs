...
public class PrePassRenderer : CachedEntityObject
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useGeometryBufferFallback");
    }

    public ValueTask set_useGeometryBufferFallback(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "useGeometryBufferFallback", value);
    }
    ...
    {
        __prePassRT = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "prePassRT", value);
    }
    ...
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "PrePassRenderer" }, scene);
