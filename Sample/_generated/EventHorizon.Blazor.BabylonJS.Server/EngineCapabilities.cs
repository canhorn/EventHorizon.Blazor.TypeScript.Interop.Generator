...
public class EngineCapabilitiesCachedEntity : CachedEntityObject, EngineCapabilities
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "maxTexturesImageUnits");
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "maxCombinedTexturesImageUnits", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "maxCubemapTextureSize");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "maxRenderTextureSize");
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "highPrecisionShaderSupported", value);
    }

    public async ValueTask<bool> get_fragmentDepthSupported()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "fragmentDepthSupported");
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "textureFloatLinearFiltering", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "textureHalfFloatRender");
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "canUseTimestampForTimerQuery", value);
    }
