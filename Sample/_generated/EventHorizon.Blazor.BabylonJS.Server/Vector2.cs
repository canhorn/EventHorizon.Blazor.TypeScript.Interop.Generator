...
public class Vector2 : CachedEntityObject
{
    ...
    public static async ValueTask<Vector2> Zero()
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector2>(
            ...
            new object[] { new string[] { "Vector2", "Zero" } }
        );
    }
    ...
    public static async ValueTask<Vector2> One()
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector2>(
            entity => new Vector2() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector2", "One" } }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector2>(
            entity => new Vector2() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector2", "FromArray" }, array, offset }
        );
    }
    ...
    public static async ValueTask FromArrayToRef(decimal[] array, decimal offset, Vector2 result)
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Vector2", "FromArrayToRef" }, array, offset, result }
        );
    }
    ...
    public static async ValueTask<Vector2> Clamp(Vector2 value, Vector2 min, Vector2 max)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector2>(
            entity => new Vector2() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector2", "Clamp" }, value, min, max }
        );
    }
    ...
    public static async ValueTask<Vector2> Lerp(Vector2 start, Vector2 end, decimal amount)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector2>(
            entity => new Vector2() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector2", "Lerp" }, start, end, amount }
        );
    }
    ...
    public static async ValueTask<decimal> Dot(Vector2 left, Vector2 right)
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "Vector2", "Dot" }, left, right }
        );
    }
    ...
    public static async ValueTask<Vector2> Normalize(Vector2 vector)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector2>(
            entity => new Vector2() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector2", "Normalize" }, vector }
        );
    }
    ...
    public static async ValueTask<Vector2> Minimize(Vector2 left, Vector2 right)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector2>(
            entity => new Vector2() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector2", "Minimize" }, left, right }
        );
    }
    ...
    public static async ValueTask<Vector2> Maximize(Vector2 left, Vector2 right)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector2>(
            entity => new Vector2() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector2", "Maximize" }, left, right }
        );
    }
    ...
    public static async ValueTask<Vector2> Transform(Vector2 vector, Matrix transformation)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector2>(
            entity => new Vector2() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector2", "Transform" }, vector, transformation }
        );
    }

    public static async ValueTask TransformToRef(
        Vector2 vector,
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Vector2", "TransformToRef" },
                vector,
                transformation,
                result
            }
    ...
    )
    {
        return await EventHorizonBlazorInterop.Func<bool>(
            new object[] { new string[] { "Vector2", "PointInTriangle" }, p, p0, p1, p2 }
        );
    }
    ...
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "Vector2", "Distance" }, value1, value2 }
        );
    }
    ...
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "Vector2", "DistanceSquared" }, value1, value2 }
        );
    }
    ...
    public static async ValueTask<Vector2> Center(Vector2 value1, Vector2 value2)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector2>(
            entity => new Vector2() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector2", "Center" }, value1, value2 }
        );
    }
    ...
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "Vector2", "DistanceOfPointFromSegment" }, p, segA, segB }
        );
    }
    #endregion
    ...
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Vector2" }, x, y);
