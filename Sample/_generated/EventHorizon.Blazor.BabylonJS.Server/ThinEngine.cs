...
public class ThinEngine : CachedEntityObject
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<string>("ThinEngine", "NpmPackage");
    }

    public static async ValueTask<string> get_Version()
    {
        return await EventHorizonBlazorInterop.Get<string>("ThinEngine", "Version");
    }

    public static async ValueTask<string> get_ShadersRepository()
    {
        return await EventHorizonBlazorInterop.Get<string>("ThinEngine", "ShadersRepository");
    }

    public static ValueTask set_ShadersRepository(string value)
    {
        return EventHorizonBlazorInterop.Set("ThinEngine", "ShadersRepository", value);
    }

    public static async ValueTask<bool> get_IsSupported()
    {
        return await EventHorizonBlazorInterop.Get<bool>("ThinEngine", "IsSupported");
    }

    public static async ValueTask<bool> get_HasMajorPerformanceCaveat()
    {
        return await EventHorizonBlazorInterop.Get<bool>("ThinEngine", "HasMajorPerformanceCaveat");
    }
    #endregion
    ...
    {
        return EventHorizonBlazorInterop.Set("ThinEngine", "ExceptionList", value);
    }

    public static async ValueTask<decimal> get_CollisionsEpsilon()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ThinEngine", "CollisionsEpsilon");
    }

    public static ValueTask set_CollisionsEpsilon(decimal value)
    {
        return EventHorizonBlazorInterop.Set("ThinEngine", "CollisionsEpsilon", value);
    }
    #endregion
    ...
    public static async ValueTask<bool> isSupported()
    {
        return await EventHorizonBlazorInterop.Func<bool>(
            new object[] { new string[] { "ThinEngine", "isSupported" } }
        );
    }
    ...
    public static async ValueTask<decimal> CeilingPOT(decimal x)
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "ThinEngine", "CeilingPOT" }, x }
        );
    }
    ...
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "ThinEngine", "FloorPOT" }, x }
        );
    }
    ...
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "ThinEngine", "NearestPOT" }, x }
        );
    }
    ...
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "ThinEngine", "GetExponentOfTwo" }, value, max, mode }
        );
    }
    ...
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "ThinEngine", "QueueNewFrame" }, func, requester }
        );
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "supportsUniformBuffers");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "doNotHandleContextLost");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "renderEvenInBackground");
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "preventCacheWipeBetweenFrames", value);
    }

    public async ValueTask<bool> get_validateShaderPrograms()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "validateShaderPrograms");
    }
    ...
    public ValueTask set_onContextRestoredObservable(Observable<ThinEngine> value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "onContextRestoredObservable", value);
    }

    public async ValueTask<bool> get_disableVertexArrayObjects()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "disableVertexArrayObjects");
    }
    ...
    private Observable<CachedEntityObject> __onBeforeTextureInitObservable;

    public async ValueTask<Observable<CachedEntityObject>> get_onBeforeTextureInitObservable()
    {
        if (__onBeforeTextureInitObservable == null)
        {
            ...
            >(
                ...
                (entity) =>
                {
                    return new Observable<CachedEntityObject>() { ___guid = entity.___guid };
                }
            );
        }
    ...
    public ValueTask set_onBeforeTextureInitObservable(Observable<CachedEntityObject> value)
    {
        __onBeforeTextureInitObservable = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "onBeforeTextureInitObservable", value);
    }

    public async ValueTask<bool> get_enableUnpackFlipYCached()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "enableUnpackFlipYCached");
    }
    ...
    public async ValueTask<WebGLVertexArrayObjectCachedEntity> recordVertexArrayObject(
    ...
    public async ValueTask<string> attachContextLostEvent(Func<Task> callback)
    {
    ...
    public async ValueTask<string> attachContextRestoredEvent(Func<Task> callback)
    {
    ...
    public async ValueTask<decimal[]> readPixels(
        decimal x,
        decimal y,
        decimal width,
        decimal height,
