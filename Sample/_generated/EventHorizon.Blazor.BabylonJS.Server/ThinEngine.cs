...
namespace BABYLON
{
    ...
    public class ThinEngine : CachedEntityObject
    {
        ...
        {
            return await EventHorizonBlazorInterop.Get<string>("BABYLON", "ThinEngine.NpmPackage");
        }

        public static async ValueTask<string> get_Version()
        {
            return await EventHorizonBlazorInterop.Get<string>("BABYLON", "ThinEngine.Version");
        }
