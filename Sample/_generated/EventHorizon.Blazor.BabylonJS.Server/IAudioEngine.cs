...
public class IAudioEngineCachedEntity : CachedEntityObject, IAudioEngine
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "WarnedWebAudioUnsupported");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useCustomUnlockedButton");
    }
