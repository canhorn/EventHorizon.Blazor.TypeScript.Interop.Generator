...
public class ValueAndUnit : CachedEntityObject
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ValueAndUnit", "UNITMODE_PERCENTAGE");
    }

    public static async ValueTask<decimal> get_UNITMODE_PIXEL()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ValueAndUnit", "UNITMODE_PIXEL");
    }
    #endregion
