...
public class PostProcess : CachedEntityObject
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "enablePixelPerfectMode");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "forceFullscreenViewport");
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "adaptScaleToCurrentViewport", value);
    }
    ...
    public async ValueTask<InternalTexture> activate(
        Camera camera,
