...
public class AssetContainer : AbstractScene
{
    ...
    public static async ValueTask<AssetContainer> NewAssetContainer(Scene scene)
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "AssetContainer" }, scene);
