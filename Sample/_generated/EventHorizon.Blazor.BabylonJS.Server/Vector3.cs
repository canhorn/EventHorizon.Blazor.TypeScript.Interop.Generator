...
public class Vector3 : CachedEntityObject
{
    ...
    )
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[]
            {
                new string[] { "Vector3", "GetClipFactor" },
                vector0,
                vector1,
                axis,
                size
    ...
    )
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[]
            {
                new string[] { "Vector3", "GetAngleBetweenVectors" },
                vector0,
                vector1,
                normal
            }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            ...
            new object[] { new string[] { "Vector3", "FromArray" }, array, offset }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "FromFloatArray" }, array, offset }
        );
    }
    ...
    public static async ValueTask FromArrayToRef(decimal[] array, decimal offset, Vector3 result)
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Vector3", "FromArrayToRef" }, array, offset, result }
        );
    }

    public static async ValueTask FromFloatArrayToRef(
        decimal[] array,
        decimal offset,
        Vector3 result
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Vector3", "FromFloatArrayToRef" },
                array,
                offset,
                result
            }
    ...
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Vector3", "FromFloatsToRef" }, x, y, z, result }
        );
    }
    ...
    public static async ValueTask<Vector3> Zero()
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "Zero" } }
        );
    }
    ...
    public static async ValueTask<Vector3> One()
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "One" } }
        );
    }
    ...
    public static async ValueTask<Vector3> Up()
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "Up" } }
        );
    }
    ...
    public static async ValueTask<Vector3> Down()
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "Down" } }
        );
    }
    ...
    public static async ValueTask<Vector3> Forward(System.Nullable<bool> rightHandedSystem = null)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "Forward" }, rightHandedSystem }
        );
    }
    ...
    public static async ValueTask<Vector3> Backward(System.Nullable<bool> rightHandedSystem = null)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "Backward" }, rightHandedSystem }
        );
    }
    ...
    public static async ValueTask<Vector3> Right()
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "Right" } }
        );
    }
    ...
    public static async ValueTask<Vector3> Left()
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "Left" } }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            ...
            new object[]
            {
                new string[] { "Vector3", "TransformCoordinates" },
                vector,
                transformation
            }
        );
    ...
    public static async ValueTask TransformCoordinatesToRef(
        Vector3 vector,
        Matrix transformation,
        Vector3 result
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Vector3", "TransformCoordinatesToRef" },
                vector,
                transformation,
                result
            }
    ...
    public static async ValueTask TransformCoordinatesFromFloatsToRef(
        decimal x,
        decimal y,
        decimal z,
        Matrix transformation,
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Vector3", "TransformCoordinatesFromFloatsToRef" },
                x,
                y,
                z,
                transformation,
    ...
    public static async ValueTask<Vector3> TransformNormal(Vector3 vector, Matrix transformation)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "TransformNormal" }, vector, transformation }
        );
    }

    public static async ValueTask TransformNormalToRef(
        Vector3 vector,
        Matrix transformation,
        Vector3 result
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Vector3", "TransformNormalToRef" },
                vector,
                transformation,
                result
            }
    ...
    public static async ValueTask TransformNormalFromFloatsToRef(
        decimal x,
        decimal y,
        decimal z,
        Matrix transformation,
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Vector3", "TransformNormalFromFloatsToRef" },
                x,
                y,
                z,
                transformation,
    ...
    public static async ValueTask<Vector3> Clamp(Vector3 value, Vector3 min, Vector3 max)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "Clamp" }, value, min, max }
        );
    }

    public static async ValueTask ClampToRef(
        Vector3 value,
        Vector3 min,
        Vector3 max,
        Vector3 result
    ...
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Vector3", "ClampToRef" }, value, min, max, result }
        );
    }
    ...
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Vector3", "CheckExtends" }, v, min, max }
        );
    }
    ...
    public static async ValueTask<Vector3> Lerp(Vector3 start, Vector3 end, decimal amount)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "Lerp" }, start, end, amount }
        );
    }
    ...
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Vector3", "LerpToRef" }, start, end, amount, result }
        );
    }
    ...
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "Vector3", "Dot" }, left, right }
        );
    }
    ...
    public static async ValueTask<Vector3> Cross(Vector3 left, Vector3 right)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "Cross" }, left, right }
        );
    }
    ...
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Vector3", "CrossToRef" }, left, right, result }
        );
    }
    ...
    public static async ValueTask<Vector3> Normalize(Vector3 vector)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "Normalize" }, vector }
        );
    }
    ...
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Vector3", "NormalizeToRef" }, vector, result }
        );
    }
    ...
    public static async ValueTask<Vector3> ProjectToRef(
        Vector3 vector,
        Matrix world,
        Matrix transform,
        Viewport viewport,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            ...
            new object[]
            {
                new string[] { "Vector3", "ProjectToRef" },
                vector,
                world,
                transform,
                viewport,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            ...
            new object[]
            {
                new string[] { "Vector3", "UnprojectFromTransform" },
                source,
                viewportWidth,
                viewportHeight,
                world,
    ...
    public static async ValueTask UnprojectToRef(
        Vector3 source,
        decimal viewportWidth,
        decimal viewportHeight,
        Matrix world,
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Vector3", "UnprojectToRef" },
                source,
                viewportWidth,
                viewportHeight,
                world,
    ...
    public static async ValueTask UnprojectFloatsToRef(
        decimal sourceX,
        decimal sourceY,
        decimal sourceZ,
        decimal viewportWidth,
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Vector3", "UnprojectFloatsToRef" },
                sourceX,
                sourceY,
                sourceZ,
                viewportWidth,
    ...
    public static async ValueTask<Vector3> Minimize(Vector3 left, Vector3 right)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "Minimize" }, left, right }
        );
    }
    ...
    public static async ValueTask<Vector3> Maximize(Vector3 left, Vector3 right)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "Maximize" }, left, right }
        );
    }
    ...
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "Vector3", "Distance" }, value1, value2 }
        );
    }
    ...
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "Vector3", "DistanceSquared" }, value1, value2 }
        );
    }
    ...
    public static async ValueTask<Vector3> Center(Vector3 value1, Vector3 value2)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "Center" }, value1, value2 }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            entity => new Vector3() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector3", "RotationFromAxis" }, axis1, axis2, axis3 }
        );
    }

    public static async ValueTask RotationFromAxisToRef(
        Vector3 axis1,
        Vector3 axis2,
        Vector3 axis3,
        Vector3 @ref
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Vector3", "RotationFromAxisToRef" },
                axis1,
                axis2,
                axis3,
                @ref
    ...
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Vector3" }, x, y, z);
    ...
    public async ValueTask<Vector3> subtractFromFloatsToRef(
        decimal x,
        decimal y,
        decimal z,
        Vector3 result
    ...
    public async ValueTask<Vector3> rotateByQuaternionAroundPointToRef(
