...
public class FramingBehavior : CachedEntityObject, Behavior<ArcRotateCamera>
{
    ...
    public static ValueTask set_EasingFunction(ExponentialEase value)
    {
        ...
        return EventHorizonBlazorInterop.Set("FramingBehavior", "EasingFunction", value);
    }

    public static async ValueTask<decimal> get_EasingMode()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("FramingBehavior", "EasingMode");
    }

    public static ValueTask set_EasingMode(decimal value)
    {
        return EventHorizonBlazorInterop.Set("FramingBehavior", "EasingMode", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("FramingBehavior", "IgnoreBoundsSizeMode", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("FramingBehavior", "FitFrustumSidesMode", value);
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "elevationReturnTime");
    }
