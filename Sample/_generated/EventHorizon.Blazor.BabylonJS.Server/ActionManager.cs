...
public class ActionManager : AbstractActionManager
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ActionManager", "NothingTrigger");
    }

    public static async ValueTask<decimal> get_OnPickTrigger()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnPickTrigger");
    }

    public static async ValueTask<decimal> get_OnLeftPickTrigger()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnLeftPickTrigger");
    }

    public static async ValueTask<decimal> get_OnRightPickTrigger()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnRightPickTrigger");
    }

    public static async ValueTask<decimal> get_OnCenterPickTrigger()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnCenterPickTrigger");
    }

    public static async ValueTask<decimal> get_OnPickDownTrigger()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnPickDownTrigger");
    }

    public static async ValueTask<decimal> get_OnDoublePickTrigger()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnDoublePickTrigger");
    }

    public static async ValueTask<decimal> get_OnPickUpTrigger()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnPickUpTrigger");
    }

    public static async ValueTask<decimal> get_OnPickOutTrigger()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnPickOutTrigger");
    }

    public static async ValueTask<decimal> get_OnLongPressTrigger()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnLongPressTrigger");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnPointerOutTrigger");
    }

    public static async ValueTask<decimal> get_OnEveryFrameTrigger()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnEveryFrameTrigger");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnKeyDownTrigger");
    }

    public static async ValueTask<decimal> get_OnKeyUpTrigger()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnKeyUpTrigger");
    }
    #endregion
    ...
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "ActionManager" }, scene);
