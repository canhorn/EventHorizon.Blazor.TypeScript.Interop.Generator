...
public class Texture : BaseTexture
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>("Texture", "SerializeBuffers");
    }

    public static ValueTask set_SerializeBuffers(bool value)
    {
        return EventHorizonBlazorInterop.Set("Texture", "SerializeBuffers", value);
    }

    public static async ValueTask<bool> get_ForceSerializeBuffers()
    {
        return await EventHorizonBlazorInterop.Get<bool>("Texture", "ForceSerializeBuffers");
    }

    public static ValueTask set_ForceSerializeBuffers(bool value)
    {
        return EventHorizonBlazorInterop.Set("Texture", "ForceSerializeBuffers", value);
    }

    public static async ValueTask<decimal> get_NEAREST_SAMPLINGMODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "NEAREST_SAMPLINGMODE");
    }

    public static async ValueTask<decimal> get_NEAREST_NEAREST_MIPLINEAR()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "NEAREST_NEAREST_MIPLINEAR");
    }

    public static async ValueTask<decimal> get_BILINEAR_SAMPLINGMODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "BILINEAR_SAMPLINGMODE");
    }

    public static async ValueTask<decimal> get_LINEAR_LINEAR_MIPNEAREST()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "LINEAR_LINEAR_MIPNEAREST");
    }

    public static async ValueTask<decimal> get_TRILINEAR_SAMPLINGMODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "TRILINEAR_SAMPLINGMODE");
    }

    public static async ValueTask<decimal> get_LINEAR_LINEAR_MIPLINEAR()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "LINEAR_LINEAR_MIPLINEAR");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "NEAREST_LINEAR_MIPNEAREST");
    }

    public static async ValueTask<decimal> get_NEAREST_LINEAR_MIPLINEAR()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "NEAREST_LINEAR_MIPLINEAR");
    }

    public static async ValueTask<decimal> get_NEAREST_LINEAR()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "NEAREST_LINEAR");
    }

    public static async ValueTask<decimal> get_NEAREST_NEAREST()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "NEAREST_NEAREST");
    }

    public static async ValueTask<decimal> get_LINEAR_NEAREST_MIPNEAREST()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "LINEAR_NEAREST_MIPNEAREST");
    }

    public static async ValueTask<decimal> get_LINEAR_NEAREST_MIPLINEAR()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "LINEAR_NEAREST_MIPLINEAR");
    }

    public static async ValueTask<decimal> get_LINEAR_LINEAR()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "LINEAR_LINEAR");
    }

    public static async ValueTask<decimal> get_LINEAR_NEAREST()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "LINEAR_NEAREST");
    }

    public static async ValueTask<decimal> get_EXPLICIT_MODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "EXPLICIT_MODE");
    }

    public static async ValueTask<decimal> get_SPHERICAL_MODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "SPHERICAL_MODE");
    }

    public static async ValueTask<decimal> get_PLANAR_MODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "PLANAR_MODE");
    }

    public static async ValueTask<decimal> get_CUBIC_MODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "CUBIC_MODE");
    }

    public static async ValueTask<decimal> get_PROJECTION_MODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "PROJECTION_MODE");
    }

    public static async ValueTask<decimal> get_SKYBOX_MODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "SKYBOX_MODE");
    }

    public static async ValueTask<decimal> get_INVCUBIC_MODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "INVCUBIC_MODE");
    }

    public static async ValueTask<decimal> get_EQUIRECTANGULAR_MODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "EQUIRECTANGULAR_MODE");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "CLAMP_ADDRESSMODE");
    }

    public static async ValueTask<decimal> get_WRAP_ADDRESSMODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "WRAP_ADDRESSMODE");
    }

    public static async ValueTask<decimal> get_MIRROR_ADDRESSMODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Texture", "MIRROR_ADDRESSMODE");
    }

    public static async ValueTask<bool> get_UseSerializedUrlIfAny()
    {
        return await EventHorizonBlazorInterop.Get<bool>("Texture", "UseSerializedUrlIfAny");
    }

    public static ValueTask set_UseSerializedUrlIfAny(bool value)
    {
        return EventHorizonBlazorInterop.Set("Texture", "UseSerializedUrlIfAny", value);
    }
    #endregion
    ...
    public static async ValueTask<Texture> NewTexture(Scene sceneOrEngine)
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Texture" }, sceneOrEngine);

        return new Texture(entity);
    }

    public static async ValueTask<Texture> NewTexture(InternalTexture internalTexture)
    {
        var entity = await EventHorizonBlazorInterop.New(
            new string[] { "Texture" },
            internalTexture
