...
public class Analyser : CachedEntityObject
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "SMOOTHING");
    }

    public ValueTask set_SMOOTHING(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "SMOOTHING", value);
    }

    public async ValueTask<decimal> get_FFT_SIZE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "FFT_SIZE");
    }

    public ValueTask set_FFT_SIZE(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "FFT_SIZE", value);
    }

    public async ValueTask<decimal> get_BARGRAPHAMPLITUDE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "BARGRAPHAMPLITUDE");
    }

    public ValueTask set_BARGRAPHAMPLITUDE(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "BARGRAPHAMPLITUDE", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "DEBUGCANVASPOS", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "DEBUGCANVASSIZE", value);
    }
    #endregion
    ...
    public static async ValueTask<Analyser> NewAnalyser(Scene scene)
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Analyser" }, scene);
