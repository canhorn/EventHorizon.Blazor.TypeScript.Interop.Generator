...
public class DataBuffer : CachedEntityObject
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "references");
    }

    public ValueTask set_references(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "references", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "capacity", value);
    }

    public async ValueTask<bool> get_is32Bits()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "is32Bits");
    }

    public ValueTask set_is32Bits(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "is32Bits", value);
    }
    #endregion
