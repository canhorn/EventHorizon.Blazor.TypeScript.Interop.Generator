...
public class BaseTexture : ThinTexture, IAnimatable
{
    ...
    public static async ValueTask WhenAllReady(BaseTexture[] textures, ActionCallback callback)
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "BaseTexture", "WhenAllReady" }, textures, callback }
        );
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "lodGenerationOffset");
    }
    ...
    private CachedEntityObject __animations;

    public async ValueTask<CachedEntityObject> get_animations()
    {
        if (__animations == null)
        {
            __animations = await EventHorizonBlazorInterop.GetClass<CachedEntityObject>(
                this.___guid,
                "animations",
                (entity) =>
                {
    ...
    public ValueTask set_animations(CachedEntityObject value)
    {
        __animations = null;
    ...
    public static async ValueTask<BaseTexture> NewBaseTexture(Scene sceneOrEngine)
    {
