...
namespace BABYLON
{
    ...
    public class SceneLoader : CachedEntityObject
    {
        ...
        {
            return EventHorizonBlazorInterop.Set("BABYLON", "SceneLoader.ShowLoadingScreen", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set("BABYLON", "SceneLoader.loggingLevel", value);
        }
        ...
        public static async ValueTask<IRegisteredPluginCachedEntity> GetDefaultPlugin()
        {
            return await EventHorizonBlazorInterop.FuncClass<IRegisteredPluginCachedEntity>(
                ...
                new object[] { new string[] { "BABYLON", "SceneLoader", "GetDefaultPlugin" } }
            );
        }
