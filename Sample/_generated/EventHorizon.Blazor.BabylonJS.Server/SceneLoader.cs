...
public class SceneLoader : CachedEntityObject
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>("SceneLoader", "ShowLoadingScreen");
    }

    public static ValueTask set_ShowLoadingScreen(bool value)
    {
        return EventHorizonBlazorInterop.Set("SceneLoader", "ShowLoadingScreen", value);
    }

    public static async ValueTask<decimal> get_loggingLevel()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("SceneLoader", "loggingLevel");
    }

    public static ValueTask set_loggingLevel(decimal value)
    {
        return EventHorizonBlazorInterop.Set("SceneLoader", "loggingLevel", value);
    }

    public static async ValueTask<bool> get_CleanBoneMatrixWeights()
    {
        return await EventHorizonBlazorInterop.Get<bool>("SceneLoader", "CleanBoneMatrixWeights");
    }

    public static ValueTask set_CleanBoneMatrixWeights(bool value)
    {
        return EventHorizonBlazorInterop.Set("SceneLoader", "CleanBoneMatrixWeights", value);
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("SceneLoader", "NO_LOGGING");
    }

    public static async ValueTask<decimal> get_MINIMAL_LOGGING()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("SceneLoader", "MINIMAL_LOGGING");
    }

    public static async ValueTask<decimal> get_SUMMARY_LOGGING()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("SceneLoader", "SUMMARY_LOGGING");
    }

    public static async ValueTask<decimal> get_DETAILED_LOGGING()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("SceneLoader", "DETAILED_LOGGING");
    }
    ...
    > get_OnPluginActivatedObservable()
    {
        if (__OnPluginActivatedObservable == null)
        {
            __OnPluginActivatedObservable = await EventHorizonBlazorInterop.GetClass<
                Observable<ISceneLoaderPluginCachedEntity>
            >(
                "SceneLoader",
    ...
    public static ValueTask set_OnPluginActivatedObservable(
        Observable<ISceneLoaderPluginCachedEntity> value
    )
    {
        __OnPluginActivatedObservable = null;
        return EventHorizonBlazorInterop.Set("SceneLoader", "OnPluginActivatedObservable", value);
    }
    #endregion
    ...
    public static async ValueTask<ISceneLoaderPluginCachedEntity> GetPluginForExtension(
        string extension
    )
    {
    ...
    public static async ValueTask<ISceneLoaderPluginCachedEntity> ImportMesh(
        object meshNames,
        string rootUrl,
    ...
    public static async ValueTask<ISceneLoaderAsyncResultCachedEntity> ImportMeshAsync(
        object meshNames,
        string rootUrl,
        string sceneFilename = null,
        Scene scene = null,
    ...
    public static async ValueTask<ISceneLoaderPluginCachedEntity> Load(
        string rootUrl,
        string sceneFilename = null,
        Engine engine = null,
    ...
    public static async ValueTask<Scene> LoadAsync(
        string rootUrl,
        string sceneFilename = null,
        Engine engine = null,
        ActionCallback<ISceneLoaderProgressEvent> onProgress = null,
    ...
    public static async ValueTask<ISceneLoaderPluginCachedEntity> Append(
        string rootUrl,
        string sceneFilename = null,
        Scene scene = null,
        ActionCallback<Scene> onSuccess = null,
    ...
    public static async ValueTask<Scene> AppendAsync(
        string rootUrl,
        string sceneFilename = null,
        Scene scene = null,
        ActionCallback<ISceneLoaderProgressEvent> onProgress = null,
    ...
    public static async ValueTask<ISceneLoaderPluginCachedEntity> LoadAssetContainer(
        string rootUrl,
        string sceneFilename = null,
        Scene scene = null,
    ...
    public static async ValueTask<AssetContainer> LoadAssetContainerAsync(
        string rootUrl,
        string sceneFilename = null,
        Scene scene = null,
        ActionCallback<ISceneLoaderProgressEvent> onProgress = null,
    ...
    public static async ValueTask ImportAnimations(
        string rootUrl,
        string sceneFilename = null,
        Scene scene = null,
