...
public class ArcRotateCamera : TargetCamera
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "angularSensibilityX");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "angularSensibilityY");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "pinchDeltaPercentage");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "wheelDeltaPercentage");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useAutoRotationBehavior");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "inertialAlphaOffset");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "inertialRadiusOffset");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "pinchToPanMaxDistance");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "panningDistanceLimit");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useInputToRestoreState");
    }
    ...
    public ValueTask set_onMeshTargetChangedObservable(Observable<AbstractMesh> value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "onMeshTargetChangedObservable", value);
    }
    ...
    public async ValueTask detachControl(object ignored)
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
