...
public class AnimationGroup : CachedEntityObject, _IDisposable
{
    ...
    public static async ValueTask<AnimationGroup> Parse(object parsedAnimationGroup, Scene scene)
    {
        return await EventHorizonBlazorInterop.FuncClass<AnimationGroup>(
            ...
            new object[] { new string[] { "AnimationGroup", "Parse" }, parsedAnimationGroup, scene }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<AnimationGroup>(
            ...
            new object[]
            {
                new string[] { "AnimationGroup", "MakeAnimationAdditive" },
    ...
    public ValueTask set_onAnimationGroupLoopObservable(Observable<AnimationGroup> value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "onAnimationGroupLoopObservable", value);
    }
    ...
    public ValueTask set_onAnimationGroupEndObservable(Observable<AnimationGroup> value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "onAnimationGroupEndObservable", value);
    }
    ...
    public ValueTask set_onAnimationGroupPlayObservable(Observable<AnimationGroup> value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "onAnimationGroupPlayObservable", value);
    }
    #endregion
    ...
    public static async ValueTask<AnimationGroup> NewAnimationGroup(string name, Scene scene = null)
    {
        var entity = await EventHorizonBlazorInterop.New(
            new string[] { "AnimationGroup" },
            name,
            scene
        );
