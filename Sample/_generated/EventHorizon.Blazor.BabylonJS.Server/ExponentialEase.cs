...
public class ExponentialEase : EasingFunction, IEasingFunction
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "exponent");
    }

    public ValueTask set_exponent(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "exponent", value);
    }
    #endregion
