...
public class BackEase : EasingFunction, IEasingFunction
{
    ...
    public static async ValueTask<BackEase> NewBackEase(System.Nullable<decimal> amplitude = null)
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "BackEase" }, amplitude);
