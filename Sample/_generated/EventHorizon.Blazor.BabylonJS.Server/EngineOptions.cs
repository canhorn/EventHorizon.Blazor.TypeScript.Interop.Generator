...
public class EngineOptionsCachedEntity : CachedEntityObject, EngineOptions
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "autoEnableWebVR");
    }

    public ValueTask set_autoEnableWebVR(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "autoEnableWebVR", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "doNotHandleTouchAction");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useHighPrecisionFloats");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useHighPrecisionMatrix");
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "failIfMajorPerformanceCaveat", value);
    }
    #endregion
