...
public class StandardMaterial : PushMaterial
{
    ...
    {
        return EventHorizonBlazorInterop.Set("StandardMaterial", "DiffuseTextureEnabled", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("StandardMaterial", "DetailTextureEnabled", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("StandardMaterial", "AmbientTextureEnabled", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("StandardMaterial", "OpacityTextureEnabled", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("StandardMaterial", "ReflectionTextureEnabled", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("StandardMaterial", "EmissiveTextureEnabled", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("StandardMaterial", "SpecularTextureEnabled", value);
    }

    public static async ValueTask<bool> get_BumpTextureEnabled()
    {
        return await EventHorizonBlazorInterop.Get<bool>("StandardMaterial", "BumpTextureEnabled");
    }

    public static ValueTask set_BumpTextureEnabled(bool value)
    {
        return EventHorizonBlazorInterop.Set("StandardMaterial", "BumpTextureEnabled", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("StandardMaterial", "LightmapTextureEnabled", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("StandardMaterial", "RefractionTextureEnabled", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>("StandardMaterial", "FresnelEnabled");
    }

    public static ValueTask set_FresnelEnabled(bool value)
    {
        return EventHorizonBlazorInterop.Set("StandardMaterial", "FresnelEnabled", value);
    }
    #endregion
    ...
    public static async ValueTask<StandardMaterial> Parse(
        object source,
        Scene scene,
        string rootUrl
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<StandardMaterial>(
            ...
            new object[] { new string[] { "StandardMaterial", "Parse" }, source, scene, rootUrl }
        );
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "cameraColorCurvesEnabled");
    }

    public ValueTask set_cameraColorCurvesEnabled(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "cameraColorCurvesEnabled", value);
    }

    public async ValueTask<bool> get_cameraColorGradingEnabled()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "cameraColorGradingEnabled");
    }

    public ValueTask set_cameraColorGradingEnabled(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "cameraColorGradingEnabled", value);
    }

    public async ValueTask<bool> get_cameraToneMappingEnabled()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "cameraToneMappingEnabled");
    }

    public ValueTask set_cameraToneMappingEnabled(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "cameraToneMappingEnabled", value);
    }

    public async ValueTask<decimal> get_cameraExposure()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "cameraExposure");
    }

    public ValueTask set_cameraExposure(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "cameraExposure", value);
    }

    public async ValueTask<decimal> get_cameraContrast()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "cameraContrast");
    }

    public ValueTask set_cameraContrast(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "cameraContrast", value);
    }
    ...
    public ValueTask set_cameraColorGradingTexture(BaseTexture value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "cameraColorGradingTexture", value);
    }
    ...
    public ValueTask set_cameraColorCurves(ColorCurves value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "cameraColorCurves", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "hasRenderTargetTextures");
    }
    ...
    public ValueTask set_diffuseTexture(BaseTexture value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "diffuseTexture", value);
    }
    ...
    public ValueTask set_ambientTexture(BaseTexture value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "ambientTexture", value);
    }
    ...
    public ValueTask set_opacityTexture(BaseTexture value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "opacityTexture", value);
    }
    ...
    public ValueTask set_reflectionTexture(BaseTexture value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "reflectionTexture", value);
    }
    ...
    public ValueTask set_emissiveTexture(BaseTexture value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "emissiveTexture", value);
    }
    ...
    public ValueTask set_specularTexture(BaseTexture value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "specularTexture", value);
    }
    ...
    public ValueTask set_lightmapTexture(BaseTexture value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "lightmapTexture", value);
    }
    ...
    {
        __diffuseColor = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "diffuseColor", value);
    }
    ...
    public ValueTask set_specularColor(Color3 value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "specularColor", value);
    }
    ...
    public ValueTask set_emissiveColor(Color3 value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "emissiveColor", value);
    }

    public async ValueTask<decimal> get_specularPower()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "specularPower");
    }

    public ValueTask set_specularPower(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "specularPower", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "useAlphaFromDiffuseTexture", value);
    }

    public async ValueTask<bool> get_useEmissiveAsIllumination()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useEmissiveAsIllumination");
    }

    public ValueTask set_useEmissiveAsIllumination(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "useEmissiveAsIllumination", value);
    }

    public async ValueTask<bool> get_linkEmissiveWithDiffuse()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "linkEmissiveWithDiffuse");
    }

    public ValueTask set_linkEmissiveWithDiffuse(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "linkEmissiveWithDiffuse", value);
    }

    public async ValueTask<bool> get_useSpecularOverAlpha()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useSpecularOverAlpha");
    }

    public ValueTask set_useSpecularOverAlpha(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "useSpecularOverAlpha", value);
    }

    public async ValueTask<bool> get_useReflectionOverAlpha()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useReflectionOverAlpha");
    }

    public ValueTask set_useReflectionOverAlpha(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "useReflectionOverAlpha", value);
    }

    public async ValueTask<bool> get_disableLighting()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "disableLighting");
    }

    public ValueTask set_disableLighting(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "disableLighting", value);
    }

    public async ValueTask<bool> get_useObjectSpaceNormalMap()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useObjectSpaceNormalMap");
    }

    public ValueTask set_useObjectSpaceNormalMap(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "useObjectSpaceNormalMap", value);
    }

    public async ValueTask<bool> get_useParallax()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useParallax");
    }

    public ValueTask set_useParallax(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "useParallax", value);
    }

    public async ValueTask<bool> get_useParallaxOcclusion()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useParallaxOcclusion");
    }

    public ValueTask set_useParallaxOcclusion(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "useParallaxOcclusion", value);
    }

    public async ValueTask<decimal> get_parallaxScaleBias()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "parallaxScaleBias");
    }

    public ValueTask set_parallaxScaleBias(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "parallaxScaleBias", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "alphaCutOff");
    }

    public ValueTask set_alphaCutOff(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "alphaCutOff", value);
    }

    public async ValueTask<bool> get_useLightmapAsShadowmap()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useLightmapAsShadowmap");
    }

    public ValueTask set_useLightmapAsShadowmap(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "useLightmapAsShadowmap", value);
    }
    ...
    public async ValueTask<FresnelParameters> get_diffuseFresnelParameters()
    {
        if (__diffuseFresnelParameters == null)
        {
            __diffuseFresnelParameters =
                await EventHorizonBlazorInterop.GetClass<FresnelParameters>(
                    this.___guid,
    ...
    public ValueTask set_diffuseFresnelParameters(FresnelParameters value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "diffuseFresnelParameters", value);
    }
    ...
    public ValueTask set_opacityFresnelParameters(FresnelParameters value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "opacityFresnelParameters", value);
    }
    ...
    public ValueTask set_reflectionFresnelParameters(FresnelParameters value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "reflectionFresnelParameters", value);
    }
    ...
    public ValueTask set_refractionFresnelParameters(FresnelParameters value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "refractionFresnelParameters", value);
    }
    ...
    public ValueTask set_emissiveFresnelParameters(FresnelParameters value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "emissiveFresnelParameters", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "maxSimultaneousLights");
    }

    public ValueTask set_maxSimultaneousLights(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "maxSimultaneousLights", value);
    }

    public async ValueTask<bool> get_invertNormalMapX()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "invertNormalMapX");
    }

    public ValueTask set_invertNormalMapX(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "invertNormalMapX", value);
    }

    public async ValueTask<bool> get_invertNormalMapY()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "invertNormalMapY");
    }

    public ValueTask set_invertNormalMapY(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "invertNormalMapY", value);
    }

    public async ValueTask<bool> get_twoSidedLighting()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "twoSidedLighting");
    }

    public ValueTask set_twoSidedLighting(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "twoSidedLighting", value);
    }
    ...
    public static async ValueTask<StandardMaterial> NewStandardMaterial(string name, Scene scene)
    {
        var entity = await EventHorizonBlazorInterop.New(
            new string[] { "StandardMaterial" },
            name,
            scene
        );
