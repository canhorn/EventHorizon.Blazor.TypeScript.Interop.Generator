    ...
    where T : CachedEntity, new()
{
    ...
    public static async ValueTask<SmartArray<T>> NewSmartArray(decimal capacity)
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "SmartArray" }, capacity);
