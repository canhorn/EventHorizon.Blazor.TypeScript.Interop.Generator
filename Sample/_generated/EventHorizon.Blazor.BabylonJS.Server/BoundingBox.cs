...
public class BoundingBox : CachedEntityObject, ICullable
{
    ...
    public static async ValueTask<bool> Intersects(BoundingBox box0, BoundingBox box1)
    {
        return await EventHorizonBlazorInterop.Func<bool>(
            new object[] { new string[] { "BoundingBox", "Intersects" }, box0, box1 }
        );
    }

    public static async ValueTask<bool> IntersectsSphere(
        Vector3 minPoint,
        Vector3 maxPoint,
    ...
    )
    {
        return await EventHorizonBlazorInterop.Func<bool>(
            new object[]
            {
                new string[] { "BoundingBox", "IntersectsSphere" },
                minPoint,
                maxPoint,
                sphereCenter,
                sphereRadius
    ...
    public static async ValueTask<bool> IsCompletelyInFrustum(
    ...
    )
    {
        return await EventHorizonBlazorInterop.Func<bool>(
            new object[]
            {
                new string[] { "BoundingBox", "IsCompletelyInFrustum" },
                boundingVectors,
                frustumPlanes
            }
        );
    ...
    public static async ValueTask<bool> IsInFrustum(
        Vector3[] boundingVectors,
        Plane[] frustumPlanes
    )
    {
        return await EventHorizonBlazorInterop.Func<bool>(
            new object[]
            {
                new string[] { "BoundingBox", "IsInFrustum" },
                boundingVectors,
                frustumPlanes
            }
        );
