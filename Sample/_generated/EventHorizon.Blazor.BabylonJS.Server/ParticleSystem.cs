...
public class ParticleSystem : BaseParticleSystem, _IDisposable, IAnimatable, IParticleSystem
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ParticleSystem", "BILLBOARDMODE_Y");
    }

    public static async ValueTask<decimal> get_BILLBOARDMODE_ALL()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("ParticleSystem", "BILLBOARDMODE_ALL");
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<ParticleSystem>(
            ...
            new object[]
            {
                new string[] { "ParticleSystem", "Parse" },
    ...
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "ParticleSystem" }, name);
