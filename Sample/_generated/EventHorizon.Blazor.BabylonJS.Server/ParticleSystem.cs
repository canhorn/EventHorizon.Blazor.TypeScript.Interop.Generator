...
namespace BABYLON
{
    ...
    public class ParticleSystem : BaseParticleSystem, _IDisposable, IAnimatable, IParticleSystem
    {
        ...
        public async ValueTask<string> updateFunction(Func<Task> callback)
        {
        ...
        public async ValueTask<string> startDirectionFunction(Func<Task> callback)
        {
        ...
        public async ValueTask<string> startPositionFunction(Func<Task> callback)
        {
        ...
        public async ValueTask<string> recycleParticle(Func<Task> callback)
        {
