...
public class AutoRotationBehavior : CachedEntityObject, Behavior<ArcRotateCamera>
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "idleRotationWaitTime");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "idleRotationSpinupTime");
    }
