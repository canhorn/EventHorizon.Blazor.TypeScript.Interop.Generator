...
public class Animation : CachedEntityObject
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>("Animation", "AllowMatricesInterpolation");
    }

    public static ValueTask set_AllowMatricesInterpolation(bool value)
    {
        return EventHorizonBlazorInterop.Set("Animation", "AllowMatricesInterpolation", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<string>("Animation", "SnippetUrl");
    }

    public static ValueTask set_SnippetUrl(string value)
    {
        return EventHorizonBlazorInterop.Set("Animation", "SnippetUrl", value);
    }

    public static async ValueTask<decimal> get_ANIMATIONTYPE_FLOAT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONTYPE_FLOAT");
    }

    public static async ValueTask<decimal> get_ANIMATIONTYPE_VECTOR3()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONTYPE_VECTOR3");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONTYPE_MATRIX");
    }

    public static async ValueTask<decimal> get_ANIMATIONTYPE_COLOR3()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONTYPE_COLOR3");
    }

    public static async ValueTask<decimal> get_ANIMATIONTYPE_COLOR4()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONTYPE_COLOR4");
    }

    public static async ValueTask<decimal> get_ANIMATIONTYPE_VECTOR2()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONTYPE_VECTOR2");
    }

    public static async ValueTask<decimal> get_ANIMATIONTYPE_SIZE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONTYPE_SIZE");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONLOOPMODE_CYCLE");
    }
    ...
    public static async ValueTask<Animation> CreateAnimation(
        string property,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Animation>(
            ...
            new object[]
            {
                new string[] { "Animation", "CreateAnimation" },
                property,
                animationType,
                framePerSecond,
                easingFunction
    ...
    public static async ValueTask<Animatable> CreateAndStartAnimation(
        string name,
        Node node,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Animatable>(
            ...
            new object[]
            {
                new string[] { "Animation", "CreateAndStartAnimation" },
                name,
                node,
                targetProperty,
                framePerSecond,
    ...
    public static async ValueTask<Animatable[]> CreateAndStartHierarchyAnimation(
        string name,
        Node node,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncArrayClass<Animatable>(
            ...
            new object[]
            {
                new string[] { "Animation", "CreateAndStartHierarchyAnimation" },
                name,
                node,
    ...
    public static async ValueTask<Animatable> CreateMergeAndStartAnimation(
        string name,
        Node node,
        string targetProperty,
        decimal framePerSecond,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Animatable>(
            ...
            new object[]
            {
                new string[] { "Animation", "CreateMergeAndStartAnimation" },
                name,
                node,
                targetProperty,
                framePerSecond,
    ...
    public static async ValueTask<Animation> MakeAnimationAdditive(
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Animation>(
            ...
            new object[]
            {
                new string[] { "Animation", "MakeAnimationAdditive" },
                sourceAnimation,
                referenceFrame,
                range,
                cloneOriginal,
    ...
    public static async ValueTask<Animatable> TransitionTo(
        string property,
        object targetValue,
        object host,
        Scene scene,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Animatable>(
            ...
            new object[]
            {
                new string[] { "Animation", "TransitionTo" },
                property,
                targetValue,
                host,
                scene,
    ...
    public static async ValueTask<Animation> Parse(object parsedAnimation)
    {
        return await EventHorizonBlazorInterop.FuncClass<Animation>(
            entity => new Animation() { ___guid = entity.___guid },
            new object[] { new string[] { "Animation", "Parse" }, parsedAnimation }
        );
    }
    ...
    public static async ValueTask AppendSerializedAnimations(IAnimatable source, object destination)
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Animation", "AppendSerializedAnimations" },
                source,
                destination
            }
        );
    ...
    public static async ValueTask<Animation> ParseFromFileAsync(string url, string name = null)
    {
        return await EventHorizonBlazorInterop.TaskClass<Animation>(
            entity => new Animation() { ___guid = entity.___guid },
            new object[] { new string[] { "Animation", "ParseFromFileAsync" }, name, url }
        );
    }
    ...
    public static async ValueTask<Animation> CreateFromSnippetAsync(string snippetId)
    {
        return await EventHorizonBlazorInterop.TaskClass<Animation>(
            entity => new Animation() { ___guid = entity.___guid },
            new object[] { new string[] { "Animation", "CreateFromSnippetAsync" }, snippetId }
        );
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<string>(this.___guid, "targetProperty");
    }

    public ValueTask set_targetProperty(string value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "targetProperty", value);
    }

    public async ValueTask<decimal> get_framePerSecond()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "framePerSecond");
    }

    public ValueTask set_framePerSecond(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "framePerSecond", value);
    }

    public async ValueTask<decimal> get_dataType()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "dataType");
    }

    public ValueTask set_dataType(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "dataType", value);
    }

    public async ValueTask<decimal> get_loopMode()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "loopMode");
    }

    public ValueTask set_loopMode(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "loopMode", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.GetArray<string>(this.___guid, "targetPropertyPath");
    }

    public ValueTask set_targetPropertyPath(string[] value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "targetPropertyPath", value);
    }
    ...
    public async ValueTask<decimal> floatInterpolateFunction(
        decimal startValue,
        decimal endValue,
        decimal gradient
    )
    ...
    public async ValueTask<decimal> floatInterpolateFunctionWithTangents(
        decimal startValue,
        decimal outTangent,
        decimal endValue,
        decimal inTangent,
    ...
    public async ValueTask<Quaternion> quaternionInterpolateFunction(
    ...
    public async ValueTask<Quaternion> quaternionInterpolateFunctionWithTangents(
        Quaternion startValue,
    ...
    public async ValueTask<Vector3> vector3InterpolateFunction(
        Vector3 startValue,
        Vector3 endValue,
        decimal gradient
    )
    ...
    public async ValueTask<Vector3> vector3InterpolateFunctionWithTangents(
        Vector3 startValue,
        Vector3 outTangent,
        Vector3 endValue,
        Vector3 inTangent,
    ...
    public async ValueTask<Vector2> vector2InterpolateFunction(
        Vector2 startValue,
        Vector2 endValue,
        decimal gradient
    )
    ...
    public async ValueTask<Vector2> vector2InterpolateFunctionWithTangents(
        Vector2 startValue,
        Vector2 outTangent,
        Vector2 endValue,
        Vector2 inTangent,
    ...
    public async ValueTask<Size> sizeInterpolateFunction(
        Size startValue,
        Size endValue,
        decimal gradient
    )
    ...
    public async ValueTask<Color3> color3InterpolateFunction(
        Color3 startValue,
        Color3 endValue,
        decimal gradient
    )
    ...
    public async ValueTask<Color4> color4InterpolateFunction(
        Color4 startValue,
        Color4 endValue,
        decimal gradient
    )
    ...
    public async ValueTask<Matrix> matrixInterpolateFunction(
        Matrix startValue,
        Matrix endValue,
        decimal gradient,
        Matrix result = null
