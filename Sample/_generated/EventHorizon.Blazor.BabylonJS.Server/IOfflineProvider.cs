...
public class IOfflineProviderCachedEntity : CachedEntityObject, IOfflineProvider
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "enableSceneOffline");
    }

    public ValueTask set_enableSceneOffline(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "enableSceneOffline", value);
    }

    public async ValueTask<bool> get_enableTexturesOffline()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "enableTexturesOffline");
    }

    public ValueTask set_enableTexturesOffline(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "enableTexturesOffline", value);
    }
    #endregion
    ...
    public async ValueTask open(ActionCallback successCallback, ActionCallback errorCallback)
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { this.___guid, "open" }, successCallback, errorCallback }
        );
    }
    ...
    public async ValueTask loadFile(
        string url,
