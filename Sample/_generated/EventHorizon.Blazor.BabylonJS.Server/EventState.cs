...
public class EventState : CachedEntityObject
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "skipNextObservers");
    }

    public ValueTask set_skipNextObservers(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "skipNextObservers", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "currentTarget", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "lastReturnValue", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "userInfo", value);
    }
    #endregion
    ...
    #region Methods
    public async ValueTask<EventState> initalize(
        decimal mask,
        System.Nullable<bool> skipNextObservers = null,
        object target = null,
        object currentTarget = null
