...
public class Vector4 : CachedEntityObject
{
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector4>(
            ...
            new object[] { new string[] { "Vector4", "FromArray" }, array, offset }
        );
    }
    ...
    public static async ValueTask FromArrayToRef(decimal[] array, decimal offset, Vector4 result)
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Vector4", "FromArrayToRef" }, array, offset, result }
        );
    }
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Vector4", "FromFloatArrayToRef" },
                array,
                offset,
                result
            }
    ...
    public static async ValueTask FromFloatsToRef(
        decimal x,
        decimal y,
        decimal z,
        decimal w,
    ...
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Vector4", "FromFloatsToRef" }, x, y, z, w, result }
        );
    }
    ...
    public static async ValueTask<Vector4> Zero()
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector4>(
            entity => new Vector4() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector4", "Zero" } }
        );
    }
    ...
    public static async ValueTask<Vector4> One()
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector4>(
            entity => new Vector4() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector4", "One" } }
        );
    }
    ...
    public static async ValueTask<Vector4> Normalize(Vector4 vector)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector4>(
            entity => new Vector4() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector4", "Normalize" }, vector }
        );
    }
    ...
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Vector4", "NormalizeToRef" }, vector, result }
        );
    }
    ...
    public static async ValueTask<Vector4> Minimize(Vector4 left, Vector4 right)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector4>(
            entity => new Vector4() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector4", "Minimize" }, left, right }
        );
    }
    ...
    public static async ValueTask<Vector4> Maximize(Vector4 left, Vector4 right)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector4>(
            entity => new Vector4() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector4", "Maximize" }, left, right }
        );
    }
    ...
    public static async ValueTask<decimal> Distance(Vector4 value1, Vector4 value2)
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "Vector4", "Distance" }, value1, value2 }
        );
    }
    ...
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { "Vector4", "DistanceSquared" }, value1, value2 }
        );
    }
    ...
    public static async ValueTask<Vector4> Center(Vector4 value1, Vector4 value2)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector4>(
            entity => new Vector4() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector4", "Center" }, value1, value2 }
        );
    }
    ...
    public static async ValueTask<Vector4> TransformNormal(Vector4 vector, Matrix transformation)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector4>(
            entity => new Vector4() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector4", "TransformNormal" }, vector, transformation }
        );
    }
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Vector4", "TransformNormalToRef" },
                vector,
                transformation,
                result
            }
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "Vector4", "TransformNormalFromFloatsToRef" },
                x,
                y,
                z,
                w,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector4>(
            entity => new Vector4() { ___guid = entity.___guid },
            new object[] { new string[] { "Vector4", "FromVector3" }, source, w }
        );
    }
    #endregion
    ...
    public static async ValueTask<Vector4> NewVector4(decimal x, decimal y, decimal z, decimal w)
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Vector4" }, x, y, z, w);
    ...
    public async ValueTask<Vector4> subtractFromFloatsToRef(
        decimal x,
        decimal y,
        decimal z,
        decimal w,
