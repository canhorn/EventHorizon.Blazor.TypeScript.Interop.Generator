...
namespace BABYLON
{
    ...
    public class UniformBuffer : CachedEntityObject
    {
        ...
        public async ValueTask<string> updateMatrix3x3(Func<Task> callback)
        {
        ...
        public async ValueTask<string> updateMatrix2x2(Func<Task> callback)
        {
        ...
        public async ValueTask<string> updateFloat(Func<Task> callback)
        {
        ...
        public async ValueTask<string> updateFloat2(Func<Task> callback)
        {
        ...
        public async ValueTask<string> updateFloat3(Func<Task> callback)
        {
        ...
        public async ValueTask<string> updateFloat4(Func<Task> callback)
        {
        ...
        public async ValueTask<string> updateMatrix(Func<Task> callback)
        {
        ...
        public async ValueTask<string> updateVector3(Func<Task> callback)
        {
        ...
        public async ValueTask<string> updateVector4(Func<Task> callback)
        {
        ...
        public async ValueTask<string> updateColor3(Func<Task> callback)
        {
        ...
        public async ValueTask<string> updateColor4(Func<Task> callback)
        {
