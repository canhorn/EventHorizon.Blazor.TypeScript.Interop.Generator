...
public class Engine : ThinEngine
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<string>("Engine", "NpmPackage");
    }

    public static async ValueTask<string> get_Version()
    {
        return await EventHorizonBlazorInterop.Get<string>("Engine", "Version");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "ALPHA_DISABLE");
    }

    public static async ValueTask<decimal> get_ALPHA_ADD()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "ALPHA_ADD");
    }

    public static async ValueTask<decimal> get_ALPHA_COMBINE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "ALPHA_COMBINE");
    }

    public static async ValueTask<decimal> get_ALPHA_SUBTRACT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "ALPHA_SUBTRACT");
    }

    public static async ValueTask<decimal> get_ALPHA_MULTIPLY()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "ALPHA_MULTIPLY");
    }

    public static async ValueTask<decimal> get_ALPHA_MAXIMIZED()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "ALPHA_MAXIMIZED");
    }

    public static async ValueTask<decimal> get_ALPHA_ONEONE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "ALPHA_ONEONE");
    }

    public static async ValueTask<decimal> get_ALPHA_PREMULTIPLIED()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "ALPHA_PREMULTIPLIED");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "ALPHA_INTERPOLATE");
    }

    public static async ValueTask<decimal> get_ALPHA_SCREENMODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "ALPHA_SCREENMODE");
    }

    public static async ValueTask<decimal> get_DELAYLOADSTATE_NONE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "DELAYLOADSTATE_NONE");
    }

    public static async ValueTask<decimal> get_DELAYLOADSTATE_LOADED()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "DELAYLOADSTATE_LOADED");
    }

    public static async ValueTask<decimal> get_DELAYLOADSTATE_LOADING()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "DELAYLOADSTATE_LOADING");
    }

    public static async ValueTask<decimal> get_DELAYLOADSTATE_NOTLOADED()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "DELAYLOADSTATE_NOTLOADED");
    }

    public static async ValueTask<decimal> get_NEVER()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "NEVER");
    }

    public static async ValueTask<decimal> get_ALWAYS()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "ALWAYS");
    }

    public static async ValueTask<decimal> get_LESS()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "LESS");
    }

    public static async ValueTask<decimal> get_EQUAL()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "EQUAL");
    }

    public static async ValueTask<decimal> get_LEQUAL()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "LEQUAL");
    }

    public static async ValueTask<decimal> get_GREATER()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "GREATER");
    }

    public static async ValueTask<decimal> get_GEQUAL()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "GEQUAL");
    }

    public static async ValueTask<decimal> get_NOTEQUAL()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "NOTEQUAL");
    }

    public static async ValueTask<decimal> get_KEEP()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "KEEP");
    }

    public static async ValueTask<decimal> get_REPLACE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "REPLACE");
    }

    public static async ValueTask<decimal> get_INCR()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "INCR");
    }

    public static async ValueTask<decimal> get_DECR()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "DECR");
    }

    public static async ValueTask<decimal> get_INVERT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "INVERT");
    }

    public static async ValueTask<decimal> get_INCR_WRAP()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "INCR_WRAP");
    }

    public static async ValueTask<decimal> get_DECR_WRAP()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "DECR_WRAP");
    }

    public static async ValueTask<decimal> get_TEXTURE_CLAMP_ADDRESSMODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURE_CLAMP_ADDRESSMODE");
    }

    public static async ValueTask<decimal> get_TEXTURE_WRAP_ADDRESSMODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURE_WRAP_ADDRESSMODE");
    }

    public static async ValueTask<decimal> get_TEXTURE_MIRROR_ADDRESSMODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURE_MIRROR_ADDRESSMODE");
    }

    public static async ValueTask<decimal> get_TEXTUREFORMAT_ALPHA()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTUREFORMAT_ALPHA");
    }

    public static async ValueTask<decimal> get_TEXTUREFORMAT_LUMINANCE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTUREFORMAT_LUMINANCE");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTUREFORMAT_RGB");
    }

    public static async ValueTask<decimal> get_TEXTUREFORMAT_RGBA()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTUREFORMAT_RGBA");
    }

    public static async ValueTask<decimal> get_TEXTUREFORMAT_RED()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTUREFORMAT_RED");
    }

    public static async ValueTask<decimal> get_TEXTUREFORMAT_R()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTUREFORMAT_R");
    }

    public static async ValueTask<decimal> get_TEXTUREFORMAT_RG()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTUREFORMAT_RG");
    }

    public static async ValueTask<decimal> get_TEXTUREFORMAT_RED_INTEGER()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTUREFORMAT_RED_INTEGER");
    }

    public static async ValueTask<decimal> get_TEXTUREFORMAT_R_INTEGER()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTUREFORMAT_R_INTEGER");
    }

    public static async ValueTask<decimal> get_TEXTUREFORMAT_RG_INTEGER()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTUREFORMAT_RG_INTEGER");
    }

    public static async ValueTask<decimal> get_TEXTUREFORMAT_RGB_INTEGER()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTUREFORMAT_RGB_INTEGER");
    }

    public static async ValueTask<decimal> get_TEXTUREFORMAT_RGBA_INTEGER()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTUREFORMAT_RGBA_INTEGER");
    }

    public static async ValueTask<decimal> get_TEXTURETYPE_UNSIGNED_BYTE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURETYPE_UNSIGNED_BYTE");
    }

    public static async ValueTask<decimal> get_TEXTURETYPE_UNSIGNED_INT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURETYPE_UNSIGNED_INT");
    }

    public static async ValueTask<decimal> get_TEXTURETYPE_FLOAT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURETYPE_FLOAT");
    }

    public static async ValueTask<decimal> get_TEXTURETYPE_HALF_FLOAT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURETYPE_HALF_FLOAT");
    }

    public static async ValueTask<decimal> get_TEXTURETYPE_BYTE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURETYPE_BYTE");
    }

    public static async ValueTask<decimal> get_TEXTURETYPE_SHORT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURETYPE_SHORT");
    }

    public static async ValueTask<decimal> get_TEXTURETYPE_UNSIGNED_SHORT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURETYPE_UNSIGNED_SHORT");
    }

    public static async ValueTask<decimal> get_TEXTURETYPE_INT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURETYPE_INT");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURE_NEAREST_LINEAR");
    }

    public static async ValueTask<decimal> get_TEXTURE_NEAREST_NEAREST()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURE_NEAREST_NEAREST");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURE_LINEAR_LINEAR");
    }

    public static async ValueTask<decimal> get_TEXTURE_LINEAR_NEAREST()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURE_LINEAR_NEAREST");
    }

    public static async ValueTask<decimal> get_TEXTURE_EXPLICIT_MODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURE_EXPLICIT_MODE");
    }

    public static async ValueTask<decimal> get_TEXTURE_SPHERICAL_MODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURE_SPHERICAL_MODE");
    }

    public static async ValueTask<decimal> get_TEXTURE_PLANAR_MODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURE_PLANAR_MODE");
    }

    public static async ValueTask<decimal> get_TEXTURE_CUBIC_MODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURE_CUBIC_MODE");
    }

    public static async ValueTask<decimal> get_TEXTURE_PROJECTION_MODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURE_PROJECTION_MODE");
    }

    public static async ValueTask<decimal> get_TEXTURE_SKYBOX_MODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURE_SKYBOX_MODE");
    }

    public static async ValueTask<decimal> get_TEXTURE_INVCUBIC_MODE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "TEXTURE_INVCUBIC_MODE");
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "SCALEMODE_FLOOR");
    }

    public static async ValueTask<decimal> get_SCALEMODE_NEAREST()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "SCALEMODE_NEAREST");
    }

    public static async ValueTask<decimal> get_SCALEMODE_CEILING()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Engine", "SCALEMODE_CEILING");
    }
    ...
    {
        __audioEngine = null;
        return EventHorizonBlazorInterop.Set("Engine", "audioEngine", value);
    }
    #endregion
    ...
    )
    {
        await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Engine", "MarkAllMaterialsAsDirty" }, flag, predicate }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<ILoadingScreenCachedEntity>(
            ...
            new object[] { new string[] { "Engine", "DefaultLoadingScreenFactory" }, canvas }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<IAudioEngineCachedEntity>(
            ...
            new object[] { new string[] { "Engine", "AudioEngineFactory" }, hostElement }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<IOfflineProviderCachedEntity>(
            ...
            new object[]
            {
                new string[] { "Engine", "OfflineProviderFactory" },
                urlToScene,
    ...
    public ValueTask set_loadingScreen(ILoadingScreenCachedEntity value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "loadingScreen", value);
    }
    #endregion
    ...
    private CachedEntityObject __postProcesses;

    public async ValueTask<CachedEntityObject> get_postProcesses()
    {
        if (__postProcesses == null)
        {
            __postProcesses = await EventHorizonBlazorInterop.GetClass<CachedEntityObject>(
                this.___guid,
                "postProcesses",
                (entity) =>
                {
        ...
        return __postProcesses;
    }

    public ValueTask set_postProcesses(CachedEntityObject value)
    {
        __postProcesses = null;
    ...
    public ValueTask set_onCanvasPointerOutObservable(Observable<PointerEvent> value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "onCanvasPointerOutObservable", value);
    }
    ...
    )
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "customAnimationFrameRequester", value);
    }
    ...
    public async ValueTask<decimal> getAspectRatio(
    ...
    public async ValueTask generateMipMapsForCubemap(
    ...
    public async ValueTask setDepthStencilTexture(
        decimal channel,
    ...
    public async ValueTask<decimal> updateRenderTargetTextureSampleCount(
        InternalTexture texture,
        decimal samples
    )
    {
