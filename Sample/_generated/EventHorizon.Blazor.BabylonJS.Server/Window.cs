...
public class WindowCachedEntity : CachedEntityObject, Window
{
    ...
    {
        __mozIndexedDB = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "mozIndexedDB", value);
    }
    ...
    public ValueTask set_webkitIndexedDB(IDBFactory value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "webkitIndexedDB", value);
    }
    ...
    {
        __msIndexedDB = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "msIndexedDB", value);
    }
    ...
    {
        __webkitURL = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "webkitURL", value);
    }
    ...
    public async ValueTask<WebGLRenderingContextCachedEntity> get_WebGLRenderingContext()
    {
        if (__WebGLRenderingContext == null)
        {
            __WebGLRenderingContext =
                await EventHorizonBlazorInterop.GetClass<WebGLRenderingContextCachedEntity>(
                    this.___guid,
    ...
    public ValueTask set_WebGLRenderingContext(WebGLRenderingContextCachedEntity value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "WebGLRenderingContext", value);
    }
    ...
    {
        __MSGesture = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "MSGesture", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "CANNON", value);
    }
    ...
    public ValueTask set_webkitAudioContext(AudioContext value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "webkitAudioContext", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "PointerEvent", value);
    }
    ...
    {
        __Math = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "Math", value);
    }
    ...
    {
        __Uint8Array = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "Uint8Array", value);
    }
    ...
    {
        __Float32Array = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "Float32Array", value);
    }
    ...
    {
        __mozURL = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "mozURL", value);
    }
    ...
    {
        __msURL = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "msURL", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "VRFrameData", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "DracoDecoderModule", value);
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { this.___guid, "setImmediate" }, handler }
        );
    }
    #endregion
}
