...
public class BaseParticleSystem : CachedEntityObject
{
    ...
    {
        return EventHorizonBlazorInterop.Set("BaseParticleSystem", "BLENDMODE_ONEONE", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("BaseParticleSystem", "BLENDMODE_STANDARD", value);
    }

    public static async ValueTask<decimal> get_BLENDMODE_ADD()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("BaseParticleSystem", "BLENDMODE_ADD");
    }

    public static ValueTask set_BLENDMODE_ADD(decimal value)
    {
        return EventHorizonBlazorInterop.Set("BaseParticleSystem", "BLENDMODE_ADD", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("BaseParticleSystem", "BLENDMODE_MULTIPLY", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set("BaseParticleSystem", "BLENDMODE_MULTIPLYADD", value);
    }
    #endregion
    ...
    {
        __noiseTexture = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "noiseTexture", value);
    }

    public async ValueTask<bool> get_isAnimationSheetEnabled()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isAnimationSheetEnabled");
    }

    public ValueTask set_isAnimationSheetEnabled(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "isAnimationSheetEnabled", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isBillboardBased");
    }

    public ValueTask set_isBillboardBased(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "isBillboardBased", value);
    }
    ...
    public ValueTask set_imageProcessingConfiguration(ImageProcessingConfiguration value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "imageProcessingConfiguration", value);
    }
    #endregion
    ...
    {
        __emitter = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "emitter", value);
    }

    public async ValueTask<decimal> get_emitRate()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "emitRate");
    }

    public ValueTask set_emitRate(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "emitRate", value);
    }

    public async ValueTask<decimal> get_manualEmitCount()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "manualEmitCount");
    }

    public ValueTask set_manualEmitCount(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "manualEmitCount", value);
    }

    public async ValueTask<decimal> get_updateSpeed()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "updateSpeed");
    }

    public ValueTask set_updateSpeed(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "updateSpeed", value);
    }

    public async ValueTask<decimal> get_targetStopDuration()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "targetStopDuration");
    }

    public ValueTask set_targetStopDuration(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "targetStopDuration", value);
    }

    public async ValueTask<bool> get_disposeOnStop()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "disposeOnStop");
    }

    public ValueTask set_disposeOnStop(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "disposeOnStop", value);
    }

    public async ValueTask<decimal> get_minEmitPower()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "minEmitPower");
    }

    public ValueTask set_minEmitPower(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "minEmitPower", value);
    }

    public async ValueTask<decimal> get_maxEmitPower()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "maxEmitPower");
    }

    public ValueTask set_maxEmitPower(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "maxEmitPower", value);
    }

    public async ValueTask<decimal> get_minLifeTime()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "minLifeTime");
    }

    public ValueTask set_minLifeTime(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "minLifeTime", value);
    }

    public async ValueTask<decimal> get_maxLifeTime()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "maxLifeTime");
    }

    public ValueTask set_maxLifeTime(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "maxLifeTime", value);
    }

    public async ValueTask<decimal> get_minSize()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "minSize");
    }

    public ValueTask set_minSize(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "minSize", value);
    }

    public async ValueTask<decimal> get_maxSize()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "maxSize");
    }

    public ValueTask set_maxSize(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "maxSize", value);
    }

    public async ValueTask<decimal> get_minScaleX()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "minScaleX");
    }

    public ValueTask set_minScaleX(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "minScaleX", value);
    }

    public async ValueTask<decimal> get_maxScaleX()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "maxScaleX");
    }

    public ValueTask set_maxScaleX(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "maxScaleX", value);
    }

    public async ValueTask<decimal> get_minScaleY()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "minScaleY");
    }

    public ValueTask set_minScaleY(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "minScaleY", value);
    }

    public async ValueTask<decimal> get_maxScaleY()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "maxScaleY");
    }

    public ValueTask set_maxScaleY(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "maxScaleY", value);
    }

    public async ValueTask<decimal> get_minInitialRotation()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "minInitialRotation");
    }

    public ValueTask set_minInitialRotation(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "minInitialRotation", value);
    }

    public async ValueTask<decimal> get_maxInitialRotation()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "maxInitialRotation");
    }

    public ValueTask set_maxInitialRotation(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "maxInitialRotation", value);
    }

    public async ValueTask<decimal> get_minAngularSpeed()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "minAngularSpeed");
    }

    public ValueTask set_minAngularSpeed(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "minAngularSpeed", value);
    }

    public async ValueTask<decimal> get_maxAngularSpeed()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "maxAngularSpeed");
    }

    public ValueTask set_maxAngularSpeed(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "maxAngularSpeed", value);
    }
    ...
    public ValueTask set_particleTexture(BaseTexture value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "particleTexture", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "customShader", value);
    }

    public async ValueTask<bool> get_preventAutoStart()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "preventAutoStart");
    }

    public ValueTask set_preventAutoStart(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "preventAutoStart", value);
    }
    ...
    public ValueTask set_noiseStrength(Vector3 value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "noiseStrength", value);
    }

    public async ValueTask<ActionCallback> get_onAnimationEnd()
    {
        return await EventHorizonBlazorInterop.Get<ActionCallback>(this.___guid, "onAnimationEnd");
    }

    public ValueTask set_onAnimationEnd(ActionCallback value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "onAnimationEnd", value);
    }

    public async ValueTask<decimal> get_blendMode()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "blendMode");
    }

    public ValueTask set_blendMode(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "blendMode", value);
    }

    public async ValueTask<bool> get_forceDepthWrite()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "forceDepthWrite");
    }

    public ValueTask set_forceDepthWrite(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "forceDepthWrite", value);
    }

    public async ValueTask<decimal> get_preWarmCycles()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "preWarmCycles");
    }

    public ValueTask set_preWarmCycles(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "preWarmCycles", value);
    }

    public async ValueTask<decimal> get_preWarmStepOffset()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "preWarmStepOffset");
    }

    public ValueTask set_preWarmStepOffset(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "preWarmStepOffset", value);
    }

    public async ValueTask<decimal> get_spriteCellChangeSpeed()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "spriteCellChangeSpeed");
    }

    public ValueTask set_spriteCellChangeSpeed(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "spriteCellChangeSpeed", value);
    }

    public async ValueTask<decimal> get_startSpriteCellID()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "startSpriteCellID");
    }

    public ValueTask set_startSpriteCellID(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "startSpriteCellID", value);
    }

    public async ValueTask<decimal> get_endSpriteCellID()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "endSpriteCellID");
    }

    public ValueTask set_endSpriteCellID(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "endSpriteCellID", value);
    }

    public async ValueTask<decimal> get_spriteCellWidth()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "spriteCellWidth");
    }

    public ValueTask set_spriteCellWidth(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "spriteCellWidth", value);
    }

    public async ValueTask<decimal> get_spriteCellHeight()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "spriteCellHeight");
    }

    public ValueTask set_spriteCellHeight(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "spriteCellHeight", value);
    }

    public async ValueTask<bool> get_spriteRandomStartCell()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "spriteRandomStartCell");
    }

    public ValueTask set_spriteRandomStartCell(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "spriteRandomStartCell", value);
    }
    ...
    public ValueTask set_translationPivot(Vector2 value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "translationPivot", value);
    }

    public async ValueTask<bool> get_beginAnimationOnStart()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "beginAnimationOnStart");
    }

    public ValueTask set_beginAnimationOnStart(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "beginAnimationOnStart", value);
    }

    public async ValueTask<decimal> get_beginAnimationFrom()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "beginAnimationFrom");
    }

    public ValueTask set_beginAnimationFrom(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "beginAnimationFrom", value);
    }

    public async ValueTask<decimal> get_beginAnimationTo()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "beginAnimationTo");
    }

    public ValueTask set_beginAnimationTo(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "beginAnimationTo", value);
    }

    public async ValueTask<bool> get_beginAnimationLoop()
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "beginAnimationLoop");
    }

    public ValueTask set_beginAnimationLoop(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "beginAnimationLoop", value);
    }
    ...
    {
        __worldOffset = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "worldOffset", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "startDelay");
    }

    public ValueTask set_startDelay(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "startDelay", value);
    }

    public async ValueTask<decimal> get_limitVelocityDamping()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "limitVelocityDamping");
    }

    public ValueTask set_limitVelocityDamping(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "limitVelocityDamping", value);
    }
    ...
    {
        __color1 = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "color1", value);
    }
    ...
    {
        __color2 = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "color2", value);
    }
    ...
    {
        __colorDead = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "colorDead", value);
    }
    ...
    {
        __textureMask = null;
        return EventHorizonBlazorInterop.Set(this.___guid, "textureMask", value);
    }
    ...
    public async ValueTask<IParticleEmitterTypeCachedEntity> get_particleEmitterType()
    {
        if (__particleEmitterType == null)
        {
            __particleEmitterType =
                await EventHorizonBlazorInterop.GetClass<IParticleEmitterTypeCachedEntity>(
                    this.___guid,
                    "particleEmitterType",
                    (entity) =>
                    {
    ...
    public ValueTask set_particleEmitterType(IParticleEmitterTypeCachedEntity value)
    {
        ...
        return EventHorizonBlazorInterop.Set(this.___guid, "particleEmitterType", value);
    }

    public async ValueTask<decimal> get_billboardMode()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "billboardMode");
    }

    public ValueTask set_billboardMode(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "billboardMode", value);
    }
    #endregion
    ...
    public static async ValueTask<BaseParticleSystem> NewBaseParticleSystem(string name)
    {
        var entity = await EventHorizonBlazorInterop.New(
            new string[] { "BaseParticleSystem" },
            name
        );
