...
public class Mesh : AbstractMesh, IGetSetVerticesData
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "FRONTSIDE");
    }

    public static async ValueTask<decimal> get_BACKSIDE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "BACKSIDE");
    }

    public static async ValueTask<decimal> get_DOUBLESIDE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "DOUBLESIDE");
    }

    public static async ValueTask<decimal> get_DEFAULTSIDE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "DEFAULTSIDE");
    }

    public static async ValueTask<decimal> get_NO_CAP()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "NO_CAP");
    }

    public static async ValueTask<decimal> get_CAP_START()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "CAP_START");
    }

    public static async ValueTask<decimal> get_CAP_END()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "CAP_END");
    }

    public static async ValueTask<decimal> get_CAP_ALL()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "CAP_ALL");
    }

    public static async ValueTask<decimal> get_NO_FLIP()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "NO_FLIP");
    }

    public static async ValueTask<decimal> get_FLIP_TILE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "FLIP_TILE");
    }

    public static async ValueTask<decimal> get_ROTATE_TILE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "ROTATE_TILE");
    }

    public static async ValueTask<decimal> get_FLIP_ROW()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "FLIP_ROW");
    }

    public static async ValueTask<decimal> get_ROTATE_ROW()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "ROTATE_ROW");
    }

    public static async ValueTask<decimal> get_FLIP_N_ROTATE_TILE()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "FLIP_N_ROTATE_TILE");
    }

    public static async ValueTask<decimal> get_FLIP_N_ROTATE_ROW()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "FLIP_N_ROTATE_ROW");
    }

    public static async ValueTask<decimal> get_CENTER()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "CENTER");
    }

    public static async ValueTask<decimal> get_LEFT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "LEFT");
    }

    public static async ValueTask<decimal> get_RIGHT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "RIGHT");
    }

    public static async ValueTask<decimal> get_TOP()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "TOP");
    }

    public static async ValueTask<decimal> get_BOTTOM()
    {
        return await EventHorizonBlazorInterop.Get<decimal>("Mesh", "BOTTOM");
    }
    #endregion
    ...
    public static async ValueTask<Mesh> Parse(object parsedMesh, Scene scene, string rootUrl)
    {
        return await EventHorizonBlazorInterop.FuncClass<Mesh>(
            ...
            new object[] { new string[] { "Mesh", "Parse" }, parsedMesh, scene, rootUrl }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Mesh>(
            ...
            new object[]
            {
                new string[] { "Mesh", "CreateHemisphere" },
                name,
                segments,
                diameter,
                scene
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Mesh>(
            ...
            new object[]
            {
                new string[] { "Mesh", "CreateCylinder" },
                name,
                height,
                diameterTop,
                diameterBottom,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Mesh>(
            ...
            new object[]
            {
                new string[] { "Mesh", "CreateTorusKnot" },
                name,
                radius,
                tube,
                radialSegments,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<LinesMesh>(
            ...
            new object[]
            {
                new string[] { "Mesh", "CreateDashedLines" },
                name,
                points,
                dashSize,
                gapSize,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Mesh>(
            ...
            new object[]
            {
                new string[] { "Mesh", "ExtrudePolygon" },
                name,
                shape,
                depth,
                scene,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Mesh>(
            ...
            new object[]
            {
                new string[] { "Mesh", "CreateTiledGround" },
                name,
                xmin,
                zmin,
                xmax,
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<GroundMesh>(
            ...
            new object[]
            {
                new string[] { "Mesh", "CreateGroundFromHeightMap" },
                name,
                url,
                width,
                height,
    ...
    public static async ValueTask<Mesh> CreatePolyhedron(string name, object options, Scene scene)
    {
        return await EventHorizonBlazorInterop.FuncClass<Mesh>(
            entity => new Mesh() { ___guid = entity.___guid },
            new object[] { new string[] { "Mesh", "CreatePolyhedron" }, name, options, scene }
        );
    }
    ...
    public static async ValueTask<Mesh> CreateIcoSphere(string name, object options, Scene scene)
    {
        return await EventHorizonBlazorInterop.FuncClass<Mesh>(
            entity => new Mesh() { ___guid = entity.___guid },
            new object[] { new string[] { "Mesh", "CreateIcoSphere" }, name, options, scene }
        );
    }
    ...
    )
    {
        return await EventHorizonBlazorInterop.FuncClass<Mesh>(
            entity => new Mesh() { ___guid = entity.___guid },
            new object[] { new string[] { "Mesh", "CreateCapsule" }, name, options, scene }
        );
    }
    ...
    public static async ValueTask<CachedEntity> MinMax(AbstractMesh[] meshes)
    {
        return await EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "Mesh", "MinMax" }, meshes }
        );
    }
    ...
    public static async ValueTask<Vector3> Center(AbstractMesh[] meshesOrMinMaxVector)
    {
        return await EventHorizonBlazorInterop.FuncClass<Vector3>(
            ...
            new object[] { new string[] { "Mesh", "Center" }, meshesOrMinMaxVector }
        );
    }
    ...
    private CachedEntityObject __instances;

    public async ValueTask<CachedEntityObject> get_instances()
    {
        if (__instances == null)
        {
            __instances = await EventHorizonBlazorInterop.GetClass<CachedEntityObject>(
                this.___guid,
                "instances",
                (entity) =>
                {
    ...
    public ValueTask set_instances(CachedEntityObject value)
    {
        __instances = null;
    ...
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Mesh" }, name, scene);
