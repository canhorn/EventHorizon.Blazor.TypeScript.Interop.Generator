...
public class Sprite : ThinSprite, IAnimatable
{
    ...
    public static async ValueTask<Sprite> Parse(object parsedSprite, SpriteManager manager)
    {
        return await EventHorizonBlazorInterop.FuncClass<Sprite>(
            ...
            new object[] { new string[] { "Sprite", "Parse" }, parsedSprite, manager }
        );
    }
    #endregion
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "fromIndex");
    }

    public ValueTask set_fromIndex(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "fromIndex", value);
    }

    public async ValueTask<decimal> get_toIndex()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "toIndex");
    }

    public ValueTask set_toIndex(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "toIndex", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "delay");
    }

    public ValueTask set_delay(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "delay", value);
    }
    #endregion
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "disposeWhenFinishedAnimating", value);
    }
    ...
    {
        return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useAlphaForPicking");
    }

    public ValueTask set_useAlphaForPicking(bool value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "useAlphaForPicking", value);
    }
    ...
    public static async ValueTask<Sprite> NewSprite(string name, ISpriteManager manager)
    {
        var entity = await EventHorizonBlazorInterop.New(new string[] { "Sprite" }, name, manager);
    ...
    public async ValueTask playAnimation(
        decimal from,
        decimal to,
        bool loop,
        decimal delay,
