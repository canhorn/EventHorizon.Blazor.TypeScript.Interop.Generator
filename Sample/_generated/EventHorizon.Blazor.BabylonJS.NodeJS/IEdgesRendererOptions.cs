...
namespace BABYLON
{
    ...
    public class IEdgesRendererOptionsCachedEntity : CachedEntityObject, IEdgesRendererOptions
    {
        ...
        public bool useAlternateEdgeFinder
        {
            get
            {
                return EventHorizonBlazorInterop.Get<bool>(this.___guid, "useAlternateEdgeFinder");
            }
            set
            {
        ...
        public decimal epsilonVertexMerge
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "epsilonVertexMerge");
            }
            set
            {
        ...
        public decimal epsilonVertexAligned
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "epsilonVertexAligned");
            }
            set
            {
