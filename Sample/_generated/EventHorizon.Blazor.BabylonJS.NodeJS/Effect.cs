...
namespace BABYLON
{
    ...
    public class Effect : CachedEntityObject, _IDisposable
    {
        ...
        public static string ShadersRepository
        {
            get
            {
                return EventHorizonBlazorInterop.Get<string>("BABYLON", "Effect.ShadersRepository");
            }
            set
            {
        ...
        public string rawVertexSourceCode
        {
            get
            {
                return EventHorizonBlazorInterop.Get<string>(this.___guid, "rawVertexSourceCode");
            }
        }
        ...
        public string rawFragmentSourceCode
        {
            get
            {
                return EventHorizonBlazorInterop.Get<string>(this.___guid, "rawFragmentSourceCode");
            }
        }
