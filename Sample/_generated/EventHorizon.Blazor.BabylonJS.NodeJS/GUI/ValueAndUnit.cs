...
namespace BABYLON.GUI
{
    ...
    public class ValueAndUnit : CachedEntityObject
    {
        ...
        public bool negativeValueAllowed
        {
            get
            {
                return EventHorizonBlazorInterop.Get<bool>(this.___guid, "negativeValueAllowed");
            }
            set
            {
        ...
        public bool ignoreAdaptiveScaling
        {
            get
            {
                return EventHorizonBlazorInterop.Get<bool>(this.___guid, "ignoreAdaptiveScaling");
            }
            set
            {
