...
namespace BABYLON
{
    ...
    public class IPhysicsEnginePluginV2CachedEntity : CachedEntityObject, IPhysicsEnginePluginV2
    {
        ...
        public void executeStep(decimal delta, PhysicsBody[] bodies)
        {
            EventHorizonBlazorInterop.Func<CachedEntity>(
        ...
        public void setCollisionCallbackEnabled(
            PhysicsBody body,
            bool enabled,
            System.Nullable<decimal> instanceIndex = null
        )
        ...
        public void setCollisionEndedCallbackEnabled(
            PhysicsBody body,
            bool enabled,
            System.Nullable<decimal> instanceIndex = null
        )
        ...
        public BoundingBox getBoundingBox(PhysicsShape shape)
        {
        ...
        public void setAxisMinLimit(PhysicsConstraint constraint, int axis, decimal minLimit)
        {
            EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[]
                {
