...
namespace BABYLON
{
    ...
    public class Texture : BaseTexture
    {
        ...
        public static bool SerializeBuffers
        {
            get
            {
                return EventHorizonBlazorInterop.Get<bool>("BABYLON", "Texture.SerializeBuffers");
            }
            set
            {
        ...
        public static bool ForceSerializeBuffers
        {
            ...
            set
            {
                ...
                EventHorizonBlazorInterop.Set("BABYLON", "Texture.ForceSerializeBuffers", value);
            }
        }
        ...
        public static decimal NEAREST_LINEAR
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Texture.NEAREST_LINEAR");
            }
        }
        ...
        public static decimal NEAREST_NEAREST
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Texture.NEAREST_NEAREST");
            }
        }
        ...
        public static decimal LINEAR_LINEAR
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Texture.LINEAR_LINEAR");
            }
        }
        ...
        public static decimal LINEAR_NEAREST
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Texture.LINEAR_NEAREST");
            }
        }
        ...
        public static decimal EXPLICIT_MODE
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Texture.EXPLICIT_MODE");
            }
        }
        ...
        public static decimal SPHERICAL_MODE
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Texture.SPHERICAL_MODE");
            }
        }
        ...
        public static decimal PROJECTION_MODE
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Texture.PROJECTION_MODE");
            }
        }
        ...
        public static decimal INVCUBIC_MODE
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Texture.INVCUBIC_MODE");
            }
        }
