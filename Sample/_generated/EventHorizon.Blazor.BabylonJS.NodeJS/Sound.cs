    ...
    public class Sound : CachedEntityObject
    {
        ...
        public decimal directionalConeInnerAngle
        {
            ...
            set
            {
                ...
                EventHorizonBlazorInterop.Set(this.___guid, "directionalConeInnerAngle", value);
            }
        }
        ...
        public decimal directionalConeOuterAngle
        {
            ...
            set
            {
                ...
                EventHorizonBlazorInterop.Set(this.___guid, "directionalConeOuterAngle", value);
            }
        }
        #endregion
        ...
        {
            get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "autoplay"); }
            set
            {

                EventHorizonBlazorInterop.Set(this.___guid, "autoplay", value);
            }
        }
        ...
        public bool useCustomAttenuation
        {
            get
            {
                return EventHorizonBlazorInterop.Get<bool>(this.___guid, "useCustomAttenuation");
            }
            set
            {

                EventHorizonBlazorInterop.Set(this.___guid, "useCustomAttenuation", value);
            }
        }

        public decimal soundTrackId
        {
            get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "soundTrackId"); }
            set
            {

                EventHorizonBlazorInterop.Set(this.___guid, "soundTrackId", value);
            }
        }
        ...
        public bool isPlaying
        {
            ...
            set
            {
                ...
                EventHorizonBlazorInterop.Set(this.___guid, "isPlaying", value);
            }
        }

        public bool isPaused
        {
            get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "isPaused"); }
            set
            {
        ...
        {
            get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "refDistance"); }
            set
            {

                EventHorizonBlazorInterop.Set(this.___guid, "refDistance", value);
            }
        }

        public decimal rolloffFactor
        {
            get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "rolloffFactor"); }
            set
            {

                EventHorizonBlazorInterop.Set(this.___guid, "rolloffFactor", value);
            }
        }
        ...
        {
            get { return EventHorizonBlazorInterop.Get<string>(this.___guid, "distanceModel"); }
            set
            {

                EventHorizonBlazorInterop.Set(this.___guid, "distanceModel", value);
            }
        }
        ...
        public Observable<Sound> onEndedObservable
        {
            ...
            set
            {
                ...
                EventHorizonBlazorInterop.Set(this.___guid, "onEndedObservable", value);
            }
        }
        #endregion
        ...
        public void setDirectionalCone(
        ...
        public bool setAttenuationFunction_Remove(string handle)
        {
            return _setAttenuationFunctionActionMap.Remove(handle);
        }
