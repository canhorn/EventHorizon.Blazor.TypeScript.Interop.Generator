...
namespace BABYLON
{
    ...
    public class ImageProcessingPostProcess : PostProcess
    {
        ...
        public decimal vignetteCameraFov
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "vignetteCameraFov");
            }
            set
            {
        ...
        public decimal vignetteBlendMode
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "vignetteBlendMode");
            }
            set
            {
        ...
        public bool fromLinearSpace
        {
            ...
            set
            {
                ...
                EventHorizonBlazorInterop.Set(this.___guid, "fromLinearSpace", value);
            }
        }
        #endregion
