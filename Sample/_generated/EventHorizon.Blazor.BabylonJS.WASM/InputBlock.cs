...
public class InputBlock : NodeMaterialBlock
{
    ...
    public ActionResultCallback<CachedEntity> valueCallback
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "valueCallback", value);
        }
    }
    ...
    public string associatedVariableName
    {
        get
        {
            return EventHorizonBlazorInterop.Get<string>(this.___guid, "associatedVariableName");
        }
        set
        {
    ...
    {
        get { return EventHorizonBlazorInterop.Get<int>(this.___guid, "animationType"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "animationType", value);
        }
    }

    public bool isUndefined
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "isUndefined"); }
    }

    public bool isUniform
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "isUniform"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "isUniform", value);
        }
    }

    public bool isAttribute
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "isAttribute"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "isAttribute", value);
        }
    }

    public bool isVarying
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "isVarying"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "isVarying", value);
        }
    }

    public bool isSystemValue
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "isSystemValue"); }
    }

    public int systemValue
    {
        get { return EventHorizonBlazorInterop.Get<int>(this.___guid, "systemValue"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "systemValue", value);
        }
    }
    #endregion
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "isBoolean"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "isBoolean", value);
        }
    }

    public decimal matrixMode
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "matrixMode"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "matrixMode", value);
        }
    }

    public bool isConstant
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "isConstant"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "isConstant", value);
        }
    }

    public string groupInInspector
    {
        get { return EventHorizonBlazorInterop.Get<string>(this.___guid, "groupInInspector"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "groupInInspector", value);
        }
    }
    ...
    public Observable<InputBlock> onValueChangedObservable
    {
        get
        {
            ...
            {
                __onValueChangedObservable = EventHorizonBlazorInterop.GetClass<
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "onValueChangedObservable", value);
        }
    }
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "convertToLinearSpace"); }
        set
        {
