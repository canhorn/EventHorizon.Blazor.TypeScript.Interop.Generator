...
public class Camera : Node
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Camera", "PERSPECTIVE_CAMERA"); }
    }

    public static decimal ORTHOGRAPHIC_CAMERA
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Camera", "ORTHOGRAPHIC_CAMERA"); }
    }

    public static decimal FOVMODE_VERTICAL_FIXED
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Camera", "FOVMODE_VERTICAL_FIXED"); }
    }

    public static decimal FOVMODE_HORIZONTAL_FIXED
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Camera", "FOVMODE_HORIZONTAL_FIXED"); }
    }

    public static decimal RIG_MODE_NONE
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Camera", "RIG_MODE_NONE"); }
    }
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Camera", "RIG_MODE_VR"); }
    }

    public static decimal RIG_MODE_WEBVR
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Camera", "RIG_MODE_WEBVR"); }
    }

    public static decimal RIG_MODE_CUSTOM
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Camera", "RIG_MODE_CUSTOM"); }
    }
    ...
    public CachedEntityObject customRenderTargets
    {
        get
        {
            if (__customRenderTargets == null)
            {
                __customRenderTargets = EventHorizonBlazorInterop.GetClass<CachedEntityObject>(
                    this.___guid,
                    "customRenderTargets",
                    (entity) =>
                    {
    ...
    public Camera(string name, Scene scene = null)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "Camera" }, name, scene);
        ___guid = entity.___guid;
    }
    #endregion
