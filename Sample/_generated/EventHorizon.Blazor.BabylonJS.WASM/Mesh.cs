...
public class Mesh : AbstractMesh, IGetSetVerticesData
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "FRONTSIDE"); }
    }

    public static decimal BACKSIDE
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "BACKSIDE"); }
    }

    public static decimal DOUBLESIDE
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "DOUBLESIDE"); }
    }

    public static decimal DEFAULTSIDE
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "DEFAULTSIDE"); }
    }

    public static decimal NO_CAP
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "NO_CAP"); }
    }

    public static decimal CAP_START
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "CAP_START"); }
    }

    public static decimal CAP_END
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "CAP_END"); }
    }

    public static decimal CAP_ALL
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "CAP_ALL"); }
    }

    public static decimal NO_FLIP
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "NO_FLIP"); }
    }

    public static decimal FLIP_TILE
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "FLIP_TILE"); }
    }

    public static decimal ROTATE_TILE
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "ROTATE_TILE"); }
    }

    public static decimal FLIP_ROW
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "FLIP_ROW"); }
    }

    public static decimal ROTATE_ROW
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "ROTATE_ROW"); }
    }

    public static decimal FLIP_N_ROTATE_TILE
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "FLIP_N_ROTATE_TILE"); }
    }

    public static decimal FLIP_N_ROTATE_ROW
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "FLIP_N_ROTATE_ROW"); }
    }

    public static decimal CENTER
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "CENTER"); }
    }

    public static decimal LEFT
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "LEFT"); }
    }

    public static decimal RIGHT
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "RIGHT"); }
    }

    public static decimal TOP
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "TOP"); }
    }

    public static decimal BOTTOM
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Mesh", "BOTTOM"); }
    }
    #endregion
    ...
    public CachedEntityObject instances
    {
        get
        {
            if (__instances == null)
            {
                __instances = EventHorizonBlazorInterop.GetClass<CachedEntityObject>(
                    this.___guid,
                    "instances",
                    (entity) =>
                    {
    ...
    public Mesh(string name, Scene scene = null)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "Mesh" }, name, scene);
        ___guid = entity.___guid;
    }
    ...
    public Mesh(string name, Scene scene = null, System.Nullable<bool> isPure = null)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "Mesh" }, name, scene, isPure);
        ___guid = entity.___guid;
    }
    #endregion
    ...
    public Mesh updateMeshPositions(
