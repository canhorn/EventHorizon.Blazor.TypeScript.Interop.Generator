...
namespace BABYLON
{
    ...
    public class Mesh : AbstractMesh, IGetSetVerticesData
    {
        ...
        public static decimal FLIP_N_ROTATE_TILE
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Mesh.FLIP_N_ROTATE_TILE");
            }
        }
        ...
        public static decimal FLIP_N_ROTATE_ROW
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Mesh.FLIP_N_ROTATE_ROW");
            }
        }
