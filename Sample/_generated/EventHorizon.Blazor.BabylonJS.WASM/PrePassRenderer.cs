...
public class PrePassRenderer : CachedEntityObject
{
    ...
    public bool useGeometryBufferFallback
    {
        get
        {
            return EventHorizonBlazorInterop.Get<bool>(this.___guid, "useGeometryBufferFallback");
        }
        set
        {
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "disableGammaTransform"); }
        set
        {
    ...
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "PrePassRenderer" }, scene);
        ___guid = entity.___guid;
    }
    #endregion
