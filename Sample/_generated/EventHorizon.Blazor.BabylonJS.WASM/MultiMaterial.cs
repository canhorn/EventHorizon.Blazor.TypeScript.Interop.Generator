...
public class MultiMaterial : Material
{
    ...
    public MultiMaterial(string name, Scene scene)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "MultiMaterial" }, name, scene);
        ___guid = entity.___guid;
    }

    public MultiMaterial(string name, Scene scene, System.Nullable<bool> doNotAdd = null)
        : base()
    {
