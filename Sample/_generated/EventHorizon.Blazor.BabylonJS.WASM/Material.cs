...
public class Material : CachedEntityObject, IAnimatable
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "TriangleFillMode"); }
    }

    public static decimal WireFrameFillMode
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "WireFrameFillMode"); }
    }

    public static decimal PointFillMode
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "PointFillMode"); }
    }

    public static decimal PointListDrawMode
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "PointListDrawMode"); }
    }

    public static decimal LineListDrawMode
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "LineListDrawMode"); }
    }

    public static decimal LineLoopDrawMode
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "LineLoopDrawMode"); }
    }

    public static decimal LineStripDrawMode
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "LineStripDrawMode"); }
    }

    public static decimal TriangleStripDrawMode
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "TriangleStripDrawMode"); }
    }

    public static decimal TriangleFanDrawMode
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "TriangleFanDrawMode"); }
    }
    ...
    public static decimal ClockWiseSideOrientation
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("Material", "ClockWiseSideOrientation");
        }
    }
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "TextureDirtyFlag"); }
    }

    public static decimal LightDirtyFlag
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "LightDirtyFlag"); }
    }

    public static decimal FresnelDirtyFlag
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "FresnelDirtyFlag"); }
    }

    public static decimal AttributesDirtyFlag
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "AttributesDirtyFlag"); }
    }

    public static decimal MiscDirtyFlag
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "MiscDirtyFlag"); }
    }

    public static decimal PrePassDirtyFlag
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "PrePassDirtyFlag"); }
    }

    public static decimal AllDirtyFlag
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "AllDirtyFlag"); }
    }

    public static decimal MATERIAL_OPAQUE
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "MATERIAL_OPAQUE"); }
    }

    public static decimal MATERIAL_ALPHATEST
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "MATERIAL_ALPHATEST"); }
    }

    public static decimal MATERIAL_ALPHABLEND
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Material", "MATERIAL_ALPHABLEND"); }
    }
    ...
    public static decimal MATERIAL_ALPHATESTANDBLEND
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("Material", "MATERIAL_ALPHATESTANDBLEND");
        }
    }
    ...
    public Observable<CachedEntity> onEffectCreatedObservable
    {
        get
        {
            ...
            {
                __onEffectCreatedObservable = EventHorizonBlazorInterop.GetClass<
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "transparencyMode"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "transparencyMode", value);
        }
    }
    #endregion
    ...
    public ShadowDepthWrapper shadowDepthWrapper
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "shadowDepthWrapper", value);
        }
    }
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "disableColorWrite"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "disableColorWrite", value);
        }
    }
