...
namespace BABYLON
{
    ...
    public class Material : CachedEntityObject, IAnimatable
    {
        ...
        public static decimal PointFillMode
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Material.PointFillMode");
            }
        }
        ...
        public static decimal LightDirtyFlag
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Material.LightDirtyFlag");
            }
        }
        ...
        public static decimal MiscDirtyFlag
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Material.MiscDirtyFlag");
            }
        }
        ...
        public static decimal AllDirtyFlag
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Material.AllDirtyFlag");
            }
        }
        ...
        public bool allowShaderHotSwapping
        {
            get
            {
                return EventHorizonBlazorInterop.Get<bool>(this.___guid, "allowShaderHotSwapping");
            }
            set
            {
        ...
        public bool checkReadyOnEveryCall
        {
            get
            {
                return EventHorizonBlazorInterop.Get<bool>(this.___guid, "checkReadyOnEveryCall");
            }
            set
            {
