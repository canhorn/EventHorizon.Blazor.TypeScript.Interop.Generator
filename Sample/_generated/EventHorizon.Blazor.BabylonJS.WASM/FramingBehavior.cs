...
public class FramingBehavior : CachedEntityObject, Behavior<ArcRotateCamera>
{
    ...
    public static ExponentialEase EasingFunction
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set("FramingBehavior", "EasingFunction", value);
        }
    }

    public static decimal EasingMode
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("FramingBehavior", "EasingMode"); }
        set
        {

            EventHorizonBlazorInterop.Set("FramingBehavior", "EasingMode", value);
        }
    }
    ...
    public static decimal IgnoreBoundsSizeMode
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set("FramingBehavior", "IgnoreBoundsSizeMode", value);
        }
    }
    ...
    public static decimal FitFrustumSidesMode
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("FramingBehavior", "FitFrustumSidesMode");
        }
        set
        {

            EventHorizonBlazorInterop.Set("FramingBehavior", "FitFrustumSidesMode", value);
        }
    }
    #endregion
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "elevationReturnTime"); }
        set
        {
    ...
    public decimal elevationReturnWaitTime
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "elevationReturnWaitTime");
        }
        set
        {
