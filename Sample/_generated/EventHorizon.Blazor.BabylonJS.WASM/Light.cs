...
namespace BABYLON
{
    ...
    public class Light : Node
    {
        ...
        public static decimal FALLOFF_DEFAULT
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Light.FALLOFF_DEFAULT");
            }
        }
        ...
        public static decimal FALLOFF_PHYSICAL
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Light.FALLOFF_PHYSICAL");
            }
        }
        ...
        public static decimal FALLOFF_STANDARD
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Light.FALLOFF_STANDARD");
            }
        }
        ...
        public static decimal LIGHTMAP_DEFAULT
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Light.LIGHTMAP_DEFAULT");
            }
        }
        ...
        public static decimal LIGHTMAP_SPECULAR
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Light.LIGHTMAP_SPECULAR");
            }
        }
        ...
        public decimal excludeWithLayerMask
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "excludeWithLayerMask");
            }
            set
            {
