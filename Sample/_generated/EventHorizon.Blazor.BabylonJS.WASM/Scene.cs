...
public class Scene : AbstractScene, IAnimatable, IClipPlanesHolder
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Scene", "DragMovementThreshold"); }
        set
        {

            EventHorizonBlazorInterop.Set("Scene", "DragMovementThreshold", value);
        }
    }

    public static decimal LongPressDelay
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Scene", "LongPressDelay"); }
        set
        {

            EventHorizonBlazorInterop.Set("Scene", "LongPressDelay", value);
        }
    }

    public static decimal DoubleClickDelay
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Scene", "DoubleClickDelay"); }
        set
        {

            EventHorizonBlazorInterop.Set("Scene", "DoubleClickDelay", value);
        }
    }

    public static bool ExclusiveDoubleClickMode
    {
        get { return EventHorizonBlazorInterop.Get<bool>("Scene", "ExclusiveDoubleClickMode"); }
        set
        {

            EventHorizonBlazorInterop.Set("Scene", "ExclusiveDoubleClickMode", value);
        }
    }
    #endregion
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Scene", "FOGMODE_NONE"); }
    }

    public static decimal FOGMODE_EXP
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Scene", "FOGMODE_EXP"); }
    }

    public static decimal FOGMODE_EXP2
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Scene", "FOGMODE_EXP2"); }
    }

    public static decimal FOGMODE_LINEAR
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Scene", "FOGMODE_LINEAR"); }
    }

    public static decimal MinDeltaTime
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Scene", "MinDeltaTime"); }
        set
        {

            EventHorizonBlazorInterop.Set("Scene", "MinDeltaTime", value);
        }
    }

    public static decimal MaxDeltaTime
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Scene", "MaxDeltaTime"); }
        set
        {

            EventHorizonBlazorInterop.Set("Scene", "MaxDeltaTime", value);
        }
    }
    #endregion
    ...
    public Observable<MultiMaterial> onNewMultiMaterialAddedObservable
    {
        get
        {
            ...
            {
                __onNewMultiMaterialAddedObservable = EventHorizonBlazorInterop.GetClass<
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "onNewMultiMaterialAddedObservable", value);
        }
    }
    ...
    public Observable<MultiMaterial> onMultiMaterialRemovedObservable
    {
        get
        {
            ...
            {
                __onMultiMaterialRemovedObservable = EventHorizonBlazorInterop.GetClass<
                    Observable<MultiMaterial>
                >(
                    this.___guid,
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "onMultiMaterialRemovedObservable", value);
        }
    }
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "physicsEnabled"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "physicsEnabled", value);
        }
    }
    ...
    public Scene(Engine engine, SceneOptions options = null)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "Scene" }, engine, options);
        ___guid = entity.___guid;
    }
    ...
    public bool pointerDownPredicate(AbstractMesh Mesh)
    {
    ...
    public bool pointerUpPredicate(AbstractMesh Mesh)
    {
        return EventHorizonBlazorInterop.Func<bool>(
    ...
    public bool pointerMovePredicate(AbstractMesh Mesh)
    {
        return EventHorizonBlazorInterop.Func<bool>(
    ...
    public void onPointerMove(PointerEvent evt, PickingInfo pickInfo, PointerEventTypes type)
    {
    ...
    public void onPointerDown(PointerEvent evt, PickingInfo pickInfo, PointerEventTypes type)
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
    ...
    public void onPointerUp(PointerEvent evt, PickingInfo pickInfo, PointerEventTypes type)
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
    ...
    public void onPointerPick(PointerEvent evt, PickingInfo pickInfo)
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
    ...
    public void executeOnceBeforeRender(
        ActionCallback func,
    ...
    public T getOrAddExternalDataWithFactory<T>(string key, ActionResultCallback<string, T> factory)
        where T : CachedEntity, new()
    {
        return EventHorizonBlazorInterop.FuncClass<T>(
            entity => new T() { ___guid = entity.___guid },
    ...
    public CachedEntity getWorldExtends(
    ...
    public PickingInfo pickWithBoundingInfo(
        decimal x,
        decimal y,
        ActionResultCallback<AbstractMesh, bool> predicate = null,
        System.Nullable<bool> fastCheck = null,
