...
public class Effect : CachedEntityObject, _IDisposable
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<string>("Effect", "ShadersRepository"); }
        set
        {

            EventHorizonBlazorInterop.Set("Effect", "ShadersRepository", value);
        }
    }
    ...
    public static bool LogShaderCodeOnCompilationError
    {
        get
        {
            return EventHorizonBlazorInterop.Get<bool>("Effect", "LogShaderCodeOnCompilationError");
        }
        set
        {

            EventHorizonBlazorInterop.Set("Effect", "LogShaderCodeOnCompilationError", value);
        }
    }
    ...
    public static CachedEntity ShadersStore
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set("Effect", "ShadersStore", value);
        }
    }
    ...
    public static CachedEntity IncludesShadersStore
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set("Effect", "IncludesShadersStore", value);
        }
    }
    #endregion
    ...
    {
        get { return EventHorizonBlazorInterop.Get<string>(this.___guid, "vertexSourceCode"); }
    }

    public string fragmentSourceCode
    {
        get { return EventHorizonBlazorInterop.Get<string>(this.___guid, "fragmentSourceCode"); }
    }

    public string rawVertexSourceCode
    {
        get { return EventHorizonBlazorInterop.Get<string>(this.___guid, "rawVertexSourceCode"); }
    }

    public string rawFragmentSourceCode
    {
        get { return EventHorizonBlazorInterop.Get<string>(this.___guid, "rawFragmentSourceCode"); }
    }
