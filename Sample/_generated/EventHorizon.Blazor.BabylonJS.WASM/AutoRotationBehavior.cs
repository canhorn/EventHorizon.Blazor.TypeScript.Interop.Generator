...
public class AutoRotationBehavior : CachedEntityObject, Behavior<ArcRotateCamera>
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "idleRotationSpeed"); }
        set
        {
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "idleRotationWaitTime"); }
        set
        {
    ...
    public decimal idleRotationSpinupTime
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "idleRotationSpinupTime");
        }
        set
        {
