...
public class ThinEngine : CachedEntityObject
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<string>("ThinEngine", "NpmPackage"); }
    }

    public static string Version
    {
        get { return EventHorizonBlazorInterop.Get<string>("ThinEngine", "Version"); }
    }

    public static string ShadersRepository
    {
        get { return EventHorizonBlazorInterop.Get<string>("ThinEngine", "ShadersRepository"); }
        set
        {

            EventHorizonBlazorInterop.Set("ThinEngine", "ShadersRepository", value);
        }
    }

    public static bool IsSupported
    {
        get { return EventHorizonBlazorInterop.Get<bool>("ThinEngine", "IsSupported"); }
    }
    ...
    public static bool HasMajorPerformanceCaveat
    {
        get
        {
            return EventHorizonBlazorInterop.Get<bool>("ThinEngine", "HasMajorPerformanceCaveat");
        }
    }
    #endregion
    ...
    public static CachedEntity[] ExceptionList
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set("ThinEngine", "ExceptionList", value);
        }
    }

    public static decimal CollisionsEpsilon
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ThinEngine", "CollisionsEpsilon"); }
        set
        {

            EventHorizonBlazorInterop.Set("ThinEngine", "CollisionsEpsilon", value);
        }
    }
    #endregion
    ...
    private Observable<T> __onBeforeTextureInitObservable;
    public Observable<T> onBeforeTextureInitObservable
    {
        get
        {
            if (__onBeforeTextureInitObservable == null)
            {
                __onBeforeTextureInitObservable = EventHorizonBlazorInterop.GetClass<Observable<T>>(
                    this.___guid,
                    "onBeforeTextureInitObservable",
                    (entity) =>
                    {
                        return new Observable<T>() { ___guid = entity.___guid };
                    }
                );
            }
