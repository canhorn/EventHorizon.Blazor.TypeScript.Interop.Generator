...
public class ValueAndUnit : CachedEntityObject
{
    ...
    public static decimal UNITMODE_PERCENTAGE
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("ValueAndUnit", "UNITMODE_PERCENTAGE");
        }
    }

    public static decimal UNITMODE_PIXEL
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ValueAndUnit", "UNITMODE_PIXEL"); }
    }
    #endregion
