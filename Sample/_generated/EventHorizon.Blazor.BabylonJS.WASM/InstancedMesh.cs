...
public class InstancedMesh : AbstractMesh
{
    ...
    public InstancedMesh(string name, Mesh source)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "InstancedMesh" }, name, source);
    ...
    public InstancedMesh(string name, Scene scene = null)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "InstancedMesh" }, name, scene);
        ___guid = entity.___guid;
    }
