...
public class Image : Control
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Image", "STRETCH_NONE"); }
    }

    public static decimal STRETCH_FILL
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Image", "STRETCH_FILL"); }
    }

    public static decimal STRETCH_UNIFORM
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Image", "STRETCH_UNIFORM"); }
    }

    public static decimal STRETCH_EXTEND
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Image", "STRETCH_EXTEND"); }
    }

    public static decimal STRETCH_NINE_PATCH
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Image", "STRETCH_NINE_PATCH"); }
    }
    #endregion
    ...
    public Image(string name = null, string url = null)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "Image" }, name, url);
    ...
    public Image(string name = null)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "Image" }, name);
        ___guid = entity.___guid;
    }
    #endregion
