...
public class ParticleSystem : BaseParticleSystem, _IDisposable, IAnimatable, IParticleSystem
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ParticleSystem", "BILLBOARDMODE_Y"); }
    }
    ...
    public static decimal BILLBOARDMODE_ALL
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("ParticleSystem", "BILLBOARDMODE_ALL");
        }
    }
    ...
    public ParticleSystem(string name)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "ParticleSystem" }, name);
        ___guid = entity.___guid;
    }
    #endregion
