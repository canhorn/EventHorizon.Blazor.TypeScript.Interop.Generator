...
public class DetailMapConfiguration : CachedEntityObject
{
    ...
    public static void AddUniforms(string[] uniforms)
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "DetailMapConfiguration", "AddUniforms" }, uniforms }
        );
    }
    ...
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "DetailMapConfiguration", "AddSamplers" }, samplers }
        );
    }
    ...
    public static void PrepareUniformBuffer(UniformBuffer uniformBuffer)
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "DetailMapConfiguration", "PrepareUniformBuffer" },
                uniformBuffer
            }
        );
    }
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "diffuseBlendLevel"); }
        set
        {
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "roughnessBlendLevel"); }
        set
        {
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "normalBlendMethod"); }
        set
        {
    ...
    public DetailMapConfiguration(ActionCallback markAllSubMeshesAsTexturesDirty)
    {
        var entity = EventHorizonBlazorInterop.New(
            new string[] { "DetailMapConfiguration" },
