...
public class SpriteManager : CachedEntityObject, ISpriteManager
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<string>("SpriteManager", "SnippetUrl"); }
        set
        {

            EventHorizonBlazorInterop.Set("SpriteManager", "SnippetUrl", value);
        }
    }
    #endregion
    ...
    public static ValueTask<SpriteManager> ParseFromFileAsync(
        string url,
        Scene scene,
        string name = null,
        string rootUrl = null
