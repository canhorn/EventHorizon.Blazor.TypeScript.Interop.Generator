...
public class ActionManager : AbstractActionManager
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ActionManager", "NothingTrigger"); }
    }

    public static decimal OnPickTrigger
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnPickTrigger"); }
    }

    public static decimal OnLeftPickTrigger
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnLeftPickTrigger"); }
    }
    ...
    public static decimal OnRightPickTrigger
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnRightPickTrigger");
        }
    }
    ...
    public static decimal OnCenterPickTrigger
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnCenterPickTrigger");
        }
    }

    public static decimal OnPickDownTrigger
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnPickDownTrigger"); }
    }
    ...
    public static decimal OnDoublePickTrigger
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnDoublePickTrigger");
        }
    }

    public static decimal OnPickUpTrigger
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnPickUpTrigger"); }
    }

    public static decimal OnPickOutTrigger
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnPickOutTrigger"); }
    }
    ...
    public static decimal OnLongPressTrigger
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnLongPressTrigger");
        }
    }
    ...
    public static decimal OnPointerOverTrigger
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnPointerOverTrigger");
        }
    }
    ...
    public static decimal OnPointerOutTrigger
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnPointerOutTrigger");
        }
    }
    ...
    public static decimal OnEveryFrameTrigger
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnEveryFrameTrigger");
        }
    }
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnKeyDownTrigger"); }
    }

    public static decimal OnKeyUpTrigger
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ActionManager", "OnKeyUpTrigger"); }
    }
    #endregion
    ...
    public static void Parse(object parsedActions, AbstractMesh @object, Scene scene)
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "ActionManager", "Parse" },
                parsedActions,
                @object,
                scene
            }
    ...
    public static string GetTriggerName(decimal trigger)
    {
        return EventHorizonBlazorInterop.Func<string>(
            new object[] { new string[] { "ActionManager", "GetTriggerName" }, trigger }
        );
    }
    #endregion
    ...
    public ActionManager(Scene scene)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "ActionManager" }, scene);
