...
public class NodeMaterialConnectionPoint : CachedEntityObject
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "isConnectedToInputBlock"); }
    }
    ...
    public bool isConnectedInVertexShader
    {
        get
        {
            return EventHorizonBlazorInterop.Get<bool>(this.___guid, "isConnectedInVertexShader");
        }
    }
    ...
    public bool isConnectedInFragmentShader
    {
        get
        {
            return EventHorizonBlazorInterop.Get<bool>(this.___guid, "isConnectedInFragmentShader");
        }
    }
    #endregion
    ...
    public bool needDualDirectionValidation
    {
        get
        {
            return EventHorizonBlazorInterop.Get<bool>(this.___guid, "needDualDirectionValidation");
        }
        set
        {
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "exposedPortPosition"); }
        set
        {
