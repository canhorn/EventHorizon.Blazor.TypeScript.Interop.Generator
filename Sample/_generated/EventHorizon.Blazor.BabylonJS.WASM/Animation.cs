...
public class Animation : CachedEntityObject
{
    ...
    public static bool AllowMatricesInterpolation
    {
        get
        {
            return EventHorizonBlazorInterop.Get<bool>("Animation", "AllowMatricesInterpolation");
        }
        set
        {

            EventHorizonBlazorInterop.Set("Animation", "AllowMatricesInterpolation", value);
        }
    }
    ...
    {
        get { return EventHorizonBlazorInterop.Get<string>("Animation", "SnippetUrl"); }
        set
        {

            EventHorizonBlazorInterop.Set("Animation", "SnippetUrl", value);
        }
    }

    public static decimal ANIMATIONTYPE_FLOAT
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONTYPE_FLOAT"); }
    }

    public static decimal ANIMATIONTYPE_VECTOR3
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONTYPE_VECTOR3"); }
    }
    ...
    public static decimal ANIMATIONTYPE_QUATERNION
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONTYPE_QUATERNION");
        }
    }

    public static decimal ANIMATIONTYPE_MATRIX
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONTYPE_MATRIX"); }
    }

    public static decimal ANIMATIONTYPE_COLOR3
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONTYPE_COLOR3"); }
    }

    public static decimal ANIMATIONTYPE_COLOR4
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONTYPE_COLOR4"); }
    }

    public static decimal ANIMATIONTYPE_VECTOR2
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONTYPE_VECTOR2"); }
    }

    public static decimal ANIMATIONTYPE_SIZE
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONTYPE_SIZE"); }
    }
    ...
    public static decimal ANIMATIONLOOPMODE_CYCLE
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("Animation", "ANIMATIONLOOPMODE_CYCLE");
        }
    }
    ...
    public static Animation MakeAnimationAdditive(
