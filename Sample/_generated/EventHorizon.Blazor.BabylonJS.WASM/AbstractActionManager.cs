...
public class AbstractActionManager : CachedEntityObject, _IDisposable
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>("AbstractActionManager", "HasTriggers"); }
    }
    ...
    public static bool HasPickTriggers
    {
        get
        {
            return EventHorizonBlazorInterop.Get<bool>("AbstractActionManager", "HasPickTriggers");
        }
    }
    #endregion
    ...
    public static CachedEntity Triggers
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set("AbstractActionManager", "Triggers", value);
        }
    }
    #endregion
