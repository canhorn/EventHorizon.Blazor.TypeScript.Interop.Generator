...
public class IMultiRenderTargetOptionsCachedEntity : CachedEntityObject, IMultiRenderTargetOptions
{
    ...
    {
        get { return EventHorizonBlazorInterop.GetArray<decimal>(this.___guid, "samplingModes"); }
        set
        {
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "generateDepthTexture"); }
        set
        {
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "doNotChangeAspectRatio"); }
        set
        {
