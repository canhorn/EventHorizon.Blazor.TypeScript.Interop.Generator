...
public class BouncingBehavior : CachedEntityObject, Behavior<ArcRotateCamera>
{
    ...
    public static BackEase EasingFunction
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set("BouncingBehavior", "EasingFunction", value);
        }
    }

    public static decimal EasingMode
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("BouncingBehavior", "EasingMode"); }
        set
        {

            EventHorizonBlazorInterop.Set("BouncingBehavior", "EasingMode", value);
        }
    }
    #endregion
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "transitionDuration"); }
        set
        {
