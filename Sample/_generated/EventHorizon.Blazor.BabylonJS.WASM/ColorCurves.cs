...
namespace BABYLON
{
    ...
    public class ColorCurves : CachedEntityObject
    {
        ...
        public decimal highlightsDensity
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "highlightsDensity");
            }
            set
            {
        ...
        public decimal highlightsSaturation
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "highlightsSaturation");
            }
            set
            {
        ...
        public decimal highlightsExposure
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "highlightsExposure");
            }
            set
            {
        ...
        public decimal midtonesSaturation
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "midtonesSaturation");
            }
            set
            {
        ...
        public decimal shadowsSaturation
        {
            get
            {
                return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "shadowsSaturation");
            }
            set
            {
