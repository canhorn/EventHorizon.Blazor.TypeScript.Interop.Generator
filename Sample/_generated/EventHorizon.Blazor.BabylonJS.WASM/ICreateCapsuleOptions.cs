...
public class ICreateCapsuleOptionsCachedEntity : CachedEntityObject, ICreateCapsuleOptions
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "topCapSubdivisions"); }
        set
        {
    ...
    public decimal bottomCapSubdivisions
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "bottomCapSubdivisions");
        }
        set
        {
