...
namespace BABYLON
{
    ...
    public class VertexBuffer : CachedEntityObject
    {
        ...
        public static string NormalKind
        {
            get
            {
                return EventHorizonBlazorInterop.Get<string>("BABYLON", "VertexBuffer.NormalKind");
            }
        }
        ...
        public static string TangentKind
        {
            get
            {
                return EventHorizonBlazorInterop.Get<string>("BABYLON", "VertexBuffer.TangentKind");
            }
        }
        ...
        public static string ColorKind
        {
            get
            {
                return EventHorizonBlazorInterop.Get<string>("BABYLON", "VertexBuffer.ColorKind");
            }
        }
