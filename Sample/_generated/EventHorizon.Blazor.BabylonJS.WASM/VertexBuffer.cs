...
public class VertexBuffer : CachedEntityObject
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("VertexBuffer", "BYTE"); }
    }

    public static decimal UNSIGNED_BYTE
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("VertexBuffer", "UNSIGNED_BYTE"); }
    }

    public static decimal SHORT
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("VertexBuffer", "SHORT"); }
    }

    public static decimal UNSIGNED_SHORT
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("VertexBuffer", "UNSIGNED_SHORT"); }
    }

    public static decimal INT
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("VertexBuffer", "INT"); }
    }

    public static decimal UNSIGNED_INT
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("VertexBuffer", "UNSIGNED_INT"); }
    }

    public static decimal FLOAT
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("VertexBuffer", "FLOAT"); }
    }

    public static string PositionKind
    {
        get { return EventHorizonBlazorInterop.Get<string>("VertexBuffer", "PositionKind"); }
    }

    public static string NormalKind
    {
        get { return EventHorizonBlazorInterop.Get<string>("VertexBuffer", "NormalKind"); }
    }

    public static string TangentKind
    {
        get { return EventHorizonBlazorInterop.Get<string>("VertexBuffer", "TangentKind"); }
    }

    public static string UVKind
    {
        get { return EventHorizonBlazorInterop.Get<string>("VertexBuffer", "UVKind"); }
    }

    public static string UV2Kind
    {
        get { return EventHorizonBlazorInterop.Get<string>("VertexBuffer", "UV2Kind"); }
    }

    public static string UV3Kind
    {
        get { return EventHorizonBlazorInterop.Get<string>("VertexBuffer", "UV3Kind"); }
    }

    public static string UV4Kind
    {
        get { return EventHorizonBlazorInterop.Get<string>("VertexBuffer", "UV4Kind"); }
    }

    public static string UV5Kind
    {
        get { return EventHorizonBlazorInterop.Get<string>("VertexBuffer", "UV5Kind"); }
    }

    public static string UV6Kind
    {
        get { return EventHorizonBlazorInterop.Get<string>("VertexBuffer", "UV6Kind"); }
    }

    public static string ColorKind
    {
        get { return EventHorizonBlazorInterop.Get<string>("VertexBuffer", "ColorKind"); }
    }

    public static string MatricesIndicesKind
    {
        get { return EventHorizonBlazorInterop.Get<string>("VertexBuffer", "MatricesIndicesKind"); }
    }

    public static string MatricesWeightsKind
    {
        get { return EventHorizonBlazorInterop.Get<string>("VertexBuffer", "MatricesWeightsKind"); }
    }
