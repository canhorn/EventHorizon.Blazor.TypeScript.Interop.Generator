...
public class NodeMaterial : PushMaterial
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<string>("NodeMaterial", "EditorURL"); }
        set
        {

            EventHorizonBlazorInterop.Set("NodeMaterial", "EditorURL", value);
        }
    }

    public static string SnippetUrl
    {
        get { return EventHorizonBlazorInterop.Get<string>("NodeMaterial", "SnippetUrl"); }
        set
        {

            EventHorizonBlazorInterop.Set("NodeMaterial", "SnippetUrl", value);
        }
    }
    ...
    public static bool IgnoreTexturesAtLoadTime
    {
        get
        {
            return EventHorizonBlazorInterop.Get<bool>("NodeMaterial", "IgnoreTexturesAtLoadTime");
        }
        set
        {

            EventHorizonBlazorInterop.Set("NodeMaterial", "IgnoreTexturesAtLoadTime", value);
        }
    }
    #endregion
    ...
    public NodeMaterial(string name, Scene scene)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "NodeMaterial" }, name, scene);
        ___guid = entity.___guid;
    }

    public NodeMaterial(string name, Scene scene, System.Nullable<bool> doNotAdd = null)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(
            new string[] { "NodeMaterial" },
