...
public class ArcRotateCamera : TargetCamera
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "angularSensibilityX"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "angularSensibilityX", value);
        }
    }

    public decimal angularSensibilityY
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "angularSensibilityY"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "angularSensibilityY", value);
        }
    }

    public decimal pinchPrecision
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "pinchPrecision"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "pinchPrecision", value);
        }
    }

    public decimal pinchDeltaPercentage
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "pinchDeltaPercentage"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "pinchDeltaPercentage", value);
        }
    }

    public bool useNaturalPinchZoom
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "useNaturalPinchZoom"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "useNaturalPinchZoom", value);
        }
    }

    public decimal panningSensibility
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "panningSensibility"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "panningSensibility", value);
        }
    }
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "wheelDeltaPercentage"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "wheelDeltaPercentage", value);
        }
    }
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "useBouncingBehavior"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "useBouncingBehavior", value);
        }
    }
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "useFramingBehavior"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "useFramingBehavior", value);
        }
    }
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "useAutoRotationBehavior"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "useAutoRotationBehavior", value);
        }
    }
    #endregion
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "inertialAlphaOffset"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "inertialAlphaOffset", value);
        }
    }

    public decimal inertialBetaOffset
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "inertialBetaOffset"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "inertialBetaOffset", value);
        }
    }

    public decimal inertialRadiusOffset
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "inertialRadiusOffset"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "inertialRadiusOffset", value);
        }
    }

    public decimal lowerAlphaLimit
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "lowerAlphaLimit"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "lowerAlphaLimit", value);
        }
    }

    public decimal upperAlphaLimit
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "upperAlphaLimit"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "upperAlphaLimit", value);
        }
    }

    public decimal lowerBetaLimit
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "lowerBetaLimit"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "lowerBetaLimit", value);
        }
    }

    public decimal upperBetaLimit
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "upperBetaLimit"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "upperBetaLimit", value);
        }
    }

    public decimal lowerRadiusLimit
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "lowerRadiusLimit"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "lowerRadiusLimit", value);
        }
    }

    public decimal upperRadiusLimit
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "upperRadiusLimit"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "upperRadiusLimit", value);
        }
    }

    public decimal inertialPanningX
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "inertialPanningX"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "inertialPanningX", value);
        }
    }

    public decimal inertialPanningY
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "inertialPanningY"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "inertialPanningY", value);
        }
    }
    ...
    public decimal pinchToPanMaxDistance
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "pinchToPanMaxDistance");
        }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "pinchToPanMaxDistance", value);
        }
    }

    public decimal panningDistanceLimit
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "panningDistanceLimit"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "panningDistanceLimit", value);
        }
    }
    ...
    public Vector3 panningOriginTarget
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "panningOriginTarget", value);
        }
    }

    public decimal panningInertia
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "panningInertia"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "panningInertia", value);
        }
    }

    public decimal zoomOnFactor
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "zoomOnFactor"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "zoomOnFactor", value);
        }
    }
    ...
    public Vector2 targetScreenOffset
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "targetScreenOffset", value);
        }
    }

    public bool allowUpsideDown
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "allowUpsideDown"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "allowUpsideDown", value);
        }
    }

    public bool useInputToRestoreState
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "useInputToRestoreState"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "useInputToRestoreState", value);
        }
    }
    ...
    public Vector3 panningAxis
    {
        ...
        {
            __panningAxis = null;
            EventHorizonBlazorInterop.Set(this.___guid, "panningAxis", value);
        }
    }
    ...
    public Observable<AbstractMesh> onMeshTargetChangedObservable
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "onMeshTargetChangedObservable", value);
        }
    }
    ...
    public Vector3 collisionRadius
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "collisionRadius", value);
        }
    }
    #endregion
    ...
    public ArcRotateCamera(string name, Scene scene = null)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "ArcRotateCamera" }, name, scene);
        ___guid = entity.___guid;
    }
    #endregion
    ...
    public void detachControl(object ignored)
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
