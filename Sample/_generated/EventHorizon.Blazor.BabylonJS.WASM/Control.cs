...
public class Control : CachedEntityObject
{
    ...
    public static decimal HORIZONTAL_ALIGNMENT_LEFT
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("Control", "HORIZONTAL_ALIGNMENT_LEFT");
        }
    }
    ...
    public static decimal HORIZONTAL_ALIGNMENT_RIGHT
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("Control", "HORIZONTAL_ALIGNMENT_RIGHT");
        }
    }
    ...
    public static decimal HORIZONTAL_ALIGNMENT_CENTER
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("Control", "HORIZONTAL_ALIGNMENT_CENTER");
        }
    }

    public static decimal VERTICAL_ALIGNMENT_TOP
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("Control", "VERTICAL_ALIGNMENT_TOP"); }
    }
    ...
    public static decimal VERTICAL_ALIGNMENT_BOTTOM
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("Control", "VERTICAL_ALIGNMENT_BOTTOM");
        }
    }
    ...
    public static decimal VERTICAL_ALIGNMENT_CENTER
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("Control", "VERTICAL_ALIGNMENT_CENTER");
        }
    }
    #endregion
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>("Control", "AllowAlphaInheritance"); }
        set
        {

            EventHorizonBlazorInterop.Set("Control", "AllowAlphaInheritance", value);
        }
    }
    #endregion

    #region Static Methods
    public static CachedEntity AddHeader(Control control, string text, string size, object options)
    {
    ...
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "Control" }, name);
        ___guid = entity.___guid;
    }
    #endregion
