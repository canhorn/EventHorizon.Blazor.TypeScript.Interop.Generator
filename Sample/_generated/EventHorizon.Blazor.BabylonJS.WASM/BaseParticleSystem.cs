...
public class BaseParticleSystem : CachedEntityObject
{
    ...
    public static decimal BLENDMODE_ONEONE
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("BaseParticleSystem", "BLENDMODE_ONEONE");
        }
        set
        {

            EventHorizonBlazorInterop.Set("BaseParticleSystem", "BLENDMODE_ONEONE", value);
        }
    }
    ...
    public static decimal BLENDMODE_STANDARD
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set("BaseParticleSystem", "BLENDMODE_STANDARD", value);
        }
    }
    ...
    public static decimal BLENDMODE_ADD
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("BaseParticleSystem", "BLENDMODE_ADD");
        }
        set
        {

            EventHorizonBlazorInterop.Set("BaseParticleSystem", "BLENDMODE_ADD", value);
        }
    }
    ...
    public static decimal BLENDMODE_MULTIPLY
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set("BaseParticleSystem", "BLENDMODE_MULTIPLY", value);
        }
    }
    ...
    public static decimal BLENDMODE_MULTIPLYADD
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set("BaseParticleSystem", "BLENDMODE_MULTIPLYADD", value);
        }
    }
    #endregion
    ...
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "BaseParticleSystem" }, name);
        ___guid = entity.___guid;
    }
    #endregion
