...
public class EasingFunction : CachedEntityObject, IEasingFunction
{
    ...
    public static decimal EASINGMODE_EASEIN
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("EasingFunction", "EASINGMODE_EASEIN");
        }
    }
    ...
    public static decimal EASINGMODE_EASEOUT
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("EasingFunction", "EASINGMODE_EASEOUT");
        }
    }
    ...
    public static decimal EASINGMODE_EASEINOUT
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("EasingFunction", "EASINGMODE_EASEINOUT");
        }
    }
    #endregion
