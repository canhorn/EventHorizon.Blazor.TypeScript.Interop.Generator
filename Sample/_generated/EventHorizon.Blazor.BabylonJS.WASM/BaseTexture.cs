...
public class BaseTexture : ThinTexture, IAnimatable
{
    ...
    public CachedEntityObject animations
    {
        get
        {
            if (__animations == null)
            {
                __animations = EventHorizonBlazorInterop.GetClass<CachedEntityObject>(
                    this.___guid,
                    "animations",
                    (entity) =>
                    {
    ...
    public BaseTexture(Scene sceneOrEngine)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "BaseTexture" }, sceneOrEngine);
    ...
    public BaseTexture(InternalTexture internalTexture)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "BaseTexture" }, internalTexture);
        ___guid = entity.___guid;
    }
    #endregion
