...
public class TransformNode : Node
{
    ...
    public static decimal BILLBOARDMODE_NONE
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("TransformNode", "BILLBOARDMODE_NONE");
        }
        set
        {

            EventHorizonBlazorInterop.Set("TransformNode", "BILLBOARDMODE_NONE", value);
        }
    }

    public static decimal BILLBOARDMODE_X
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("TransformNode", "BILLBOARDMODE_X"); }
        set
        {

            EventHorizonBlazorInterop.Set("TransformNode", "BILLBOARDMODE_X", value);
        }
    }

    public static decimal BILLBOARDMODE_Y
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("TransformNode", "BILLBOARDMODE_Y"); }
        set
        {

            EventHorizonBlazorInterop.Set("TransformNode", "BILLBOARDMODE_Y", value);
        }
    }

    public static decimal BILLBOARDMODE_Z
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("TransformNode", "BILLBOARDMODE_Z"); }
        set
        {

            EventHorizonBlazorInterop.Set("TransformNode", "BILLBOARDMODE_Z", value);
        }
    }

    public static decimal BILLBOARDMODE_ALL
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("TransformNode", "BILLBOARDMODE_ALL"); }
        set
        {

            EventHorizonBlazorInterop.Set("TransformNode", "BILLBOARDMODE_ALL", value);
        }
    }
    ...
    public static decimal BILLBOARDMODE_USE_POSITION
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set("TransformNode", "BILLBOARDMODE_USE_POSITION", value);
        }
    }
    #endregion
    ...
    public TransformNode(string name, Scene scene = null)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "TransformNode" }, name, scene);
        ___guid = entity.___guid;
    }
    #endregion
