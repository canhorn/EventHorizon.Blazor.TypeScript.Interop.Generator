...
public class FreeCamera : TargetCamera
{
    ...
    {
        get { return EventHorizonBlazorInterop.GetArray<decimal>(this.___guid, "keysDownward"); }
        set
        {
    ...
    public FreeCamera(string name, Scene scene = null)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "FreeCamera" }, name, scene);
        ___guid = entity.___guid;
    }
    #endregion
