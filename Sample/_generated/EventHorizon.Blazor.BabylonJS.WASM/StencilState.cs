...
public class StencilState : CachedEntityObject
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("StencilState", "ALWAYS"); }
    }

    public static decimal KEEP
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("StencilState", "KEEP"); }
    }

    public static decimal REPLACE
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("StencilState", "REPLACE"); }
    }
    #endregion
