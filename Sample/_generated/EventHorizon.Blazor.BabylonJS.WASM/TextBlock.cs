...
public class TextBlock : Control
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "underline"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "underline", value);
        }
    }

    public bool lineThrough
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "lineThrough"); }
        set
        {

            EventHorizonBlazorInterop.Set(this.___guid, "lineThrough", value);
        }
    }
    ...
    public TextBlock(string name = null, string text = null)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "TextBlock" }, name, text);
    ...
    public TextBlock(string name = null)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "TextBlock" }, name);
        ___guid = entity.___guid;
    }
    #endregion
