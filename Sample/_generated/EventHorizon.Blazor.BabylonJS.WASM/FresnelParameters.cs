...
public class FresnelParameters : CachedEntityObject
{
    ...
    public static FresnelParameters Parse(CachedEntity parsedFresnelParameters)
    {
        return EventHorizonBlazorInterop.FuncClass<FresnelParameters>(
            ...
            new object[] { new string[] { "FresnelParameters", "Parse" }, parsedFresnelParameters }
        );
    }
    #endregion
    ...
    public FresnelParameters(CachedEntity options = null)
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "FresnelParameters" }, options);
        ___guid = entity.___guid;
    }
    #endregion
