...
public class ProceduralTexture : Texture
{
    ...
    public Observable<ProceduralTexture> onBeforeGenerationObservable
    {
        get
        {
            ...
            {
                __onBeforeGenerationObservable = EventHorizonBlazorInterop.GetClass<
                    Observable<ProceduralTexture>
                >(
                    this.___guid,
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "onBeforeGenerationObservable", value);
        }
    }
    ...
    public ProceduralTexture(Scene sceneOrEngine)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(
            new string[] { "ProceduralTexture" },
