...
public class ShadowGenerator : CachedEntityObject, IShadowGenerator
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<string>("ShadowGenerator", "CLASSNAME"); }
        set
        {

            EventHorizonBlazorInterop.Set("ShadowGenerator", "CLASSNAME", value);
        }
    }

    public static decimal FILTER_NONE
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ShadowGenerator", "FILTER_NONE"); }
    }
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ShadowGenerator", "FILTER_PCF"); }
    }

    public static decimal FILTER_PCSS
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ShadowGenerator", "FILTER_PCSS"); }
    }

    public static decimal QUALITY_HIGH
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ShadowGenerator", "QUALITY_HIGH"); }
    }

    public static decimal QUALITY_MEDIUM
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ShadowGenerator", "QUALITY_MEDIUM"); }
    }

    public static decimal QUALITY_LOW
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("ShadowGenerator", "QUALITY_LOW"); }
    }
    #endregion
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "useExponentialShadowMap"); }
        set
        {
    ...
    public bool useBlurExponentialShadowMap
    {
        get
        {
            return EventHorizonBlazorInterop.Get<bool>(this.___guid, "useBlurExponentialShadowMap");
        }
        set
        {
    ...
    public bool useBlurCloseExponentialShadowMap
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "useBlurCloseExponentialShadowMap", value);
        }
    }
    ...
    public bool useContactHardeningShadow
    {
        get
        {
            return EventHorizonBlazorInterop.Get<bool>(this.___guid, "useContactHardeningShadow");
        }
        set
        {
    ...
    public decimal contactHardeningLightSizeUVRatio
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "contactHardeningLightSizeUVRatio", value);
        }
    }
    ...
    public Observable<Effect> onBeforeShadowMapRenderObservable
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "onBeforeShadowMapRenderObservable", value);
        }
    }
    ...
    public Observable<Effect> onAfterShadowMapRenderObservable
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "onAfterShadowMapRenderObservable", value);
        }
    }
    ...
    public bool enableSoftTransparentShadow
    {
        get
        {
            return EventHorizonBlazorInterop.Get<bool>(this.___guid, "enableSoftTransparentShadow");
        }
        set
        {
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>(this.___guid, "frustumEdgeFalloff"); }
        set
        {
