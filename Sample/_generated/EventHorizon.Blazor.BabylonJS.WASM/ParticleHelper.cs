...
public class ParticleHelper : CachedEntityObject
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<string>("ParticleHelper", "BaseAssetsUrl"); }
        set
        {

            EventHorizonBlazorInterop.Set("ParticleHelper", "BaseAssetsUrl", value);
        }
    }

    public static string SnippetUrl
    {
        get { return EventHorizonBlazorInterop.Get<string>("ParticleHelper", "SnippetUrl"); }
        set
        {

            EventHorizonBlazorInterop.Set("ParticleHelper", "SnippetUrl", value);
        }
    }
    #endregion
