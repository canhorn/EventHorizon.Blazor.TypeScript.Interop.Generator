...
public class PushMaterial : Material
{
    ...
    public PushMaterial(string name, Scene scene)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "PushMaterial" }, name, scene);
        ___guid = entity.___guid;
    }

    public PushMaterial(string name, Scene scene, System.Nullable<bool> doNotAdd = null)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(
            new string[] { "PushMaterial" },
            name,
            scene,
            doNotAdd
        );
