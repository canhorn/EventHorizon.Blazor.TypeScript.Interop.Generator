...
public class AbstractMesh : TransformNode, _IDisposable, ICullable, IGetSetVerticesData
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("AbstractMesh", "BILLBOARDMODE_NONE"); }
    }

    public static decimal BILLBOARDMODE_X
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("AbstractMesh", "BILLBOARDMODE_X"); }
    }

    public static decimal BILLBOARDMODE_Y
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("AbstractMesh", "BILLBOARDMODE_Y"); }
    }

    public static decimal BILLBOARDMODE_Z
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("AbstractMesh", "BILLBOARDMODE_Z"); }
    }

    public static decimal BILLBOARDMODE_ALL
    {
        get { return EventHorizonBlazorInterop.Get<decimal>("AbstractMesh", "BILLBOARDMODE_ALL"); }
    }
    ...
    public static decimal OCCLUSION_TYPE_NONE
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("AbstractMesh", "OCCLUSION_TYPE_NONE");
        }
        set
        {

            EventHorizonBlazorInterop.Set("AbstractMesh", "OCCLUSION_TYPE_NONE", value);
        }
    }
    ...
    public static decimal OCCLUSION_TYPE_OPTIMISTIC
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set("AbstractMesh", "OCCLUSION_TYPE_OPTIMISTIC", value);
        }
    }
    ...
    public static decimal OCCLUSION_TYPE_STRICT
    {
        get
        {
            return EventHorizonBlazorInterop.Get<decimal>("AbstractMesh", "OCCLUSION_TYPE_STRICT");
        }
        set
        {

            EventHorizonBlazorInterop.Set("AbstractMesh", "OCCLUSION_TYPE_STRICT", value);
        }
    }
    ...
    public AbstractMesh(string name, Scene scene = null)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "AbstractMesh" }, name, scene);
