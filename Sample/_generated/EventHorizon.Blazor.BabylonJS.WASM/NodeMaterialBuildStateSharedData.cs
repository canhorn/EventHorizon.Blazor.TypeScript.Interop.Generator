...
public class NodeMaterialBuildStateSharedData : CachedEntityObject
{
    ...
    {
        get { return EventHorizonBlazorInterop.Get<string>(this.___guid, "varyingDeclaration"); }
        set
        {
    ...
    {
        get { return EventHorizonBlazorInterop.Get<bool>(this.___guid, "allowEmptyVertexProgram"); }
        set
        {
