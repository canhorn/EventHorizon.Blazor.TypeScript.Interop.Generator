...
public class PointerInfoPre : PointerInfoBase
{
    ...
    public PointerInfoPre(decimal type, PointerEvent @event)
        : base()
    {
        var entity = EventHorizonBlazorInterop.New(new string[] { "PointerInfoPre" }, type, @event);
        ___guid = entity.___guid;
    }
    #endregion
