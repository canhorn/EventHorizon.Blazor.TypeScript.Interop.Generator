...
namespace BABYLON
{
    ...
    public class IParticleSystemCachedEntity : CachedEntityObject, IParticleSystem
    {
        ...
        public ValueTask set_updateInAnimate(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "updateInAnimate", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "vertexShaderName", value);
        }
        ...
        public ValueTask set_vertexBuffers(Immutable<T> value)
        {
            __vertexBuffers = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "vertexBuffers", value);
        }
        ...
        public ValueTask set_indexBuffer(DataBuffer value)
        {
            __indexBuffer = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "indexBuffer", value);
        }
        ...
        public async ValueTask<IParticleSystemCachedEntity> addRampGradient(
            decimal gradient,
            Color3 color
        )
        {
