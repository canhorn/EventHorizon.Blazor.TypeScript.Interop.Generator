...
namespace BABYLON
{
    ...
    public class PickingInfo : CachedEntityObject
    {
        ...
        public async ValueTask<TransformNode> get_aimTransform()
        {
            if (__aimTransform == null)
            {
                __aimTransform = await EventHorizonBlazorInterop.GetClass<TransformNode>(
                    this.___guid,
                    "aimTransform",
                    (entity) =>
                    {
        ...
        public ValueTask set_aimTransform(TransformNode value)
        {
            __aimTransform = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "aimTransform", value);
        }

        private TransformNode __gripTransform;

        public async ValueTask<TransformNode> get_gripTransform()
        {
            if (__gripTransform == null)
            {
                __gripTransform = await EventHorizonBlazorInterop.GetClass<TransformNode>(
                    this.___guid,
                    "gripTransform",
                    (entity) =>
                    {
        ...
        public ValueTask set_gripTransform(TransformNode value)
        {
            __gripTransform = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "gripTransform", value);
        }
        #endregion
        ...
        public async ValueTask<Vector2> getTextureCoordinates(string uvSet = null)
        {
