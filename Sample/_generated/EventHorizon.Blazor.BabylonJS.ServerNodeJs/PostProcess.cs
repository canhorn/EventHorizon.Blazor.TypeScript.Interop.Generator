...
namespace BABYLON
{
    ...
    public class PostProcess : CachedEntityObject
    {
        ...
        public static async ValueTask RegisterShaderCodeProcessing(
        ...
        public static async ValueTask<PostProcess> Parse(
            object parsedPostProcess,
            Scene scene,
            string rootUrl
        )
        {
            return await EventHorizonBlazorInterop.FuncClass<PostProcess>(
                ...
                new object[]
                {
                    new string[] { "BABYLON", "PostProcess", "Parse" },
                    parsedPostProcess,
                    scene,
                    rootUrl
                }
        ...
        public async ValueTask<RenderTargetWrapper> get_inputTexture()
        {
            if (__inputTexture == null)
            {
                __inputTexture = await EventHorizonBlazorInterop.GetClass<RenderTargetWrapper>(
                    this.___guid,
                    "inputTexture",
                    (entity) =>
                    {
        ...
        public ValueTask set_inputTexture(RenderTargetWrapper value)
        {
            __inputTexture = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "inputTexture", value);
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "aspectRatio");
        }
        #endregion
        ...
        public ValueTask set_nodeMaterialSource(NodeMaterial value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "nodeMaterialSource", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "renderTargetSamplingMode", value);
        }
        ...
        public async ValueTask<bool> get_forceAutoClearInAlphaMode()
        {
        ...
        public ValueTask set_forceAutoClearInAlphaMode(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "forceAutoClearInAlphaMode", value);
        }
        ...
        public ValueTask set_alphaConstants(Color4 value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "alphaConstants", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "enablePixelPerfectMode", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "forceFullscreenViewport", value);
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "scaleMode");
        }

        public ValueTask set_scaleMode(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "scaleMode", value);
        }

        public async ValueTask<bool> get_alwaysForcePOT()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "alwaysForcePOT");
        }

        public ValueTask set_alwaysForcePOT(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "alwaysForcePOT", value);
        }
        ...
        public async ValueTask<bool> get_externalTextureSamplerBinding()
        {
            return await EventHorizonBlazorInterop.Get<bool>(
                this.___guid,
        ...
        public ValueTask set_externalTextureSamplerBinding(bool value)
        {
            return EventHorizonBlazorInterop.Set(
                this.___guid,
                "externalTextureSamplerBinding",
        ...
        public async ValueTask<Observable<Camera>> get_onActivateObservable()
        {
            ...
            {
                __onActivateObservable = await EventHorizonBlazorInterop.GetClass<
                    Observable<Camera>
                >(
                    this.___guid,
        ...
        public ValueTask set_onActivateObservable(Observable<Camera> value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "onActivateObservable", value);
        }
        ...
        public async ValueTask<Observable<PostProcess>> get_onSizeChangedObservable()
        {
            ...
            {
                __onSizeChangedObservable = await EventHorizonBlazorInterop.GetClass<
        ...
        public ValueTask set_onSizeChangedObservable(Observable<PostProcess> value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "onSizeChangedObservable", value);
        }
        ...
        public ValueTask set_onApplyObservable(Observable<Effect> value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "onApplyObservable", value);
        }
        ...
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] { new string[] { this.___guid, "restoreDefaultInputTexture" } }
            );
        }
        ...
        public async ValueTask updateEffect(
            string defines = null,
        ...
        public async ValueTask<RenderTargetWrapper> activate(
            Camera camera,
            InternalTexture sourceTexture = null,
            System.Nullable<bool> forceDepthStencil = null
        )
        {
            return await EventHorizonBlazorInterop.FuncClass<RenderTargetWrapper>(
        ...
        public async ValueTask<PostProcess> clone()
        {
            return await EventHorizonBlazorInterop.FuncClass<PostProcess>(
                entity => new PostProcess() { ___guid = entity.___guid },
