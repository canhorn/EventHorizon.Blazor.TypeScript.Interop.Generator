...
namespace BABYLON
{
    ...
    public class HavokPlugin : CachedEntityObject, IPhysicsEnginePluginV2
    {
        ...
        public async ValueTask<CachedEntity> get_numBodies()
        {
            return await EventHorizonBlazorInterop.Get<CachedEntity>(this.___guid, "numBodies");
        }
        #endregion
        ...
        public static async ValueTask<HavokPlugin> NewHavokPlugin(
        ...
        public async ValueTask executeStep(decimal delta, PhysicsBody[] physicsBodies)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
        ...
        public async ValueTask setActivationControl(PhysicsBody body, int controlMode)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[]
                {
        ...
        public async ValueTask setPhysicsBodyTransformation(PhysicsBody body, TransformNode node)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[]
                {
        ...
        public async ValueTask<BoundingBox> getBoundingBox(PhysicsShape _shape)
        {
        ...
        public async ValueTask pointProximity(
            IPhysicsPointProximityQuery query,
            ProximityCastResult result
        )
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
        ...
        public async ValueTask shapeProximity(
        ...
        public async ValueTask shapeCast(
        ...
        public async ValueTask<
            Observable<IPhysicsCollisionEventCachedEntity>
        > getCollisionObservable(PhysicsBody body)
        {
        ...
        public async ValueTask<
            Observable<IBasePhysicsCollisionEventCachedEntity>
        > getCollisionEndedObservable(PhysicsBody body)
        {
            return await EventHorizonBlazorInterop.FuncClass<
                Observable<IBasePhysicsCollisionEventCachedEntity>
            >(
        ...
        public async ValueTask setCollisionCallbackEnabled(PhysicsBody body, bool enabled)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[]
                {
        ...
        public async ValueTask setCollisionEndedCallbackEnabled(PhysicsBody body, bool enabled)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[]
                {
