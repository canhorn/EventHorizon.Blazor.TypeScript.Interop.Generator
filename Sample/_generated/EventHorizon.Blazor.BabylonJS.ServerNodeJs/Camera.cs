...
namespace BABYLON
{
    ...
    public class Camera : Node
    {
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Camera.RIG_MODE_NONE");
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Camera.RIG_MODE_VR");
        }
        ...
        public async ValueTask<decimal> get_screenArea()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "screenArea");
        }
        ...
        public async ValueTask<bool> get_hasMoved()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "hasMoved");
        }
        ...
        public async ValueTask<IObliqueParamsCachedEntity> get_oblique()
        {
            if (__oblique == null)
            {
                __oblique = await EventHorizonBlazorInterop.GetClass<IObliqueParamsCachedEntity>(
                    this.___guid,
                    "oblique",
                    (entity) =>
                    {
        ...
        public ValueTask set_oblique(IObliqueParamsCachedEntity value)
        {
            __oblique = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "oblique", value);
        }
        ...
        public async ValueTask<decimal> get_projectionPlaneTilt()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(
                this.___guid,
                "projectionPlaneTilt"
        ...
        public ValueTask set_projectionPlaneTilt(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "projectionPlaneTilt", value);
        }
        ...
        public async ValueTask<bool> hasStateStored()
        {
        ...
        public async ValueTask applyVerticalCorrection()
        {
        ...
        public async ValueTask detachControl(object ignored = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
        ...
        public async ValueTask<Camera> clone(string name, Node newParent = null)
        {
            return await EventHorizonBlazorInterop.FuncClass<Camera>(
                entity => new Camera() { ___guid = entity.___guid },
