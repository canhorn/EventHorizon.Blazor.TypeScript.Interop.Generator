...
namespace BABYLON
{
    ...
    public class Particle : CachedEntityObject
    {
        ...
        public async ValueTask<ThinParticleSystem> get_particleSystem()
        {
            if (__particleSystem == null)
            {
                __particleSystem = await EventHorizonBlazorInterop.GetClass<ThinParticleSystem>(
                    this.___guid,
                    "particleSystem",
                    (entity) =>
                    {
        ...
        public ValueTask set_particleSystem(ThinParticleSystem value)
        {
        ...
        public static async ValueTask<Particle> NewParticle(ThinParticleSystem particleSystem)
        {
