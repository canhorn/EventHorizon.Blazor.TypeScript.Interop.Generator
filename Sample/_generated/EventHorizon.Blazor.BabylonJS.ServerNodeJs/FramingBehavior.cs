...
namespace BABYLON
{
    ...
    public class FramingBehavior : CachedEntityObject, Behavior<ArcRotateCamera>
    {
        ...
        public async ValueTask<Observable<Void_>> get_onTargetFramingAnimationEndObservable()
        {
            if (__onTargetFramingAnimationEndObservable == null)
            {
                __onTargetFramingAnimationEndObservable = await EventHorizonBlazorInterop.GetClass<
                    Observable<Void_>
                >(
                    this.___guid,
        ...
        public ValueTask set_onTargetFramingAnimationEndObservable(Observable<Void_> value)
        {
        ...
        public async ValueTask<bool> zoomOnBoundingInfo(
