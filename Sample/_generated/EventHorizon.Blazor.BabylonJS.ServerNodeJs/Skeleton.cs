...
namespace BABYLON
{
    ...
    public class Skeleton : CachedEntityObject, IAnimatable
    {
        ...
        public async ValueTask prepare(System.Nullable<bool> dontCheckFrameId = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
        ...
        public async ValueTask computeAbsoluteMatrices(System.Nullable<bool> forceUpdate = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[]
                {
