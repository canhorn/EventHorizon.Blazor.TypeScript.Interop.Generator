...
namespace BABYLON
{
    ...
    public class VertexData : CachedEntityObject
    {
        ...
        public static async ValueTask<VertexData> Parse(object parsedVertexData)
        {
            return await EventHorizonBlazorInterop.FuncClass<VertexData>(
                entity => new VertexData() { ___guid = entity.___guid },
        ...
        public async ValueTask<VertexDataMaterialInfo[]> get_materialInfos()
        {
            return await EventHorizonBlazorInterop.GetArrayClass<VertexDataMaterialInfo>(
                this.___guid,
                "materialInfos",
                (entity) =>
                {
        ...
        public ValueTask set_materialInfos(VertexDataMaterialInfo[] value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "materialInfos", value);
        }
        ...
        public async ValueTask<VertexData[]> splitBasedOnMaterialID()
        {
            return await EventHorizonBlazorInterop.FuncArrayClass<VertexData>(
                entity => new VertexData() { ___guid = entity.___guid },
        ...
        public async ValueTask<VertexData> clone()
        {
            return await EventHorizonBlazorInterop.FuncClass<VertexData>(
                entity => new VertexData() { ___guid = entity.___guid },
