...
namespace BABYLON
{
    ...
    public class Observable<T> : CachedEntityObject
    {
        ...
        public static async ValueTask<Observable<T>> FromPromise<T, E>(
            T promise,
        ...
        public async ValueTask<bool> get_notifyIfTriggered()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "notifyIfTriggered");
        }

        public ValueTask set_notifyIfTriggered(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "notifyIfTriggered", value);
        }
        #endregion
        ...
        public async ValueTask cleanLastNotifiedState()
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
