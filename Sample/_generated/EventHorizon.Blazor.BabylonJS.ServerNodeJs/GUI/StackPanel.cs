...
namespace BABYLON.GUI
{
    ...
    public class StackPanel : Container
    {
        ...
        public async ValueTask<decimal> get_spacing()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "spacing");
        }

        public ValueTask set_spacing(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "spacing", value);
        }
