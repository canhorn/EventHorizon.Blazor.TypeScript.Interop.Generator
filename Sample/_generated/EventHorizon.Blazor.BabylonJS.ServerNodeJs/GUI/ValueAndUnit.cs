...
namespace BABYLON.GUI
{
    ...
    public class ValueAndUnit : CachedEntityObject
    {
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isPercentage");
        }

        public async ValueTask<bool> get_isPixel()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isPixel");
        }

        public async ValueTask<decimal> get_internalValue()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "internalValue");
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "unit");
        }

        public ValueTask set_unit(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "unit", value);
        }
        #endregion
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "negativeValueAllowed");
        }

        public ValueTask set_negativeValueAllowed(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "negativeValueAllowed", value);
        }

        public async ValueTask<bool> get_ignoreAdaptiveScaling()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "ignoreAdaptiveScaling");
        }

        public ValueTask set_ignoreAdaptiveScaling(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "ignoreAdaptiveScaling", value);
        }

        private Observable<Void_> __onChangedObservable;

        public async ValueTask<Observable<Void_>> get_onChangedObservable()
        {
            if (__onChangedObservable == null)
            {
                __onChangedObservable = await EventHorizonBlazorInterop.GetClass<Observable<Void_>>(
                    this.___guid,
                    "onChangedObservable",
                    (entity) =>
                    {
        ...
        public ValueTask set_onChangedObservable(Observable<Void_> value)
        {
        ...
        #region Methods
        public async ValueTask<decimal> getValueInPixel(
        ...
        public async ValueTask<ValueAndUnit> updateInPlace(
            decimal value,
            System.Nullable<decimal> unit = null
        )
        {
