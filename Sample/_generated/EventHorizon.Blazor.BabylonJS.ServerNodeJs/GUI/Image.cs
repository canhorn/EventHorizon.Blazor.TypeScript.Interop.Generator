...
namespace BABYLON.GUI
{
    ...
    public class Image : Control
    {
        ...
        public static async ValueTask<CachedEntity> get_SourceImgCache()
        {
        ...
        public static ValueTask set_SourceImgCache(CachedEntity value)
        {
            return EventHorizonBlazorInterop.Set("BABYLON", "GUI.Image.SourceImgCache", value);
        }
        ...
        public static async ValueTask ResetImageCache()
        {
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isLoaded");
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "detectPointerOnOpaqueOnly", value);
        }

        public async ValueTask<decimal> get_sliceLeft()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "sliceLeft");
        }

        public ValueTask set_sliceLeft(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "sliceLeft", value);
        }

        public async ValueTask<decimal> get_sliceRight()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "sliceRight");
        }

        public ValueTask set_sliceRight(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "sliceRight", value);
        }

        public async ValueTask<decimal> get_sliceTop()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "sliceTop");
        }

        public ValueTask set_sliceTop(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "sliceTop", value);
        }

        public async ValueTask<decimal> get_sliceBottom()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "sliceBottom");
        }

        public ValueTask set_sliceBottom(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "sliceBottom", value);
        }

        public async ValueTask<decimal> get_sourceLeft()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "sourceLeft");
        }

        public ValueTask set_sourceLeft(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "sourceLeft", value);
        }

        public async ValueTask<decimal> get_sourceTop()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "sourceTop");
        }

        public ValueTask set_sourceTop(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "sourceTop", value);
        }

        public async ValueTask<decimal> get_sourceWidth()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "sourceWidth");
        }

        public ValueTask set_sourceWidth(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "sourceWidth", value);
        }

        public async ValueTask<decimal> get_sourceHeight()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "sourceHeight");
        }

        public ValueTask set_sourceHeight(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "sourceHeight", value);
        }

        public async ValueTask<decimal> get_imageWidth()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "imageWidth");
        }

        public async ValueTask<decimal> get_imageHeight()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "imageHeight");
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isSVG");
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "autoScale");
        }

        public ValueTask set_autoScale(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "autoScale", value);
        }

        public async ValueTask<decimal> get_stretch()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "stretch");
        }

        public ValueTask set_stretch(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "stretch", value);
        }

        private IImageCachedEntity __domImage;

        public async ValueTask<IImageCachedEntity> get_domImage()
        {
            if (__domImage == null)
            {
                __domImage = await EventHorizonBlazorInterop.GetClass<IImageCachedEntity>(
                    this.___guid,
                    "domImage",
                    (entity) =>
                    {
        ...
        public ValueTask set_domImage(IImageCachedEntity value)
        {
            __domImage = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "domImage", value);
        }

        public async ValueTask<string> get_source()
        {
            return await EventHorizonBlazorInterop.Get<string>(this.___guid, "source");
        }

        public ValueTask set_source(string value)
        {
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "cellWidth");
        }

        public ValueTask set_cellWidth(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "cellWidth", value);
        }

        public async ValueTask<decimal> get_cellHeight()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "cellHeight");
        }

        public ValueTask set_cellHeight(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "cellHeight", value);
        }

        public async ValueTask<decimal> get_cellId()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "cellId");
        }

        public ValueTask set_cellId(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "cellId", value);
        }
        #endregion
        ...
        public async ValueTask<string> get_alt()
        {
            return await EventHorizonBlazorInterop.Get<string>(this.___guid, "alt");
        }

        public ValueTask set_alt(string value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "alt", value);
        }
        ...
        public async ValueTask<Observable<Image>> get_onImageLoadedObservable()
        {
            ...
            {
                __onImageLoadedObservable = await EventHorizonBlazorInterop.GetClass<
                    Observable<Image>
                >(
                    this.___guid,
        ...
        public ValueTask set_onImageLoadedObservable(Observable<Image> value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "onImageLoadedObservable", value);
        }
        ...
        public async ValueTask<Observable<Image>> get_onSVGAttributesComputedObservable()
        {
            ...
            {
                __onSVGAttributesComputedObservable = await EventHorizonBlazorInterop.GetClass<
                    Observable<Image>
                >(
                    this.___guid,
        ...
        public async ValueTask<ReferrerPolicy> get_referrerPolicy()
        {
            if (__referrerPolicy == null)
            {
                __referrerPolicy = await EventHorizonBlazorInterop.GetClass<ReferrerPolicy>(
                    this.___guid,
                    "referrerPolicy",
                    (entity) =>
                    {
        ...
        public ValueTask set_referrerPolicy(ReferrerPolicy value)
        {
        ...
        public static async ValueTask<Image> NewImage(string name = null, string url = null)
        {
        ...
        public static async ValueTask<Image> NewImage(string name = null)
        {
            var entity = await EventHorizonBlazorInterop.New(
                new string[] { "BABYLON", "GUI", "Image" },
                name
