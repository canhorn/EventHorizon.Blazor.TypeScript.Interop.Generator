...
namespace BABYLON
{
    ...
    public class Animation : CachedEntityObject
    {
        ...
        {
            return await EventHorizonBlazorInterop.Get<string>("BABYLON", "Animation.SnippetUrl");
        }

        public static ValueTask set_SnippetUrl(string value)
        {
            return EventHorizonBlazorInterop.Set("BABYLON", "Animation.SnippetUrl", value);
        }
        ...
        public static async ValueTask<decimal> get_ANIMATIONLOOPMODE_YOYO()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(
                "BABYLON",
        ...
        public static async ValueTask<decimal> get_ANIMATIONLOOPMODE_RELATIVE_FROM_CURRENT()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(
                "BABYLON",
        ...
        public static async ValueTask<Animation> get_CreateFromSnippetAsync()
        {
            return await EventHorizonBlazorInterop.Get<Animation>(
                "BABYLON",
                "Animation.CreateFromSnippetAsync"
            );
        }

        public static ValueTask set_CreateFromSnippetAsync(Animation value)
        {
            return EventHorizonBlazorInterop.Set(
                "BABYLON",
                "Animation.CreateFromSnippetAsync",
        ...
        )
        {
            return await EventHorizonBlazorInterop.FuncClass<Animation>(
                ...
                new object[]
                {
                    new string[] { "BABYLON", "Animation", "MakeAnimationAdditive" },
                    sourceAnimation,
                    referenceFrame,
                    range,
                    cloneOriginal,
        ...
        public static async ValueTask AppendSerializedAnimations(
            IAnimatable source,
            object destination
        )
        {
        ...
        public static async ValueTask<Animation> ParseFromFileAsync(string url, string name = null)
        {
            return await EventHorizonBlazorInterop.TaskClass<Animation>(
                ...
                new object[]
                {
                    new string[] { "BABYLON", "Animation", "ParseFromFileAsync" },
                    name,
                    url
                }
            );
        ...
        public static async ValueTask<Animation> ParseFromSnippetAsync(string snippetId)
        {
            return await EventHorizonBlazorInterop.TaskClass<Animation>(
                entity => new Animation() { ___guid = entity.___guid },
                new object[]
        ...
        public async ValueTask setEasingFunction(IEasingFunction easingFunction)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
        ...
        public async ValueTask<Color3> color3InterpolateFunctionWithTangents(
            Color3 startValue,
            Color3 outTangent,
            Color3 endValue,
            Color3 inTangent,
        ...
        public async ValueTask<Color4> color4InterpolateFunctionWithTangents(
            Color4 startValue,
            Color4 outTangent,
            Color4 endValue,
            Color4 inTangent,
        ...
        public async ValueTask<CachedEntity> evaluate(decimal currentFrame)
        {
        ...
        public async ValueTask setKeys(
            IAnimationKey[] values,
            System.Nullable<bool> dontClone = null
        )
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
        ...
        public async ValueTask<decimal> createKeyForFrame(decimal frame)
        {
            return await EventHorizonBlazorInterop.Func<decimal>(
