...
namespace BABYLON
{
    ...
    public class NodeMaterialBlock : CachedEntityObject
    {
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isUnique");
        }

        public async ValueTask<bool> get_isFinalMerger()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isFinalMerger");
        }

        public async ValueTask<bool> get_isInput()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isInput");
        }

        public async ValueTask<bool> get_isTeleportOut()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isTeleportOut");
        }

        public async ValueTask<bool> get_isTeleportIn()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isTeleportIn");
        }
        ...
        public async ValueTask<bool> get_willBeGeneratedIntoVertexShaderFromFragmentShader()
        {
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "inputsAreExclusive");
        }

        public ValueTask set_inputsAreExclusive(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "inputsAreExclusive", value);
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<string>(this.___guid, "comments");
        }

        public ValueTask set_comments(string value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "comments", value);
        }

        public async ValueTask<bool> get_visibleInInspector()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "visibleInInspector");
        }

        public ValueTask set_visibleInInspector(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "visibleInInspector", value);
        }

        public async ValueTask<bool> get_visibleOnFrame()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "visibleOnFrame");
        }

        public ValueTask set_visibleOnFrame(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "visibleOnFrame", value);
        }
        #endregion
        ...
        public async ValueTask<bool> isConnectedInFragmentShader()
        {
            return await EventHorizonBlazorInterop.Func<bool>(
                new object[] { new string[] { this.___guid, "isConnectedInFragmentShader" } }
            );
        }

        public async ValueTask<NodeMaterialBlock> registerInput(
            string name,
            int type,
        ...
        public async ValueTask<NodeMaterialBlock> registerOutput(
            string name,
            int type,
            System.Nullable<int> target = null,
            NodeMaterialConnectionPoint point = null
        ...
        public async ValueTask<NodeMaterialConnectionPoint> getFirstAvailableInput(
        ...
        public async ValueTask<NodeMaterialConnectionPoint> getFirstAvailableOutput(
        ...
        public async ValueTask<NodeMaterialConnectionPoint> getSiblingOutput(
            NodeMaterialConnectionPoint current
        )
        {
            return await EventHorizonBlazorInterop.FuncClass<NodeMaterialConnectionPoint>(
                entity => new NodeMaterialConnectionPoint() { ___guid = entity.___guid },
        ...
        public async ValueTask<bool> isAnAncestorOf(NodeMaterialBlock block)
        {
            return await EventHorizonBlazorInterop.Func<bool>(
                new object[] { new string[] { this.___guid, "isAnAncestorOf" }, block }
            );
        }

        public async ValueTask<NodeMaterialBlock> connectTo(
            NodeMaterialBlock other,
            object options = null
        )
        {
            return await EventHorizonBlazorInterop.FuncClass<NodeMaterialBlock>(
        ...
        public async ValueTask updateUniformsAndSamples(
        ...
        public async ValueTask replaceRepeatableContent(
        ...
        public async ValueTask<bool> build(
            NodeMaterialBuildState state,
            NodeMaterialBlock[] activeBlocks
        )
        {
            return await EventHorizonBlazorInterop.Func<bool>(
