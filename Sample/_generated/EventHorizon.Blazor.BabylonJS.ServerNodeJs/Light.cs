...
namespace BABYLON
{
    ...
    public class Light : Node, ISortableLight
    {
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Light.FALLOFF_DEFAULT");
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Light.FALLOFF_GLTF");
        }
        ...
        public static async ValueTask<Light> NewLight(string name, Scene scene = null)
        {
        ...
        #region Methods
        public async ValueTask<Matrix> getViewMatrix(System.Nullable<decimal> _faceIndex = null)
        {
        ...
        public async ValueTask<CachedEntity> getShadowGenerators()
        {
