...
namespace BABYLON
{
    ...
    public class BaseTexture : ThinTexture, IAnimatable
    {
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "hasAlpha");
        }

        public ValueTask set_hasAlpha(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "hasAlpha", value);
        }

        public async ValueTask<bool> get_getAlphaFromRGB()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "getAlphaFromRGB");
        }

        public ValueTask set_getAlphaFromRGB(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "getAlphaFromRGB", value);
        }

        public async ValueTask<decimal> get_coordinatesIndex()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "coordinatesIndex");
        }

        public ValueTask set_coordinatesIndex(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "coordinatesIndex", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "coordinatesMode", value);
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isRGBD");
        }

        public ValueTask set_isRGBD(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "isRGBD", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "lodGenerationOffset", value);
        }

        public async ValueTask<decimal> get_lodGenerationScale()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "lodGenerationScale");
        }

        public ValueTask set_lodGenerationScale(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "lodGenerationScale", value);
        }

        public async ValueTask<bool> get_linearSpecularLOD()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "linearSpecularLOD");
        }

        public ValueTask set_linearSpecularLOD(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "linearSpecularLOD", value);
        }
        ...
        public ValueTask set_irradianceTexture(BaseTexture value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "irradianceTexture", value);
        }
        ...
        public async ValueTask<bool> get_loadingError()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "loadingError");
        }

        public async ValueTask<CachedEntity> get_errorObject()
        {
            return await EventHorizonBlazorInterop.Get<CachedEntity>(this.___guid, "errorObject");
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "textureType");
        }

        public async ValueTask<decimal> get_textureFormat()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "textureFormat");
        }
        #endregion
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "level");
        }

        public ValueTask set_level(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "level", value);
        }

        public async ValueTask<bool> get_optimizeUVAllocation()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "optimizeUVAllocation");
        }

        public ValueTask set_optimizeUVAllocation(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "optimizeUVAllocation", value);
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "invertZ");
        }

        public ValueTask set_invertZ(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "invertZ", value);
        }

        public async ValueTask<bool> get_lodLevelInAlpha()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "lodLevelInAlpha");
        }

        public ValueTask set_lodLevelInAlpha(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "lodLevelInAlpha", value);
        }

        public async ValueTask<bool> get_isRenderTarget()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isRenderTarget");
        }

        public ValueTask set_isRenderTarget(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "isRenderTarget", value);
        }
        ...
        public static async ValueTask<BaseTexture> NewBaseTexture(InternalTexture internalTexture)
        {
            var entity = await EventHorizonBlazorInterop.New(
                new string[] { "BABYLON", "BaseTexture" },
                internalTexture
        ...
        public async ValueTask<Matrix> getRefractionTextureMatrix()
        {
            return await EventHorizonBlazorInterop.FuncClass<Matrix>(
                entity => new Matrix() { ___guid = entity.___guid },
        ...
        public async ValueTask<CachedEntity> serialize(System.Nullable<bool> allowEmptyName = null)
        {
