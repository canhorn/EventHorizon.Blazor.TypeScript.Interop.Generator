...
namespace BABYLON
{
    ...
    public class NodeMaterial : PushMaterial
    {
        ...
        {
            return await EventHorizonBlazorInterop.Get<string>("BABYLON", "NodeMaterial.EditorURL");
        }

        public static ValueTask set_EditorURL(string value)
        {
            return EventHorizonBlazorInterop.Set("BABYLON", "NodeMaterial.EditorURL", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set("BABYLON", "NodeMaterial.SnippetUrl", value);
        }
        ...
        public static async ValueTask<int> get_DefaultShaderLanguage()
        {
        ...
        public static ValueTask set_DefaultShaderLanguage(int value)
        {
            return EventHorizonBlazorInterop.Set(
                "BABYLON",
                "NodeMaterial.DefaultShaderLanguage",
        ...
        public static async ValueTask<NodeMaterial> Parse(
            object source,
            Scene scene,
            string rootUrl = null,
        ...
        public static async ValueTask<NodeMaterial> ParseFromFileAsync(
            string name,
            string url,
            Scene scene,
            string rootUrl = null,
        ...
        public async ValueTask<INodeMaterialOptionsCachedEntity> get_options()
        {
            ...
            {
                __options =
                    await EventHorizonBlazorInterop.GetClass<INodeMaterialOptionsCachedEntity>(
                        this.___guid,
                        "options",
                        (entity) =>
                        {
        ...
        public async ValueTask<decimal[]> get_prePassTextureOutputs()
        {
        ...
        public async ValueTask<decimal[]> get_prePassTextureInputs()
        {
            return await EventHorizonBlazorInterop.GetArray<decimal>(
                this.___guid,
        ...
        {
            return await EventHorizonBlazorInterop.Get<string>(this.___guid, "compiledShaders");
        }
        #endregion
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "editorData", value);
        }

        public async ValueTask<bool> get_ignoreAlpha()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "ignoreAlpha");
        }

        public ValueTask set_ignoreAlpha(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "ignoreAlpha", value);
        }
        ...
        public async ValueTask<Observable<NodeMaterial>> get_onBuildObservable()
        {
            ...
            {
                __onBuildObservable = await EventHorizonBlazorInterop.GetClass<
        ...
        public ValueTask set_onBuildObservable(Observable<NodeMaterial> value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "onBuildObservable", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "attachedBlocks", value);
        }

        public async ValueTask<string> get_comment()
        {
            return await EventHorizonBlazorInterop.Get<string>(this.___guid, "comment");
        }

        public ValueTask set_comment(string value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "comment", value);
        }

        public async ValueTask<bool> get_forceAlphaBlending()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "forceAlphaBlending");
        }

        public ValueTask set_forceAlphaBlending(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "forceAlphaBlending", value);
        }
        #endregion
        ...
        public static async ValueTask<NodeMaterial> NewNodeMaterial(
            string name,
            Scene scene = null,
            INodeMaterialOptions options = null
        )
        {
        ...
        public async ValueTask<NodeMaterialBlock> getBlockByPredicate(
        ...
        public async ValueTask<InputBlock> getInputBlockByPredicate(
            ActionResultCallback<InputBlock, bool> predicate
        )
        {
        ...
        public async ValueTask createEffectForParticles(
        ...
        public async ValueTask createAsShadowDepthWrapper(Material targetMaterial)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[]
                {
        ...
        public async ValueTask<TextureBlock[]> getAllTextureBlocks()
        {
            return await EventHorizonBlazorInterop.FuncArrayClass<TextureBlock>(
                entity => new TextureBlock() { ___guid = entity.___guid },
        ...
        public async ValueTask<NodeMaterial> loadAsync(string url, string rootUrl = null)
        {
            return await EventHorizonBlazorInterop.TaskClass<NodeMaterial>(
                entity => new NodeMaterial() { ___guid = entity.___guid },
        ...
        public async ValueTask loadFromSerialization(
            object source,
            string rootUrl = null,
            System.Nullable<bool> merge = null
        )
        ...
        public async ValueTask<NodeMaterial> clone(
            string name,
            System.Nullable<bool> shareEffect = null
        )
        {
            return await EventHorizonBlazorInterop.FuncClass<NodeMaterial>(
                entity => new NodeMaterial() { ___guid = entity.___guid },
        ...
        {
            await EventHorizonBlazorInterop.TaskArray<Void_>(
