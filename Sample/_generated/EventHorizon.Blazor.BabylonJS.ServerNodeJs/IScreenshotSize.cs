...
namespace BABYLON
{
    ...
    public class IScreenshotSizeCachedEntity : CachedEntityObject, IScreenshotSize
    {
        ...
        public async ValueTask<decimal> get_finalWidth()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "finalWidth");
        }

        public ValueTask set_finalWidth(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "finalWidth", value);
        }

        public async ValueTask<decimal> get_finalHeight()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "finalHeight");
        }

        public ValueTask set_finalHeight(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "finalHeight", value);
        }
        #endregion
