...
namespace BABYLON
{
    ...
    public class NodeMaterialConnectionPoint : CachedEntityObject
    {
        ...
        public async ValueTask<bool> get_isDirectlyConnectedToVertexOutput()
        {
            return await EventHorizonBlazorInterop.Get<bool>(
                this.___guid,
        ...
        public async ValueTask<
            Observable<NodeMaterialConnectionPoint>
        > get_onDisconnectionObservable()
        {
            if (__onDisconnectionObservable == null)
            {
                __onDisconnectionObservable = await EventHorizonBlazorInterop.GetClass<
                    Observable<NodeMaterialConnectionPoint>
                >(
                    this.___guid,
        ...
        public async ValueTask<Observable<int>> get_onTypeChangedObservable()
        {
        ...
        public async ValueTask<int> checkCompatibilityState(
        ...
        public async ValueTask addExcludedConnectionPointFromAllowedTypes(decimal mask)
        {
