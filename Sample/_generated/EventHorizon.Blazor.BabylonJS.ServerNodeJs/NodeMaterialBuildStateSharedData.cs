...
namespace BABYLON
{
    ...
    public class NodeMaterialBuildStateSharedData : CachedEntityObject
    {
        ...
        public async ValueTask<NodeMaterial> get_nodeMaterial()
        {
            if (__nodeMaterial == null)
            {
                __nodeMaterial = await EventHorizonBlazorInterop.GetClass<NodeMaterial>(
                    this.___guid,
                    "nodeMaterial",
                    (entity) =>
                    {
        ...
        public ValueTask set_nodeMaterial(NodeMaterial value)
        {
            __nodeMaterial = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "nodeMaterial", value);
        }

        public async ValueTask<string[]> get_temps()
        {
            return await EventHorizonBlazorInterop.GetArray<string>(this.___guid, "temps");
        }

        public ValueTask set_temps(string[] value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "temps", value);
        }

        public async ValueTask<string[]> get_varyings()
        {
            return await EventHorizonBlazorInterop.GetArray<string>(this.___guid, "varyings");
        }

        public ValueTask set_varyings(string[] value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "varyings", value);
        }

        public async ValueTask<string> get_varyingDeclaration()
        {
            return await EventHorizonBlazorInterop.Get<string>(this.___guid, "varyingDeclaration");
        }

        public ValueTask set_varyingDeclaration(string value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "varyingDeclaration", value);
        }

        private Immutable<T> __fragmentOutputNodes;

        public async ValueTask<Immutable<T>> get_fragmentOutputNodes()
        {
            if (__fragmentOutputNodes == null)
            {
                __fragmentOutputNodes = await EventHorizonBlazorInterop.GetClass<Immutable<T>>(
                    this.___guid,
                    "fragmentOutputNodes",
                    (entity) =>
                    {
        ...
        public ValueTask set_fragmentOutputNodes(Immutable<T> value)
        {
            __fragmentOutputNodes = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "fragmentOutputNodes", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "inputBlocks", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "textureBlocks", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "bindableBlocks", value);
        }

        public async ValueTask<NodeMaterialBlock[]> get_forcedBindableBlocks()
        {
            return await EventHorizonBlazorInterop.GetArrayClass<NodeMaterialBlock>(
                this.___guid,
        ...
        public ValueTask set_forcedBindableBlocks(NodeMaterialBlock[] value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "forcedBindableBlocks", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "blocksWithFallbacks", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "blocksWithDefines", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "repeatableContentBlocks", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "dynamicUniformBlocks", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "blockingBlocks", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "animatedInputs", value);
        }

        public async ValueTask<decimal> get_buildId()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "buildId");
        }

        public ValueTask set_buildId(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "buildId", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "variableNames", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "defineNames", value);
        }

        public async ValueTask<bool> get_emitComments()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "emitComments");
        }

        public ValueTask set_emitComments(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "emitComments", value);
        }

        public async ValueTask<bool> get_verbose()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "verbose");
        }

        public ValueTask set_verbose(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "verbose", value);
        }
        ...
        {
            __scene = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "scene", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "hints", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "checks", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "allowEmptyVertexProgram", value);
        }
        #endregion
