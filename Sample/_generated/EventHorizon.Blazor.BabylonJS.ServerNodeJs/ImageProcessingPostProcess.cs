...
namespace BABYLON
{
    ...
    public class ImageProcessingPostProcess : PostProcess
    {
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "fromLinearSpace");
        }

        public ValueTask set_fromLinearSpace(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "fromLinearSpace", value);
        }
        #endregion
        ...
        public ImageProcessingPostProcess(ICachedEntity entity)
            : base(entity) { }
