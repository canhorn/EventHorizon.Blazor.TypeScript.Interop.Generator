...
namespace BABYLON
{
    ...
    public class Animatable : CachedEntityObject
    {
        ...
        public async ValueTask<decimal> get_elapsedTime()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "elapsedTime");
        }

        public async ValueTask<bool> get_paused()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "paused");
        }
        #endregion
        ...
        public async ValueTask<ActionCallback> get_onAnimationLoop()
        {
            return await EventHorizonBlazorInterop.Get<ActionCallback>(
                this.___guid,
                "onAnimationLoop"
        ...
        public ValueTask set_onAnimationLoop(ActionCallback value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "onAnimationLoop", value);
        }
