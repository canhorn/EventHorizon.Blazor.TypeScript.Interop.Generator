...
namespace BABYLON
{
    ...
    public class Material : CachedEntityObject, IAnimatable, IClipPlanesHolder
    {
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>("BABYLON", "Material.AllDirtyFlag");
        }
        ...
        public static async ValueTask<Observable<Material>> get_OnEventObservable()
        {
            if (__OnEventObservable == null)
            {
                __OnEventObservable = await EventHorizonBlazorInterop.GetClass<
                    Observable<Material>
                >(
                    "BABYLON",
        ...
        public static ValueTask set_OnEventObservable(Observable<Material> value)
        {
            __OnEventObservable = null;
            return EventHorizonBlazorInterop.Set("BABYLON", "Material.OnEventObservable", value);
        }
        #endregion
        ...
        public async ValueTask<bool> get_blockDirtyMechanism()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "blockDirtyMechanism");
        }

        public ValueTask set_blockDirtyMechanism(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "blockDirtyMechanism", value);
        }
        ...
        public async ValueTask<Observable<AbstractMesh>> get_onBindObservable()
        {
            ...
            {
                __onBindObservable = await EventHorizonBlazorInterop.GetClass<
        ...
        public async ValueTask<Observable<Material>> get_onUnBindObservable()
        {
            ...
            {
                __onUnBindObservable = await EventHorizonBlazorInterop.GetClass<
                    Observable<Material>
                >(
                    this.___guid,
                    "onUnBindObservable",
        ...
        public async ValueTask<decimal> get_zOffsetUnits()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "zOffsetUnits");
        }

        public ValueTask set_zOffsetUnits(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "zOffsetUnits", value);
        }
        ...
        public async ValueTask<MaterialStencilState> get_stencil()
        {
            if (__stencil == null)
            {
                __stencil = await EventHorizonBlazorInterop.GetClass<MaterialStencilState>(
                    this.___guid,
                    "stencil",
                    (entity) =>
                    {
        ...
        public async ValueTask<string> atomicMaterialsUpdate(Func<Material, Task> callback)
        {
            await SetupAtomicMaterialsUpdateLoop();
        ...
        private async ValueTask SetupAtomicMaterialsUpdateLoop()
        {
        ...
        public async ValueTask markDirty(System.Nullable<bool> forceMaterialDirty = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
        ...
        public async ValueTask bindEyePosition(Effect effect, string variableName = null)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[]
                {
