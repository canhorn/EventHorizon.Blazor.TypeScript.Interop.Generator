...
namespace BABYLON
{
    ...
    public class Layer : CachedEntityObject
    {
        ...
        public async ValueTask<bool> get_applyPostProcess()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "applyPostProcess");
        }

        public ValueTask set_applyPostProcess(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "applyPostProcess", value);
        }
        #endregion
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isBackground");
        }

        public ValueTask set_isBackground(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "isBackground", value);
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "alphaBlendingMode");
        }

        public ValueTask set_alphaBlendingMode(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "alphaBlendingMode", value);
        }

        public async ValueTask<bool> get_alphaTest()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "alphaTest");
        }

        public ValueTask set_alphaTest(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "alphaTest", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "renderTargetTextures", value);
        }
