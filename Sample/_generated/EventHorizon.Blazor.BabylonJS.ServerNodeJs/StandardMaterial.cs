...
namespace BABYLON
{
    ...
    public class StandardMaterial : PushMaterial
    {
        ...
        public async ValueTask<bool> get_applyDecalMapAfterDetailMap()
        {
            return await EventHorizonBlazorInterop.Get<bool>(
                this.___guid,
        ...
        public ValueTask set_applyDecalMapAfterDetailMap(bool value)
        {
            return EventHorizonBlazorInterop.Set(
                this.___guid,
                "applyDecalMapAfterDetailMap",
        ...
        public async ValueTask<StandardMaterial> clone(
            string name,
