...
public class WindowCachedEntity : CachedEntityObject, Window
{
    ...
    public async ValueTask<WebGLRenderingContext> get_WebGLRenderingContext()
    {
        if (__WebGLRenderingContext == null)
        {
            __WebGLRenderingContext =
                await EventHorizonBlazorInterop.GetClass<WebGLRenderingContext>(
                    this.___guid,
    ...
    public ValueTask set_WebGLRenderingContext(WebGLRenderingContext value)
    {
