...
namespace BABYLON
{
    ...
    public class Collider : CachedEntityObject
    {
        ...
        public static async ValueTask<bool> get_DoubleSidedCheck()
        {
            return await EventHorizonBlazorInterop.Get<bool>(
                "BABYLON",
                "Collider.DoubleSidedCheck"
            );
        }

        public static ValueTask set_DoubleSidedCheck(bool value)
        {
            return EventHorizonBlazorInterop.Set("BABYLON", "Collider.DoubleSidedCheck", value);
        }
        #endregion
