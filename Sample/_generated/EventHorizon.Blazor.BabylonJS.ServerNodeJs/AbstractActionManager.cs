...
namespace BABYLON
{
    ...
    public class AbstractActionManager : CachedEntityObject, _IDisposable
    {
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "actions", value);
        }

        public async ValueTask<bool> get_isRecursive()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isRecursive");
        }

        public ValueTask set_isRecursive(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "isRecursive", value);
        }

        public async ValueTask<bool> get_disposeWhenUnowned()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "disposeWhenUnowned");
        }

        public ValueTask set_disposeWhenUnowned(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "disposeWhenUnowned", value);
        }
        #endregion
