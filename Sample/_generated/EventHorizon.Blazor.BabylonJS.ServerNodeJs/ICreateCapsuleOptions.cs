...
namespace BABYLON
{
    ...
    public class ICreateCapsuleOptionsCachedEntity : CachedEntityObject, ICreateCapsuleOptions
    {
        ...
        public async ValueTask<bool> get_updatable()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "updatable");
        }

        public ValueTask set_updatable(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "updatable", value);
        }
        #endregion
