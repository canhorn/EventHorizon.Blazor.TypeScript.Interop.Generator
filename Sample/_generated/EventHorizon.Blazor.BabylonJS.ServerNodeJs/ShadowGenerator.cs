...
namespace BABYLON
{
    ...
    public class ShadowGenerator : CachedEntityObject, IShadowGenerator
    {
        ...
        {
            return EventHorizonBlazorInterop.Set("BABYLON", "ShadowGenerator.CLASSNAME", value);
        }
        ...
        public static async ValueTask<decimal> get_DEFAULT_ALPHA_CUTOFF()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(
                "BABYLON",
        ...
        public static ValueTask set_DEFAULT_ALPHA_CUTOFF(decimal value)
        {
        ...
        public async ValueTask<Matrix> get_viewMatrix()
        {
            if (__viewMatrix == null)
            {
                __viewMatrix = await EventHorizonBlazorInterop.GetClass<Matrix>(
                    this.___guid,
                    "viewMatrix",
                    (entity) =>
                    {
        ...
        public async ValueTask<Matrix> get_projectionMatrix()
        {
            if (__projectionMatrix == null)
            {
                __projectionMatrix = await EventHorizonBlazorInterop.GetClass<Matrix>(
                    this.___guid,
                    "projectionMatrix",
                    (entity) =>
                    {
        ...
        public async ValueTask<bool> get_useOpacityTextureForTransparentShadow()
        {
            return await EventHorizonBlazorInterop.Get<bool>(
                this.___guid,
        ...
        public ValueTask set_useOpacityTextureForTransparentShadow(bool value)
        {
            return EventHorizonBlazorInterop.Set(
                this.___guid,
                "useOpacityTextureForTransparentShadow",
