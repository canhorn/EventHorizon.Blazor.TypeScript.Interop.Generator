...
namespace BABYLON
{
    ...
    public class ParticleHelper : CachedEntityObject
    {
        ...
        public static async ValueTask<IParticleSystemCachedEntity> get_CreateFromSnippetAsync()
        {
            return await EventHorizonBlazorInterop.Get<IParticleSystemCachedEntity>(
                "BABYLON",
                "ParticleHelper.CreateFromSnippetAsync"
            );
        }

        public static ValueTask set_CreateFromSnippetAsync(IParticleSystemCachedEntity value)
        {
        ...
        public static async ValueTask<IParticleSystemCachedEntity> ParseFromSnippetAsync(
            string snippetId,
            Scene scene,
            System.Nullable<bool> gpu = null,
            string rootUrl = null,
