...
public class EXT_disjoint_timer_queryCachedEntity : CachedEntityObject, EXT_disjoint_timer_query
{
    ...
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "QUERY_COUNTER_BITS_EXT");
    }

    public ValueTask set_QUERY_COUNTER_BITS_EXT(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "QUERY_COUNTER_BITS_EXT", value);
    }

    public async ValueTask<decimal> get_TIME_ELAPSED_EXT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "TIME_ELAPSED_EXT");
    }

    public ValueTask set_TIME_ELAPSED_EXT(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "TIME_ELAPSED_EXT", value);
    }

    public async ValueTask<decimal> get_TIMESTAMP_EXT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "TIMESTAMP_EXT");
    }

    public ValueTask set_TIMESTAMP_EXT(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "TIMESTAMP_EXT", value);
    }

    public async ValueTask<decimal> get_GPU_DISJOINT_EXT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "GPU_DISJOINT_EXT");
    }

    public ValueTask set_GPU_DISJOINT_EXT(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "GPU_DISJOINT_EXT", value);
    }

    public async ValueTask<decimal> get_QUERY_RESULT_EXT()
    {
        return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "QUERY_RESULT_EXT");
    }

    public ValueTask set_QUERY_RESULT_EXT(decimal value)
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "QUERY_RESULT_EXT", value);
    }
    ...
    {
        return EventHorizonBlazorInterop.Set(this.___guid, "QUERY_RESULT_AVAILABLE_EXT", value);
    }
    #endregion
    ...
    public async ValueTask<WebGLQuery> createQueryEXT()
    {
        return await EventHorizonBlazorInterop.FuncClass<WebGLQuery>(
