...
namespace BABYLON
{
    ...
    public class TransformNode : Node
    {
        ...
        {
            return EventHorizonBlazorInterop.Set("BABYLON", "TransformNode.BILLBOARDMODE_X", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set("BABYLON", "TransformNode.BILLBOARDMODE_Y", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set("BABYLON", "TransformNode.BILLBOARDMODE_Z", value);
        }
        ...
        public static async ValueTask<bool> get_BillboardUseParentOrientation()
        {
        ...
        public static ValueTask set_BillboardUseParentOrientation(bool value)
        {
            return EventHorizonBlazorInterop.Set(
                "BABYLON",
                "TransformNode.BillboardUseParentOrientation",
        ...
        public async ValueTask<bool> isUsingPivotMatrix()
        {
        ...
        public async ValueTask<bool> isUsingPostMultiplyPivotMatrix()
        {
            return await EventHorizonBlazorInterop.Func<bool>(
        ...
        public async ValueTask<TransformNode> freezeWorldMatrix(
        ...
        public async ValueTask<Node> markAsDirty(string property = null)
        {
        ...
        public async ValueTask<TransformNode> setParent(
            Node node,
        ...
        public async ValueTask<TransformNode> addChild(
            TransformNode mesh,
            System.Nullable<bool> preserveScalingSign = null
        )
        {
        ...
        public async ValueTask<TransformNode> removeChild(
            TransformNode mesh,
            System.Nullable<bool> preserveScalingSign = null
        )
        {
        ...
        public async ValueTask<TransformNode> detachFromBone(
            System.Nullable<bool> resetToPreviousParent = null
        )
        {
            return await EventHorizonBlazorInterop.FuncClass<TransformNode>(
                entity => new TransformNode() { ___guid = entity.___guid },
        ...
        public async ValueTask<TransformNode> rotateAround(
            Vector3 point,
            Vector3 axis,
            decimal amount
        )
        ...
        public async ValueTask<bool> isWorldMatrixCameraDependent()
        {
            return await EventHorizonBlazorInterop.Func<bool>(
