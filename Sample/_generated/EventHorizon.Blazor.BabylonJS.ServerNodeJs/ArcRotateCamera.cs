...
namespace BABYLON
{
    ...
    public class ArcRotateCamera : TargetCamera
    {
        ...
        public async ValueTask<TransformNode> get_targetHost()
        {
            if (__targetHost == null)
            {
                __targetHost = await EventHorizonBlazorInterop.GetClass<TransformNode>(
                    this.___guid,
                    "targetHost",
                    (entity) =>
                    {
        ...
        public ValueTask set_targetHost(TransformNode value)
        {
            __targetHost = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "targetHost", value);
        }
        ...
        {
            __upVector = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "upVector", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "angularSensibilityX", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "angularSensibilityY", value);
        }

        public async ValueTask<decimal> get_pinchPrecision()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "pinchPrecision");
        }

        public ValueTask set_pinchPrecision(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "pinchPrecision", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "pinchDeltaPercentage", value);
        }

        public async ValueTask<bool> get_useNaturalPinchZoom()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useNaturalPinchZoom");
        }

        public ValueTask set_useNaturalPinchZoom(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "useNaturalPinchZoom", value);
        }

        public async ValueTask<decimal> get_panningSensibility()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "panningSensibility");
        }

        public ValueTask set_panningSensibility(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "panningSensibility", value);
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "wheelPrecision");
        }

        public ValueTask set_wheelPrecision(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "wheelPrecision", value);
        }

        public async ValueTask<bool> get_zoomToMouseLocation()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "zoomToMouseLocation");
        }

        public ValueTask set_zoomToMouseLocation(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "zoomToMouseLocation", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "wheelDeltaPercentage", value);
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useBouncingBehavior");
        }

        public ValueTask set_useBouncingBehavior(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "useBouncingBehavior", value);
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useFramingBehavior");
        }

        public ValueTask set_useFramingBehavior(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "useFramingBehavior", value);
        }
        ...
        public async ValueTask<AutoRotationBehavior> get_autoRotationBehavior()
        {
            ...
            {
                __autoRotationBehavior =
                    await EventHorizonBlazorInterop.GetClass<AutoRotationBehavior>(
                        this.___guid,
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "useAutoRotationBehavior", value);
        }
        #endregion
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "beta");
        }

        public ValueTask set_beta(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "beta", value);
        }
        ...
        public async ValueTask<bool> get_overrideCloneAlphaBetaRadius()
        {
            return await EventHorizonBlazorInterop.Get<bool>(
                this.___guid,
        ...
        public ValueTask set_overrideCloneAlphaBetaRadius(bool value)
        {
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "inertialAlphaOffset", value);
        }

        public async ValueTask<decimal> get_inertialBetaOffset()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "inertialBetaOffset");
        }

        public ValueTask set_inertialBetaOffset(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "inertialBetaOffset", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "inertialRadiusOffset", value);
        }

        public async ValueTask<decimal> get_lowerAlphaLimit()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "lowerAlphaLimit");
        }

        public ValueTask set_lowerAlphaLimit(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "lowerAlphaLimit", value);
        }

        public async ValueTask<decimal> get_upperAlphaLimit()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "upperAlphaLimit");
        }

        public ValueTask set_upperAlphaLimit(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "upperAlphaLimit", value);
        }

        public async ValueTask<decimal> get_lowerBetaLimit()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "lowerBetaLimit");
        }

        public ValueTask set_lowerBetaLimit(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "lowerBetaLimit", value);
        }

        public async ValueTask<decimal> get_upperBetaLimit()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "upperBetaLimit");
        }

        public ValueTask set_upperBetaLimit(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "upperBetaLimit", value);
        }

        public async ValueTask<decimal> get_lowerRadiusLimit()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "lowerRadiusLimit");
        }

        public ValueTask set_lowerRadiusLimit(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "lowerRadiusLimit", value);
        }

        public async ValueTask<decimal> get_upperRadiusLimit()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "upperRadiusLimit");
        }

        public ValueTask set_upperRadiusLimit(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "upperRadiusLimit", value);
        }

        public async ValueTask<decimal> get_inertialPanningX()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "inertialPanningX");
        }

        public ValueTask set_inertialPanningX(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "inertialPanningX", value);
        }

        public async ValueTask<decimal> get_inertialPanningY()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "inertialPanningY");
        }

        public ValueTask set_inertialPanningY(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "inertialPanningY", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "pinchToPanMaxDistance", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "panningDistanceLimit", value);
        }
        ...
        public ValueTask set_panningOriginTarget(Vector3 value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "panningOriginTarget", value);
        }

        public async ValueTask<decimal> get_panningInertia()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "panningInertia");
        }

        public ValueTask set_panningInertia(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "panningInertia", value);
        }

        public async ValueTask<decimal> get_zoomOnFactor()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "zoomOnFactor");
        }

        public ValueTask set_zoomOnFactor(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "zoomOnFactor", value);
        }
        ...
        public ValueTask set_targetScreenOffset(Vector2 value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "targetScreenOffset", value);
        }

        public async ValueTask<bool> get_allowUpsideDown()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "allowUpsideDown");
        }

        public ValueTask set_allowUpsideDown(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "allowUpsideDown", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "useInputToRestoreState", value);
        }

        public async ValueTask<decimal> get_restoreStateInterpolationFactor()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(
                this.___guid,
        ...
        public ValueTask set_restoreStateInterpolationFactor(decimal value)
        {
            return EventHorizonBlazorInterop.Set(
                this.___guid,
                "restoreStateInterpolationFactor",
        ...
        {
            __panningAxis = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "panningAxis", value);
        }

        public async ValueTask<bool> get_mapPanning()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "mapPanning");
        }

        public ValueTask set_mapPanning(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "mapPanning", value);
        }

        private Observable<TransformNode> __onMeshTargetChangedObservable;

        public async ValueTask<Observable<TransformNode>> get_onMeshTargetChangedObservable()
        {
            if (__onMeshTargetChangedObservable == null)
            {
                __onMeshTargetChangedObservable = await EventHorizonBlazorInterop.GetClass<
        ...
        public ValueTask set_onMeshTargetChangedObservable(Observable<TransformNode> value)
        {
        ...
        public ValueTask set_collisionRadius(Vector3 value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "collisionRadius", value);
        }
        #endregion
        ...
        public ArcRotateCamera(ICachedEntity entity)
            : base(entity) { }
        ...
        public async ValueTask setMatUp()
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] { new string[] { this.___guid, "setMatUp" } }
            );
        }
        ...
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] { new string[] { this.___guid, "rebuildAnglesAndRadius" } }
            );
        }
        ...
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] { new string[] { this.___guid, "setPosition" }, position }
            );
        }

        public async ValueTask setTarget(
        ...
        public async ValueTask zoomOn(
            AbstractMesh[] meshes = null,
            System.Nullable<bool> doNotUpdateMaxZ = null
        )
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[] { new string[] { this.___guid, "zoomOn" }, meshes, doNotUpdateMaxZ }
            );
        }

        public async ValueTask focusOn(
        ...
        )
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[]
                {
                    new string[] { this.___guid, "focusOn" },
