...
namespace BABYLON
{
    ...
    public class InternalTexture : TextureSampler
    {
        ...
        {
            return await EventHorizonBlazorInterop.Get<int>(this.___guid, "source");
        }
        #endregion
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "isMultiview");
        }

        public ValueTask set_isMultiview(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "isMultiview", value);
        }
        ...
        public async ValueTask<Observable<InternalTexture>> get_onLoadedObservable()
        {
            ...
            {
                __onLoadedObservable = await EventHorizonBlazorInterop.GetClass<
        ...
        public ValueTask set_onLoadedObservable(Observable<InternalTexture> value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "onLoadedObservable", value);
        }

        private Observable<CachedEntity> __onErrorObservable;

        public async ValueTask<Observable<CachedEntity>> get_onErrorObservable()
        {
            if (__onErrorObservable == null)
            {
                __onErrorObservable = await EventHorizonBlazorInterop.GetClass<
        ...
        public ValueTask set_onErrorObservable(Observable<CachedEntity> value)
        {
        ...
        public ValueTask set_onRebuildCallback(
            ActionResultCallback<InternalTexture, InternalTexture> value
        )
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "onRebuildCallback", value);
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "baseWidth");
        }

        public ValueTask set_baseWidth(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "baseWidth", value);
        }

        public async ValueTask<decimal> get_baseHeight()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "baseHeight");
        }

        public ValueTask set_baseHeight(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "baseHeight", value);
        }

        public async ValueTask<decimal> get_baseDepth()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "baseDepth");
        }

        public ValueTask set_baseDepth(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "baseDepth", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "invertY", value);
        }
        #endregion
        ...
        public async ValueTask updateSize(
            decimal width,
            decimal height,
