...
namespace BABYLON
{
    ...
    public class Ray : CachedEntityObject
    {
        ...
        public static async ValueTask<Ray> CreateNew(
            decimal x,
            decimal y,
        ...
        public static async ValueTask<Ray> CreateNewFromTo(
            Vector3 origin,
            Vector3 end,
            Matrix world = null
        )
        ...
        public static async ValueTask<Ray> CreateFromToToRef(
            Vector3 origin,
            Vector3 end,
            Ray result,
            Matrix world = null
        ...
        public static async ValueTask<Ray> TransformToRef(Ray ray, Matrix matrix, Ray result)
        {
            return await EventHorizonBlazorInterop.FuncClass<Ray>(
                entity => new Ray() { ___guid = entity.___guid },
                new object[]
        ...
        {
            __origin = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "origin", value);
        }
        ...
        public async ValueTask<decimal> get_epsilon()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "epsilon");
        }

        public ValueTask set_epsilon(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "epsilon", value);
        }
        #endregion
        ...
        #region Methods
        public async ValueTask<Ray> clone()
        {
            return await EventHorizonBlazorInterop.FuncClass<Ray>(
                entity => new Ray() { ___guid = entity.___guid },
        ...
        public async ValueTask<bool> intersectsBoxMinMax(
            Vector3 minimum,
            Vector3 maximum,
        ...
        public async ValueTask<bool> intersectsBox(
            BoundingBox box,
            System.Nullable<decimal> intersectionTreshold = null
        )
        {
        ...
        public async ValueTask<bool> intersectsSphere(
        ...
        public async ValueTask<IntersectionInfo> intersectsTriangle(
            Vector3 vertex0,
            Vector3 vertex1,
            Vector3 vertex2
        )
        ...
        public async ValueTask<Vector3> intersectsAxis(
            string axis,
        ...
        public async ValueTask<PickingInfo> intersectsMesh(
            AbstractMesh mesh,
        ...
        public async ValueTask<PickingInfo[]> intersectsMeshes(
            AbstractMesh[] meshes,
            System.Nullable<bool> fastCheck = null,
        ...
        public async ValueTask<decimal> intersectionSegment(
            Vector3 sega,
            Vector3 segb,
            decimal threshold
        )
        ...
        public async ValueTask<Ray> update(
            decimal x,
            decimal y,
            decimal viewportWidth,
            decimal viewportHeight,
        ...
        public async ValueTask unprojectRayToRef(
            decimal sourceX,
            decimal sourceY,
            decimal viewportWidth,
            decimal viewportHeight,
