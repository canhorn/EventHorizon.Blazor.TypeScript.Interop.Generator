...
namespace BABYLON
{
    ...
    public class ProceduralTexture : Texture
    {
        ...
        public async ValueTask executeWhenReady(ActionCallback<ProceduralTexture> func)
        {
            await EventHorizonBlazorInterop.Func<CachedEntity>(
        ...
        public async ValueTask<ProceduralTexture> setVector4(string name, Vector4 value)
        {
            return await EventHorizonBlazorInterop.FuncClass<ProceduralTexture>(
                entity => new ProceduralTexture() { ___guid = entity.___guid },
