...
namespace BABYLON
{
    ...
    public class IEdgesRendererOptionsCachedEntity : CachedEntityObject, IEdgesRendererOptions
    {
        ...
        public async ValueTask<bool> get_removeDegeneratedTriangles()
        {
            return await EventHorizonBlazorInterop.Get<bool>(
                this.___guid,
        ...
        public ValueTask set_removeDegeneratedTriangles(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "removeDegeneratedTriangles", value);
        }
        #endregion
