...
namespace BABYLON
{
    ...
    public class ParticleSystemSet : CachedEntityObject, _IDisposable
    {
        ...
        public async ValueTask<AbstractMesh> get_emitterNode()
        {
            if (__emitterNode == null)
            {
                __emitterNode = await EventHorizonBlazorInterop.GetClass<AbstractMesh>(
                    this.___guid,
                    "emitterNode",
                    (entity) =>
                    {
        ...
        public ValueTask set_emitterNode(AbstractMesh value)
        {
            __emitterNode = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "emitterNode", value);
        }
        #endregion
