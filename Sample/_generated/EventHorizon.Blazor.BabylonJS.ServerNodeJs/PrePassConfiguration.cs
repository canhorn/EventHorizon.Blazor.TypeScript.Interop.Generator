...
namespace BABYLON
{
    ...
    public class PrePassConfiguration : CachedEntityObject
    {
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "previousWorldMatrices", value);
        }
        ...
        public ValueTask set_previousViewProjection(Matrix value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "previousViewProjection", value);
        }

        private Matrix __currentViewProjection;

        public async ValueTask<Matrix> get_currentViewProjection()
        {
            if (__currentViewProjection == null)
            {
                __currentViewProjection = await EventHorizonBlazorInterop.GetClass<Matrix>(
                    this.___guid,
        ...
        public ValueTask set_currentViewProjection(Matrix value)
        {
            __currentViewProjection = null;
            return EventHorizonBlazorInterop.Set(this.___guid, "currentViewProjection", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "previousBones", value);
        }
        #endregion
