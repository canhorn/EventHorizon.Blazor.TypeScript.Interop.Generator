...
namespace BABYLON
{
    ...
    public class Texture : BaseTexture
    {
        ...
        public static async ValueTask<Observable<BaseTexture>> get_OnTextureLoadErrorObservable()
        {
            if (__OnTextureLoadErrorObservable == null)
            {
                __OnTextureLoadErrorObservable = await EventHorizonBlazorInterop.GetClass<
        ...
        public static ValueTask set_OnTextureLoadErrorObservable(Observable<BaseTexture> value)
        {
