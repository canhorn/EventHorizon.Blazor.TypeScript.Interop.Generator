...
namespace BABYLON
{
    ...
    public class ImageProcessingConfiguration : CachedEntityObject
    {
        ...
        public static async ValueTask<decimal> get_TONEMAPPING_KHR_PBR_NEUTRAL()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(
                "BABYLON",
        ...
        public static async ValueTask PrepareUniforms(
            string[] uniforms,
        ...
        public static async ValueTask PrepareSamplers(
            string[] samplersList,
            IImageProcessingConfigurationDefines defines
        )
        {
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "colorCurvesEnabled");
        }

        public ValueTask set_colorCurvesEnabled(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "colorCurvesEnabled", value);
        }
        ...
        public ValueTask set_colorGradingTexture(BaseTexture value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "colorGradingTexture", value);
        }

        public async ValueTask<bool> get_colorGradingEnabled()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "colorGradingEnabled");
        }

        public ValueTask set_colorGradingEnabled(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "colorGradingEnabled", value);
        }
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "colorGradingWithGreenDepth", value);
        }

        public async ValueTask<bool> get_colorGradingBGR()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "colorGradingBGR");
        }

        public ValueTask set_colorGradingBGR(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "colorGradingBGR", value);
        }

        public async ValueTask<decimal> get_exposure()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "exposure");
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "toneMappingEnabled");
        }

        public ValueTask set_toneMappingEnabled(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "toneMappingEnabled", value);
        }

        public async ValueTask<decimal> get_toneMappingType()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "toneMappingType");
        }

        public ValueTask set_toneMappingType(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "toneMappingType", value);
        }

        public async ValueTask<decimal> get_contrast()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "contrast");
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "vignetteCentreY");
        }

        public ValueTask set_vignetteCentreY(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "vignetteCentreY", value);
        }

        public async ValueTask<decimal> get_vignetteCentreX()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "vignetteCentreX");
        }

        public ValueTask set_vignetteCentreX(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "vignetteCentreX", value);
        }

        public async ValueTask<decimal> get_vignetteBlendMode()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "vignetteBlendMode");
        }

        public ValueTask set_vignetteBlendMode(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "vignetteBlendMode", value);
        }

        public async ValueTask<bool> get_vignetteEnabled()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "vignetteEnabled");
        }

        public ValueTask set_vignetteEnabled(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "vignetteEnabled", value);
        }

        public async ValueTask<bool> get_ditheringEnabled()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "ditheringEnabled");
        }

        public ValueTask set_ditheringEnabled(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "ditheringEnabled", value);
        }

        public async ValueTask<decimal> get_ditheringIntensity()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "ditheringIntensity");
        }

        public ValueTask set_ditheringIntensity(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "ditheringIntensity", value);
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "applyByPostProcess");
        }

        public ValueTask set_applyByPostProcess(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "applyByPostProcess", value);
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "vignetteStretch");
        }

        public ValueTask set_vignetteStretch(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "vignetteStretch", value);
        }

        public async ValueTask<decimal> get_vignetteCenterX()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "vignetteCenterX");
        }

        public ValueTask set_vignetteCenterX(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "vignetteCenterX", value);
        }

        public async ValueTask<decimal> get_vignetteCenterY()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "vignetteCenterY");
        }

        public ValueTask set_vignetteCenterY(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "vignetteCenterY", value);
        }

        public async ValueTask<decimal> get_vignetteWeight()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "vignetteWeight");
        }

        public ValueTask set_vignetteWeight(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "vignetteWeight", value);
        }
        ...
        public ValueTask set_vignetteColor(Color4 value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "vignetteColor", value);
        }

        public async ValueTask<decimal> get_vignetteCameraFov()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "vignetteCameraFov");
        }

        public ValueTask set_vignetteCameraFov(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "vignetteCameraFov", value);
        }
        ...
        public async ValueTask<Observable<ImageProcessingConfiguration>> get_onUpdateParameters()
        {
            ...
            {
                __onUpdateParameters = await EventHorizonBlazorInterop.GetClass<
        ...
        public ValueTask set_onUpdateParameters(Observable<ImageProcessingConfiguration> value)
        {
            ...
            return EventHorizonBlazorInterop.Set(this.___guid, "onUpdateParameters", value);
        }
        #endregion
