...
namespace BABYLON
{
    ...
    public interface IXYZ : ICachedEntity { }

    [JsonConverter(typeof(CachedEntityConverter<IXYZCachedEntity>))]
    public class IXYZCachedEntity : CachedEntityObject, IXYZ
    {
        ...
        #region Constructor
        public IXYZCachedEntity()
            : base() { }

        public IXYZCachedEntity(ICachedEntity entity)
            : base(entity) { }
