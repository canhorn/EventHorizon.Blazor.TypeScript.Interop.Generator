...
namespace BABYLON
{
    ...
    public class VertexBuffer : CachedEntityObject
    {
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>("BABYLON", "VertexBuffer.BYTE");
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>("BABYLON", "VertexBuffer.SHORT");
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>("BABYLON", "VertexBuffer.INT");
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>("BABYLON", "VertexBuffer.FLOAT");
        }
        ...
        {
            return await EventHorizonBlazorInterop.Get<string>("BABYLON", "VertexBuffer.UVKind");
        }

        public static async ValueTask<string> get_UV2Kind()
        {
            return await EventHorizonBlazorInterop.Get<string>("BABYLON", "VertexBuffer.UV2Kind");
        }

        public static async ValueTask<string> get_UV3Kind()
        {
            return await EventHorizonBlazorInterop.Get<string>("BABYLON", "VertexBuffer.UV3Kind");
        }

        public static async ValueTask<string> get_UV4Kind()
        {
            return await EventHorizonBlazorInterop.Get<string>("BABYLON", "VertexBuffer.UV4Kind");
        }

        public static async ValueTask<string> get_UV5Kind()
        {
            return await EventHorizonBlazorInterop.Get<string>("BABYLON", "VertexBuffer.UV5Kind");
        }

        public static async ValueTask<string> get_UV6Kind()
        {
            return await EventHorizonBlazorInterop.Get<string>("BABYLON", "VertexBuffer.UV6Kind");
        }

        public static async ValueTask<string> get_ColorKind()
        {
            return await EventHorizonBlazorInterop.Get<string>("BABYLON", "VertexBuffer.ColorKind");
        }

        public static async ValueTask<string> get_ColorInstanceKind()
        {
            return await EventHorizonBlazorInterop.Get<string>(
                "BABYLON",
        ...
        public static async ValueTask<decimal> GetDataType(decimal[] data)
        {
            return await EventHorizonBlazorInterop.Func<decimal>(
        ...
        public static async ValueTask<decimal[]> GetFloatData(
            decimal[] data,
            decimal size,
            decimal type,
            decimal byteOffset,
        ...
        public async ValueTask<decimal> get_hashCode()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "hashCode");
        }

        private AbstractEngine __engine;

        public async ValueTask<AbstractEngine> get_engine()
        {
            if (__engine == null)
            {
        ...
        public async ValueTask<decimal[]> getFloatData(
            decimal totalVertices,
            System.Nullable<bool> forceCopy = null
        )
        {
        ...
        public async ValueTask<Buffer> getWrapperBuffer()
        {
            return await EventHorizonBlazorInterop.FuncClass<Buffer>(
        ...
        public async ValueTask<decimal> getSize(System.Nullable<bool> sizeInBytes = null)
        {
            return await EventHorizonBlazorInterop.Func<decimal>(
