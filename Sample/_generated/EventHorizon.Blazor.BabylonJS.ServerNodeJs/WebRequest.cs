...
namespace BABYLON
{
    ...
    public class WebRequest : CachedEntityObject, IWebRequest
    {
        ...
        public static async ValueTask<bool> get_IsCustomRequestAvailable()
        {
        ...
        public static async ValueTask<bool> get_SkipRequestModificationForBabylonCDN()
        {
            return await EventHorizonBlazorInterop.Get<bool>(
                "BABYLON",
        ...
        public static ValueTask set_SkipRequestModificationForBabylonCDN(bool value)
        {
            return EventHorizonBlazorInterop.Set(
                "BABYLON",
                "WebRequest.SkipRequestModificationForBabylonCDN",
        ...
        public async ValueTask<decimal> get_timeout()
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "timeout");
        }

        public ValueTask set_timeout(decimal value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "timeout", value);
        }
        #endregion
