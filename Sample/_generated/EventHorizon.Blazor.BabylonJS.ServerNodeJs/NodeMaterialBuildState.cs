...
namespace BABYLON
{
    ...
    public class NodeMaterialBuildState : CachedEntityObject
    {
        ...
        public async ValueTask<CachedEntity> get_fSuffix()
        {
            return await EventHorizonBlazorInterop.Get<CachedEntity>(this.___guid, "fSuffix");
        }
        #endregion
        ...
        public async ValueTask<CachedEntity> get_prePassOutput()
        {
            return await EventHorizonBlazorInterop.GetClass<CachedEntity>(
                this.___guid,
                "prePassOutput",
        ...
        public ValueTask set_prePassOutput(CachedEntity value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "prePassOutput", value);
        }
