...
namespace BABYLON
{
    ...
    public class BaseParticleSystem : CachedEntityObject, IClipPlanesHolder
    {
        ...
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "useLogarithmicDepth");
        }

        public ValueTask set_useLogarithmicDepth(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "useLogarithmicDepth", value);
        }
        ...
        public async ValueTask<bool> get_spriteCellLoop()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "spriteCellLoop");
        }

        public ValueTask set_spriteCellLoop(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "spriteCellLoop", value);
        }
