...
namespace BABYLON
{
    ...
    public class SpriteManager : CachedEntityObject, ISpriteManager
    {
        ...
        {
            return EventHorizonBlazorInterop.Set("BABYLON", "SpriteManager.SnippetUrl", value);
        }

        public static async ValueTask<SpriteManager> get_CreateFromSnippetAsync()
        {
            return await EventHorizonBlazorInterop.Get<SpriteManager>(
                "BABYLON",
                "SpriteManager.CreateFromSnippetAsync"
            );
        }

        public static ValueTask set_CreateFromSnippetAsync(SpriteManager value)
        {
        ...
        public static async ValueTask<SpriteManager> Parse(
            object parsedManager,
            Scene scene,
            string rootUrl
        )
        {
            return await EventHorizonBlazorInterop.FuncClass<SpriteManager>(
                ...
                new object[]
                {
                    new string[] { "BABYLON", "SpriteManager", "Parse" },
                    parsedManager,
                    scene,
                    rootUrl
                }
        ...
        public static async ValueTask<SpriteManager> ParseFromFileAsync(
            string url,
            Scene scene,
            string name = null,
            string rootUrl = null
        )
        {
            return await EventHorizonBlazorInterop.TaskClass<SpriteManager>(
                ...
                new object[]
                {
                    new string[] { "BABYLON", "SpriteManager", "ParseFromFileAsync" },
                    name,
                    url,
                    scene,
                    rootUrl
        ...
        public static async ValueTask<SpriteManager> ParseFromSnippetAsync(
            string snippetId,
            Scene scene,
            string rootUrl = null
        )
        ...
        {
            return await EventHorizonBlazorInterop.Get<decimal>(this.___guid, "capacity");
        }
        ...
        public async ValueTask<bool> get_pixelPerfect()
        {
            return await EventHorizonBlazorInterop.Get<bool>(this.___guid, "pixelPerfect");
        }

        public ValueTask set_pixelPerfect(bool value)
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "pixelPerfect", value);
        }
        #endregion
        ...
        {
            return EventHorizonBlazorInterop.Set(this.___guid, "sprites", value);
        }
        ...
        public SpriteManager(ICachedEntity entity)
            : base(entity) { }
        ...
        public static async ValueTask<SpriteManager> NewSpriteManager(
            ...
            System.Nullable<bool> fromPacked = null,
            object spriteJSON = null
        )
        {
        ...
        public async ValueTask<PickingInfo> intersects(
            Ray ray,
            Camera camera,
            ActionResultCallback<Sprite, bool> predicate = null,
        ...
        public async ValueTask<PickingInfo[]> multiIntersects(
            Ray ray,
            Camera camera,
            ActionResultCallback<Sprite, bool> predicate = null
        )
